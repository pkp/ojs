...
- configure an OJS instance:
  ...
  - debug.webtest_admin_pw = "...your admin password..."
- optional: change the admin-password of the test server if it is publicly exposed - make sure it is equal to debug.webtest_admin_pw.
