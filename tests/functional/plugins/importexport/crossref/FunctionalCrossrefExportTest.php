...
class FunctionalCrossrefExportTest extends FunctionalExportBaseTestCase {

	/**
	 * @see FunctionalExportBaseTestCase::getExportUrl()
	 */
	protected function getExportUrl() {
		return 'CrossRefExportPlugin/exportArticle/1';
	}

	public function testDoi() {
		$this->xPath->registerNamespace('cr', 'http://www.crossref.org/schema/4.3.0');
		self::assertEquals('10.1234/t.v1i1.1', $this->xPath->evaluate('string(/cr:doi_batch/cr:body/cr:journal/cr:journal_article/cr:doi_data/cr:doi)'));
	}
}
?>