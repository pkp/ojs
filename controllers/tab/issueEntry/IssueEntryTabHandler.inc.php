...
/**
 * @file controllers/tab/catalogEntry/IssueEntryTabHandler.inc.php
 *
		...
		if (!$form) { // nothing applicable in parent.
			...
			switch ($this->getCurrentTab()) {
				case 'publication':
					...
					PkpLog::logEvent($request, $submission, SUBMISSION_LOG_ISSUE_METADATA_UPDATE, 'submission.event.issueMetadataUpdated');
					break;
			}
		}
	}
