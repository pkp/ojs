...
a);a&&"uninitialized"==a.toLowerCase()&&setTimeout(b,50)}catch(c){d("Server abort: ",c," (",c.name,")"),w(I),G&&clearTimeout(G),G=void 0}}var c=q.attr2("target"),e=q.attr2("action"),B=q.attr("enctype")||q.attr("encoding")||"multipart/form-data";j.setAttribute("target",y);(!n||/post/i.test(n))&&j.setAttribute("method","POST");e!=l.url&&j.setAttribute("action",l.url);!l.skipEncodingOverride&&(!n||/post/i.test(n))&&q.attr({encoding:"multipart/form-data",enctype:"multipart/form-data"});l.timeout&&(G=
setTimeout(function(){E=!0;w(O)},l.timeout));var h=[];try{if(l.extraData)for(var C in l.extraData)l.extraData.hasOwnProperty(C)&&(a.isPlainObject(l.extraData[C])&&l.extraData[C].hasOwnProperty("name")&&l.extraData[C].hasOwnProperty("value")?h.push(a('<input type="hidden" name="'+l.extraData[C].name+'">').val(l.extraData[C].value).appendTo(j)[0]):h.push(a('<input type="hidden" name="'+C+'">').val(l.extraData[C]).appendTo(j)[0]));l.iframeTarget||p.appendTo("body");m.attachEvent?m.attachEvent("onload",
w):m.addEventListener("load",w,!1);setTimeout(b,15);try{j.submit()}catch(z){document.createElement("form").submit.apply(j)}}finally{j.setAttribute("action",e),j.setAttribute("enctype",B),c?j.setAttribute("target",c):q.removeAttr("target"),a(h).remove()}}function w(b){if(!r.aborted&&!P)if(z=f(m),z||(d("cannot access response document"),b=I),b===O&&r)r.abort("timeout"),B.reject(r,"timeout");else if(b==I&&r)r.abort("server abort"),B.reject(r,"error","server abort");else if(z&&z.location.href!=l.iframeSrc||
E){m.detachEvent?m.detachEvent("onload",w):m.removeEventListener("load",w,!1);var b="success",c;try{if(E)throw"timeout";var e="xml"==l.dataType||z.XMLDocument||a.isXMLDoc(z);d("isXml="+e);if(!e&&(window.opera&&(null===z.body||!z.body.innerHTML))&&--T){d("requeing onLoad callback, DOM not available");setTimeout(w,250);return}var g=z.body?z.body:z.documentElement;r.responseText=g?g.innerHTML:null;r.responseXML=z.XMLDocument?z.XMLDocument:z;e&&(l.dataType="xml");r.getResponseHeader=function(a){return{"content-type":l.dataType}[a.toLowerCase()]};
g&&(r.status=Number(g.getAttribute("status"))||r.status,r.statusText=g.getAttribute("statusText")||r.statusText);var h=(l.dataType||"").toLowerCase(),i=/(json|script|text)/.test(h);if(i||l.textarea){var j=z.getElementsByTagName("textarea")[0];if(j)r.responseText=j.value,r.status=Number(j.getAttribute("status"))||r.status,r.statusText=j.getAttribute("statusText")||r.statusText;else if(i){var v=z.getElementsByTagName("pre")[0],n=z.getElementsByTagName("body")[0];v?r.responseText=v.textContent?v.textContent:
v.innerText:n&&(r.responseText=n.textContent?n.textContent:n.innerText)}}else"xml"==h&&(!r.responseXML&&r.responseText)&&(r.responseXML=t(r.responseText));try{var e=r,g=l,q=e.getResponseHeader("content-type")||"",y="xml"===h||!h&&0<=q.indexOf("xml"),x=y?e.responseXML:e.responseText;y&&"parsererror"===x.documentElement.nodeName&&a.error&&a.error("parsererror");g&&g.dataFilter&&(x=g.dataFilter(x,h));"string"===typeof x&&("json"===h||!h&&0<=q.indexOf("json")?x=A(x):("script"===h||!h&&0<=q.indexOf("javascript"))&&
a.globalEval(x));C=x}catch(s){b="parsererror",r.error=c=s||b}}catch(u){d("error caught: ",u),b="error",r.error=c=u||b}r.aborted&&(d("upload aborted"),b=null);r.status&&(b=200<=r.status&&300>r.status||304===r.status?"success":"error");"success"===b?(l.success&&l.success.call(l.context,C,"success",r),B.resolve(r.responseText,"success",r),k&&a.event.trigger("ajaxSuccess",[r,l])):b&&(void 0===c&&(c=r.statusText),l.error&&l.error.call(l.context,r,b,c),B.reject(r,"error",c),k&&a.event.trigger("ajaxError",
[r,l,c]));k&&a.event.trigger("ajaxComplete",[r,l]);k&&!--a.active&&a.event.trigger("ajaxStop");l.complete&&l.complete.call(l.context,r,b);P=!0;l.timeout&&clearTimeout(G);setTimeout(function(){l.iframeTarget?p.attr("src",l.iframeSrc):p.remove();r.responseXML=null},100)}}var j=q[0],v,l,k,y,p,m,r,E,G,B=a.Deferred();B.abort=function(a){r.abort(a)};if(e)for(v=0;v<s.length;v++)e=a(s[v]),h?e.prop("disabled",!1):e.removeAttr("disabled");l=a.extend(!0,{},a.ajaxSettings,b);l.context=l.context||l;y="jqFormIO"+
(new Date).getTime();l.iframeTarget?(p=a(l.iframeTarget),(v=p.attr2("name"))?y=v:p.attr2("name",y)):(p=a('<iframe name="'+y+'" src="'+l.iframeSrc+'" />'),p.css({position:"absolute",top:"-1000px",left:"-1000px"}));m=p[0];r={aborted:0,responseText:null,responseXML:null,status:0,statusText:"n/a",getAllResponseHeaders:function(){},getResponseHeader:function(){},setRequestHeader:function(){},abort:function(b){var c="timeout"===b?"timeout":"aborted";d("aborting upload... "+c);this.aborted=1;try{m.contentWindow.document.execCommand&&
m.contentWindow.document.execCommand("Stop")}catch(e){}p.attr("src",l.iframeSrc);r.error=c;l.error&&l.error.call(l.context,r,c,b);k&&a.event.trigger("ajaxError",[r,l,c]);l.complete&&l.complete.call(l.context,r,c)}};(k=l.global)&&0===a.active++&&a.event.trigger("ajaxStart");k&&a.event.trigger("ajaxSend",[r,l]);if(l.beforeSend&&!1===l.beforeSend.call(l.context,r,l))return l.global&&a.active--,B.reject(),B;if(r.aborted)return B.reject(),B;if(e=j.clk)if((v=e.name)&&!e.disabled)l.extraData=l.extraData||
{},l.extraData[v]=e.value,"image"==e.type&&(l.extraData[v+".x"]=j.clk_x,l.extraData[v+".y"]=j.clk_y);var O=1,I=2,e=a("meta[name=csrf-token]").attr("content");if((v=a("meta[name=csrf-param]").attr("content"))&&e)l.extraData=l.extraData||{},l.extraData[v]=e;l.forceSync?g():setTimeout(g,10);var C,z,T=50,P,t=a.parseXML||function(a,b){window.ActiveXObject?(b=new ActiveXObject("Microsoft.XMLDOM"),b.async="false",b.loadXML(a)):b=(new DOMParser).parseFromString(a,"text/xml");return b&&b.documentElement&&
"parsererror"!=b.documentElement.nodeName?b:null},A=a.parseJSON||function(a){return window.eval("("+a+")")};return B}if(!this.length)return d("ajaxSubmit: skipping submit process - no element selected"),this;var n,k,q=this;"function"==typeof b?b={success:b}:void 0===b&&(b={});n=b.type||this.attr2("method");k=b.url||this.attr2("action");(k=(k="string"===typeof k?a.trim(k):"")||window.location.href||"")&&(k=(k.match(/^([^#]+)/)||[])[1]);b=a.extend(!0,{url:k,success:a.ajaxSettings.success,type:n||a.ajaxSettings.type,
iframeSrc:/^https/i.test(window.location.href||"")?"javascript:false":"about:blank"},b);k={};this.trigger("form-pre-serialize",[this,b,k]);if(k.veto)return d("ajaxSubmit: submit vetoed via form-pre-serialize trigger"),this;if(b.beforeSerialize&&!1===b.beforeSerialize(this,b))return d("ajaxSubmit: submit aborted via beforeSerialize callback"),this;var p=b.traditional;void 0===p&&(p=a.ajaxSettings.traditional);var s=[],m,t=this.formToArray(b.semantic,s);b.data&&(b.extraData=b.data,m=a.param(b.data,
p));if(b.beforeSubmit&&!1===b.beforeSubmit(t,this,b))return d("ajaxSubmit: submit aborted via beforeSubmit callback"),this;this.trigger("form-submit-validate",[t,this,b,k]);if(k.veto)return d("ajaxSubmit: submit vetoed via form-submit-validate trigger"),this;k=a.param(t,p);m&&(k=k?k+"&"+m:m);"GET"==b.type.toUpperCase()?(b.url+=(0<=b.url.indexOf("?")?"&":"?")+k,b.data=null):b.data=k;var u=[];b.resetForm&&u.push(function(){q.resetForm()});b.clearForm&&u.push(function(){q.clearForm(b.includeHidden)});
if(!b.dataType&&b.target){var g=b.success||function(){};u.push(function(c){var d=b.replaceTarget?"replaceWith":"html";a(b.target)[d](c).each(g,arguments)})}else b.success&&u.push(b.success);b.success=function(a,c,d){for(var e=b.context||this,f=0,g=u.length;f<g;f++)u[f].apply(e,[a,c,d||q,q])};if(b.error){var D=b.error;b.error=function(a,c,d){D.apply(b.context||this,[a,c,d,q])}}if(b.complete){var w=b.complete;b.complete=function(a,c){w.apply(b.context||this,[a,c,q])}}m=0<a("input[type=file]:enabled",
this).filter(function(){return""!==a(this).val()}).length;k="multipart/form-data"==q.attr("enctype")||"multipart/form-data"==q.attr("encoding");p=e&&f;d("fileAPI :"+p);var v;if(!1!==b.iframe&&(b.iframe||(m||k)&&!p))b.closeKeepAlive?a.get(b.closeKeepAlive,function(){v=c(t)}):v=c(t);else if((m||k)&&p){var l=new FormData;for(k=0;k<t.length;k++)l.append(t[k].name,t[k].value);if(b.extraData){k=a.param(b.extraData,b.traditional).split("&");p=k.length;m=[];var y,E;for(y=0;y<p;y++)k[y]=k[y].replace(/\+/g,
" "),E=k[y].split("="),m.push([decodeURIComponent(E[0]),decodeURIComponent(E[1])]);for(k=0;k<m.length;k++)m[k]&&l.append(m[k][0],m[k][1])}b.data=null;m=a.extend(!0,{},a.ajaxSettings,b,{contentType:!1,processData:!1,cache:!1,type:n||"POST"});b.uploadProgress&&(m.xhr=function(){var c=a.ajaxSettings.xhr();c.upload&&c.upload.addEventListener("progress",function(a){var c=0,d=a.loaded||a.position,e=a.total;a.lengthComputable&&(c=Math.ceil(100*(d/e)));b.uploadProgress(a,d,e,c)},!1);return c});m.data=null;
var A=m.beforeSend;m.beforeSend=function(a,c){c.data=b.formData?b.formData:l;A&&A.call(this,a,c)};v=a.ajax(m)}else v=a.ajax(b);q.removeData("jqxhr").data("jqxhr",v);for(m=0;m<s.length;m++)s[m]=null;this.trigger("form-submit-notify",[this,b]);return this};a.fn.ajaxForm=function(e){e=e||{};e.delegation=e.delegation&&a.isFunction(a.fn.on);if(!e.delegation&&0===this.length){var f=this.selector,h=this.context;if(!a.isReady&&f)return d("DOM not ready, queuing ajaxForm"),a(function(){a(f,h).ajaxForm(e)}),
...
c){var d=[];if(0===this.length)return d;var f=this[0],h=this.attr("id"),p=b?f.getElementsByTagName("*"):f.elements;p&&!/MSIE [678]/.test(navigator.userAgent)&&(p=a(p).get());h&&(h=a(':input[form="'+h+'"]').get(),h.length&&(p=(p||[]).concat(h)));if(!p||!p.length)return d;var s,m,t,u,g;s=0;for(g=p.length;s<g;s++)if(u=p[s],(h=u.name)&&!u.disabled)if(b&&f.clk&&"image"==u.type)f.clk==u&&(d.push({name:h,value:a(u).val(),type:u.type}),d.push({name:h+".x",value:f.clk_x},{name:h+".y",value:f.clk_y}));else if((t=
a.fieldValue(u,!0))&&t.constructor==Array){c&&c.push(u);m=0;for(u=t.length;m<u;m++)d.push({name:h,value:t[m]})}else if(e&&"file"==u.type)if(c&&c.push(u),t=u.files,t.length)for(m=0;m<t.length;m++)d.push({name:h,value:t[m],type:u.type});else d.push({name:h,value:"",type:u.type});else null!==t&&"undefined"!=typeof t&&(c&&c.push(u),d.push({name:h,value:t,type:u.type,required:u.required}));if(!b&&f.clk&&(p=a(f.clk),s=p[0],(h=s.name)&&!s.disabled&&"image"==s.type))d.push({name:h,value:p.val()}),d.push({name:h+
...
c.screenY===d.data("selectBox-down-at-y")||(d.removeData("selectBox-down-at-x").removeData("selectBox-down-at-y"),p(b,a(this).parent()),q())}).bind("mouseover.selectBox",function(){s(b,a(this).parent())}).bind("mouseout.selectBox",function(){m(b,a(this).parent())});var f=b.attr("class")||"";if(""!==f){var f=f.split(" "),g;for(g in f)d.addClass(f[g]+"-selectBox-dropdown-menu")}D(d);return d}},i=function(b){return("selectBox-label "+(a(b).find("OPTION:selected").attr("class")||"")).replace(/\s+$/,"")},
j=function(b){return a(b).find("OPTION:selected").text()||"\u00a0"},n=function(b){var b=a(b),c=b.data("selectBox-control");c&&c.find(".selectBox-label").attr("class",i(b)).text(j(b))},k=function(b){var b=a(b),c=b.data("selectBox-control"),d=b.data("selectBox-settings"),e=c.data("selectBox-options");if(c.hasClass("selectBox-disabled"))return!1;q();var f=isNaN(c.css("borderBottomWidth"))?0:parseInt(c.css("borderBottomWidth"));e.width(c.innerWidth()).css({top:c.offset().top+c.outerHeight()-f,left:c.offset().left});
if(b.triggerHandler("beforeopen"))return!1;f=function(){b.triggerHandler("open",{_selectBox:!0})};switch(d.menuTransition){case "fade":e.fadeIn(d.menuSpeed,f);break;case "slide":e.slideDown(d.menuSpeed,f);break;default:e.show(d.menuSpeed,f)}d.menuSpeed||f();d=e.find(".selectBox-selected:first");t(b,d,!0);s(b,d);c.addClass("selectBox-menuShowing");a(document).bind("mousedown.selectBox",function(b){a(b.target).parents().andSelf().hasClass("selectBox-options")||q()})},q=function(){0!==a(".selectBox-dropdown-menu:visible").length&&
...
t=function(b,c,d){if(c&&0!==c.length){var b=a(b),b=b.data("selectBox-control"),e=b.data("selectBox-options"),b=b.hasClass("selectBox-dropdown")?e:e.parent(),e=parseInt(c.offset().top-b.position().top),f=parseInt(e+c.outerHeight());d?b.scrollTop(c.offset().top-b.offset().top+b.scrollTop()-b.height()/2):(0>e&&b.scrollTop(c.offset().top-b.offset().top+b.scrollTop()),f>b.height()&&b.scrollTop(c.offset().top+c.outerHeight()-b.offset().top+b.scrollTop()-b.height()))}},u=function(b,c){var b=a(b),d=b.data("selectBox-control"),
...
function(a){u(c,a)}).bind("keypress.selectBox",function(a){g(c,a)}).bind("mousedown.selectBox",function(b){a(b.target).is("A.selectBox-inline")&&b.preventDefault();e.hasClass("selectBox-focus")||e.focus()}).insertAfter(c),!c[0].style.height){var f=c.attr("size")?parseInt(c.attr("size")):5,n=e.clone().removeAttr("id").css({position:"absolute",top:"-9999em"}).show().appendTo("body");n.find(".selectBox-options").html("<li><a>\u00a0</a></li>");var p=parseInt(n.find(".selectBox-options A:first").html("&nbsp;").outerHeight());
n.remove();e.height(p*f)}}else f=a('<span class="selectBox-label" />'),n=a('<span class="selectBox-arrow" />'),f.attr("class",i(c)).text(j(c)),d=h(c,"dropdown"),d.appendTo("BODY"),e.data("selectBox-options",d).addClass("selectBox-dropdown").append(f).append(n).bind("mousedown.selectBox",function(a){e.hasClass("selectBox-menuShowing")?q():(a.stopPropagation(),d.data("selectBox-down-at-x",a.screenX).data("selectBox-down-at-y",a.screenY),k(c))}).bind("keydown.selectBox",function(a){u(c,a)}).bind("keypress.selectBox",
function(a){g(c,a)}).bind("open.selectBox",function(a,b){b&&!0===b._selectBox||k(c)}).bind("close.selectBox",function(a,b){b&&!0===b._selectBox||q()}).insertAfter(c),n=e.width()-n.outerWidth()-parseInt(f.css("paddingLeft"))-parseInt(f.css("paddingLeft")),f.width(n);D(e);c.addClass("selectBox").data("selectBox-control",e).data("selectBox-settings",m).hide()}})}return a(this)}})}(jQuery);(function(){function a(a){return function(b,c,d,e){var c=D(c,e,4),f=!x(b)&&g.keys(b),h=(f||b).length,i=0<a?0:h-1;3>arguments.length&&(d=b[f?f[i]:i],i+=a);for(var j=c,k=d;0<=i&&i<h;i+=a)var l=f?f[i]:i,k=j(k,b[l],l,b);return k}}function b(a){return function(b,c,d){for(var c=w(c,d),d=A(b),e=0<a?0:d-1;0<=e&&e<d;e+=a)if(c(b[e],e,b))return e;return-1}}function c(a,b,c){return function(d,e,f){var h=0,i=A(d);if("number"==typeof f)0<a?h=0<=f?f:Math.max(f+i,h):i=0<=f?Math.min(f+1,i):f+i+1;else if(c&&f&&i)return f=
c(d,e),d[f]===e?f:-1;if(e!==e)return f=b(n.call(d,h,i),g.isNaN),0<=f?f+h:-1;for(f=0<a?h:i-1;0<=f&&f<i;f+=a)if(d[f]===e)return f;return-1}}function d(a,b){var c=Q.length,d=a.constructor,d=g.isFunction(d)&&d.prototype||i,e="constructor";for(g.has(a,e)&&!g.contains(b,e)&&b.push(e);c--;)e=Q[c],e in a&&(a[e]!==d[e]&&!g.contains(b,e))&&b.push(e)}var e=this,f=e._,h=Array.prototype,i=Object.prototype,j=h.push,n=h.slice,k=i.toString,q=i.hasOwnProperty,p=Array.isArray,s=Object.keys,m=Function.prototype.bind,
t=Object.create,u=function(){},g=function(a){if(a instanceof g)return a;if(!(this instanceof g))return new g(a);this._wrapped=a};"undefined"!==typeof exports?("undefined"!==typeof module&&module.exports&&(exports=module.exports=g),exports._=g):e._=g;g.VERSION="1.8.3";var D=function(a,b,c){if(void 0===b)return a;switch(null==c?3:c){case 1:return function(c){return a.call(b,c)};case 2:return function(c,d){return a.call(b,c,d)};case 3:return function(c,d,e){return a.call(b,c,d,e)};case 4:return function(c,
d,e,f){return a.call(b,c,d,e,f)}}return function(){return a.apply(b,arguments)}},w=function(a,b,c){return null==a?g.identity:g.isFunction(a)?D(a,b,c):g.isObject(a)?g.matcher(a):g.property(a)};g.iteratee=function(a,b){return w(a,b,Infinity)};var v=function(a,b){return function(c){var d=arguments.length;if(2>d||null==c)return c;for(var e=1;e<d;e++)for(var f=arguments[e],g=a(f),h=g.length,i=0;i<h;i++){var j=g[i];if(!b||void 0===c[j])c[j]=f[j]}return c}},l=function(a){if(!g.isObject(a))return{};if(t)return t(a);
u.prototype=a;a=new u;u.prototype=null;return a},y=function(a){return function(b){return null==b?void 0:b[a]}},E=Math.pow(2,53)-1,A=y("length"),x=function(a){a=A(a);return"number"==typeof a&&0<=a&&a<=E};g.each=g.forEach=function(a,b,c){var b=D(b,c),d;if(x(a)){c=0;for(d=a.length;c<d;c++)b(a[c],c,a)}else{var e=g.keys(a),c=0;for(d=e.length;c<d;c++)b(a[e[c]],e[c],a)}return a};g.map=g.collect=function(a,b,c){for(var b=w(b,c),c=!x(a)&&g.keys(a),d=(c||a).length,e=Array(d),f=0;f<d;f++){var h=c?c[f]:f;e[f]=
b(a[h],h,a)}return e};g.reduce=g.foldl=g.inject=a(1);g.reduceRight=g.foldr=a(-1);g.find=g.detect=function(a,b,c){b=x(a)?g.findIndex(a,b,c):g.findKey(a,b,c);if(void 0!==b&&-1!==b)return a[b]};g.filter=g.select=function(a,b,c){var d=[],b=w(b,c);g.each(a,function(a,c,e){b(a,c,e)&&d.push(a)});return d};g.reject=function(a,b,c){return g.filter(a,g.negate(w(b)),c)};g.every=g.all=function(a,b,c){for(var b=w(b,c),c=!x(a)&&g.keys(a),d=(c||a).length,e=0;e<d;e++){var f=c?c[e]:e;if(!b(a[f],f,a))return!1}return!0};
g.some=g.any=function(a,b,c){for(var b=w(b,c),c=!x(a)&&g.keys(a),d=(c||a).length,e=0;e<d;e++){var f=c?c[e]:e;if(b(a[f],f,a))return!0}return!1};g.contains=g.includes=g.include=function(a,b,c,d){x(a)||(a=g.values(a));if("number"!=typeof c||d)c=0;return 0<=g.indexOf(a,b,c)};g.invoke=function(a,b){var c=n.call(arguments,2),d=g.isFunction(b);return g.map(a,function(a){var e=d?b:a[b];return null==e?e:e.apply(a,c)})};g.pluck=function(a,b){return g.map(a,g.property(b))};g.where=function(a,b){return g.filter(a,
g.matcher(b))};g.findWhere=function(a,b){return g.find(a,g.matcher(b))};g.max=function(a,b,c){var d=-Infinity,e=-Infinity,f;if(null==b&&null!=a)for(var a=x(a)?a:g.values(a),h=0,i=a.length;h<i;h++)c=a[h],c>d&&(d=c);else b=w(b,c),g.each(a,function(a,c,g){f=b(a,c,g);if(f>e||-Infinity===f&&-Infinity===d)d=a,e=f});return d};g.min=function(a,b,c){var d=Infinity,e=Infinity,f;if(null==b&&null!=a)for(var a=x(a)?a:g.values(a),h=0,i=a.length;h<i;h++)c=a[h],c<d&&(d=c);else b=w(b,c),g.each(a,function(a,c,g){f=
b(a,c,g);if(f<e||Infinity===f&&Infinity===d)d=a,e=f});return d};g.shuffle=function(a){for(var a=x(a)?a:g.values(a),b=a.length,c=Array(b),d=0,e;d<b;d++)e=g.random(0,d),e!==d&&(c[d]=c[e]),c[e]=a[d];return c};g.sample=function(a,b,c){return null==b||c?(x(a)||(a=g.values(a)),a[g.random(a.length-1)]):g.shuffle(a).slice(0,Math.max(0,b))};g.sortBy=function(a,b,c){b=w(b,c);return g.pluck(g.map(a,function(a,c,d){return{value:a,index:c,criteria:b(a,c,d)}}).sort(function(a,b){var c=a.criteria,d=b.criteria;if(c!==
d){if(c>d||void 0===c)return 1;if(c<d||void 0===d)return-1}return a.index-b.index}),"value")};var H=function(a){return function(b,c,d){var e={},c=w(c,d);g.each(b,function(d,f){var g=c(d,f,b);a(e,d,g)});return e}};g.groupBy=H(function(a,b,c){g.has(a,c)?a[c].push(b):a[c]=[b]});g.indexBy=H(function(a,b,c){a[c]=b});g.countBy=H(function(a,b,c){g.has(a,c)?a[c]++:a[c]=1});g.toArray=function(a){return!a?[]:g.isArray(a)?n.call(a):x(a)?g.map(a,g.identity):g.values(a)};g.size=function(a){return null==a?0:x(a)?
a.length:g.keys(a).length};g.partition=function(a,b,c){var b=w(b,c),d=[],e=[];g.each(a,function(a,c,f){(b(a,c,f)?d:e).push(a)});return[d,e]};g.first=g.head=g.take=function(a,b,c){return null==a?void 0:null==b||c?a[0]:g.initial(a,a.length-b)};g.initial=function(a,b,c){return n.call(a,0,Math.max(0,a.length-(null==b||c?1:b)))};g.last=function(a,b,c){return null==a?void 0:null==b||c?a[a.length-1]:g.rest(a,Math.max(0,a.length-b))};g.rest=g.tail=g.drop=function(a,b,c){return n.call(a,null==b||c?1:b)};g.compact=
function(a){return g.filter(a,g.identity)};var F=function(a,b,c,d){for(var e=[],f=0,d=d||0,h=A(a);d<h;d++){var i=a[d];if(x(i)&&(g.isArray(i)||g.isArguments(i))){b||(i=F(i,b,c));var j=0,k=i.length;for(e.length+=k;j<k;)e[f++]=i[j++]}else c||(e[f++]=i)}return e};g.flatten=function(a,b){return F(a,b,!1)};g.without=function(a){return g.difference(a,n.call(arguments,1))};g.uniq=g.unique=function(a,b,c,d){g.isBoolean(b)||(d=c,c=b,b=!1);null!=c&&(c=w(c,d));for(var d=[],e=[],f=0,h=A(a);f<h;f++){var i=a[f],
j=c?c(i,f,a):i;b?((!f||e!==j)&&d.push(i),e=j):c?g.contains(e,j)||(e.push(j),d.push(i)):g.contains(d,i)||d.push(i)}return d};g.union=function(){return g.uniq(F(arguments,!0,!0))};g.intersection=function(a){for(var b=[],c=arguments.length,d=0,e=A(a);d<e;d++){var f=a[d];if(!g.contains(b,f)){for(var h=1;h<c&&g.contains(arguments[h],f);h++);h===c&&b.push(f)}}return b};g.difference=function(a){var b=F(arguments,!0,!0,1);return g.filter(a,function(a){return!g.contains(b,a)})};g.zip=function(){return g.unzip(arguments)};
g.unzip=function(a){for(var b=a&&g.max(a,A).length||0,c=Array(b),d=0;d<b;d++)c[d]=g.pluck(a,d);return c};g.object=function(a,b){for(var c={},d=0,e=A(a);d<e;d++)b?c[a[d]]=b[d]:c[a[d][0]]=a[d][1];return c};g.findIndex=b(1);g.findLastIndex=b(-1);g.sortedIndex=function(a,b,c,d){for(var c=w(c,d,1),b=c(b),d=0,e=A(a);d<e;){var f=Math.floor((d+e)/2);c(a[f])<b?d=f+1:e=f}return d};g.indexOf=c(1,g.findIndex,g.sortedIndex);g.lastIndexOf=c(-1,g.findLastIndex);g.range=function(a,b,c){null==b&&(b=a||0,a=0);for(var c=
c||1,b=Math.max(Math.ceil((b-a)/c),0),d=Array(b),e=0;e<b;e++,a+=c)d[e]=a;return d};var M=function(a,b,c,d,e){if(!(d instanceof b))return a.apply(c,e);b=l(a.prototype);a=a.apply(b,e);return g.isObject(a)?a:b};g.bind=function(a,b){if(m&&a.bind===m)return m.apply(a,n.call(arguments,1));if(!g.isFunction(a))throw new TypeError("Bind must be called on a function");var c=n.call(arguments,2),d=function(){return M(a,d,b,this,c.concat(n.call(arguments)))};return d};g.partial=function(a){var b=n.call(arguments,
...
{};return c};g.delay=function(a,b){var c=n.call(arguments,2);return setTimeout(function(){return a.apply(null,c)},b)};g.defer=g.partial(g.delay,g,1);g.throttle=function(a,b,c){var d,e,f,h=null,i=0;c||(c={});var j=function(){i=!1===c.leading?0:g.now();h=null;f=a.apply(d,e);h||(d=e=null)};return function(){var k=g.now();!i&&!1===c.leading&&(i=k);var l=b-(k-i);d=this;e=arguments;0>=l||l>b?(h&&(clearTimeout(h),h=null),i=k,f=a.apply(d,e),h||(d=e=null)):!h&&!1!==c.trailing&&(h=setTimeout(j,l));return f}};
g.debounce=function(a,b,c){var d,e,f,h,i,j=function(){var k=g.now()-h;k<b&&0<=k?d=setTimeout(j,b-k):(d=null,c||(i=a.apply(f,e),d||(f=e=null)))};return function(){f=this;e=arguments;h=g.now();var k=c&&!d;d||(d=setTimeout(j,b));k&&(i=a.apply(f,e),f=e=null);return i}};g.wrap=function(a,b){return g.partial(b,a)};g.negate=function(a){return function(){return!a.apply(this,arguments)}};g.compose=function(){var a=arguments,b=a.length-1;return function(){for(var c=b,d=a[b].apply(this,arguments);c--;)d=a[c].call(this,
...
return b};g.allKeys=function(a){if(!g.isObject(a))return[];var b=[],c;for(c in a)b.push(c);N&&d(a,b);return b};g.values=function(a){for(var b=g.keys(a),c=b.length,d=Array(c),e=0;e<c;e++)d[e]=a[b[e]];return d};g.mapObject=function(a,b,c){for(var b=w(b,c),c=g.keys(a),d=c.length,e={},f,h=0;h<d;h++)f=c[h],e[f]=b(a[f],f,a);return e};g.pairs=function(a){for(var b=g.keys(a),c=b.length,d=Array(c),e=0;e<c;e++)d[e]=[b[e],a[b[e]]];return d};g.invert=function(a){for(var b={},c=g.keys(a),d=0,e=c.length;d<e;d++)b[a[c[d]]]=
c[d];return b};g.functions=g.methods=function(a){var b=[],c;for(c in a)g.isFunction(a[c])&&b.push(c);return b.sort()};g.extend=v(g.allKeys);g.extendOwn=g.assign=v(g.keys);g.findKey=function(a,b,c){for(var b=w(b,c),c=g.keys(a),d,e=0,f=c.length;e<f;e++)if(d=c[e],b(a[d],d,a))return d};g.pick=function(a,b,c){var d={},e=a,f,h;if(null==e)return d;g.isFunction(b)?(h=g.allKeys(e),f=D(b,c)):(h=F(arguments,!1,!1,1),f=function(a,b,c){return b in c},e=Object(e));for(var i=0,j=h.length;i<j;i++){var k=h[i],l=e[k];
f(l,k,e)&&(d[k]=l)}return d};g.omit=function(a,b,c){if(g.isFunction(b))b=g.negate(b);else var d=g.map(F(arguments,!1,!1,1),String),b=function(a,b){return!g.contains(d,b)};return g.pick(a,b,c)};g.defaults=v(g.allKeys,!0);g.create=function(a,b){var c=l(a);b&&g.extendOwn(c,b);return c};g.clone=function(a){return!g.isObject(a)?a:g.isArray(a)?a.slice():g.extend({},a)};g.tap=function(a,b){b(a);return a};g.isMatch=function(a,b){var c=g.keys(b),d=c.length;if(null==a)return!d;for(var e=Object(a),f=0;f<d;f++){var h=
...
q.call(a,b)};g.noConflict=function(){e._=f;return this};g.identity=function(a){return a};g.constant=function(a){return function(){return a}};g.noop=function(){};g.property=y;g.propertyOf=function(a){return null==a?function(){}:function(b){return a[b]}};g.matcher=g.matches=function(a){a=g.extendOwn({},a);return function(b){return g.isMatch(b,a)}};g.times=function(a,b,c){for(var d=Array(Math.max(0,a)),b=D(b,c,1),c=0;c<a;c++)d[c]=b(c);return d};g.random=function(a,b){null==b&&(b=a,a=0);return a+Math.floor(Math.random()*
(b-a+1))};g.now=Date.now||function(){return(new Date).getTime()};p={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#x27;","`":"&#x60;"};v=g.invert(p);y=function(a){var b=function(b){return a[b]},c="(?:"+g.keys(a).join("|")+")",d=RegExp(c),e=RegExp(c,"g");return function(a){a=null==a?"":""+a;return d.test(a)?a.replace(e,b):a}};g.escape=y(p);g.unescape=y(v);g.result=function(a,b,c){b=null==a?void 0:a[b];void 0===b&&(b=c);return g.isFunction(b)?b.call(a):b};var U=0;g.uniqueId=function(a){var b=
...
"){\n"+e+"}";return c};g.chain=function(a){a=g(a);a._chain=!0;return a};var L=function(a,b){return a._chain?g(b).chain():b};g.mixin=function(a){g.each(g.functions(a),function(b){var c=g[b]=a[b];g.prototype[b]=function(){var a=[this._wrapped];j.apply(a,arguments);return L(this,c.apply(g,a))}})};g.mixin(g);g.each("pop push reverse shift sort splice unshift".split(" "),function(a){var b=h[a];g.prototype[a]=function(){var c=this._wrapped;b.apply(c,arguments);("shift"===a||"splice"===a)&&0===c.length&&
delete c[0];return L(this,c)}});g.each(["concat","join","slice"],function(a){var b=h[a];g.prototype[a]=function(){return L(this,b.apply(this._wrapped,arguments))}});g.prototype.value=function(){return this._wrapped};g.prototype.valueOf=g.prototype.toJSON=g.prototype.value;g.prototype.toString=function(){return""+this._wrapped};"function"===typeof define&&define.amd&&define("underscore",[],function(){return g})}).call(this);(function(a){a.pkp=a.pkp||{};a.pkp.classes=a.pkp.classes||{};a.pkp.controllers=a.pkp.controllers||{};a.pkp.plugins=a.pkp.plugins||{};a.pkp.plugins.blocks=a.pkp.plugins.blocks||{};a.pkp.plugins.generic=a.pkp.plugins.generic||{};a.pkp.plugins.pubIds=a.pkp.plugins.pubIds||{};a.pkp.plugins.importexport=a.pkp.plugins.importexport||{};a.pkp.classes.Helper=function(){throw Error("Trying to instantiate the Helper singleton!");};a.pkp.classes.Helper.CHARS_="0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz".split("");
...
this.$linkActionElement.focus();this.$modal_.remove();return this.parent("finish")}})(jQuery);(function(a){a.pkp.classes.notification=a.pkp.classes.notification||{};a.pkp.classes.notification.NotificationHelper=function(){};a.pkp.classes.notification.NotificationHelper.redirectNotifyUserEvent=function(b,c){var d,e,f,h,i,j,n,k,q,p,s;if(void 0!==c.content)b.getHtmlElement().parent().trigger("notifyUser",[c]);else{d=b.getHtmlElement();e=!1;!(b instanceof a.pkp.controllers.SiteHandler)&&0<a(c).parents(".pkp_controllers_grid").length&&(d.parent().trigger("notifyUser"),e=!0);d=a(".pkp_notification",
d);f=[];h=0;for(i=d.length;h<i;h++)if(n=a(d[h]),!(0<n.parents(":hidden").length)){j=n.parents();q=0;for(p=j.length;q<p;q++)if(k=a(j[q]).data("pkp.handler"),k instanceof a.pkp.classes.Handler){s=a(j[q]);break}if(s.has(c[0]).length||s[0]===c[0]){if(0<n.parents(".ui-accordion:first").length&&(j=n.parents(".ui-accordion:first"),!j.has(c[0])))continue;f.push(n)}}if(f.length)for(h=f.length-1;-1<h;h--)f[h].triggerHandler("notifyUser");else e||b.getHtmlElement().parent().trigger("notifyUser")}}})(jQuery);(function(a){a.pkp.classes.features=a.pkp.classes.features||{};a.pkp.classes.features.Feature=function(a,c){this.gridHandler=a;this.options_=c;this.addFeatureHtml(this.getGridHtmlElement(),c)};a.pkp.classes.features.Feature.prototype.gridHandler=null;a.pkp.classes.features.Feature.prototype.options_=null;a.pkp.classes.features.Feature.prototype.setOptions=function(a){this.options_=a};a.pkp.classes.features.Feature.prototype.getOptions=function(){return this.options_};a.pkp.classes.features.Feature.prototype.init=
...
f=this.gridHandler.callbackWrapper(this.dragStartCallback,this),h=this.gridHandler.callbackWrapper(this.dragStopCallback,this),i=this.gridHandler.callbackWrapper(this.updateOrderCallback,this),c={disabled:!e,items:c,activate:f,deactivate:h,update:i,tolerance:"pointer"};"object"===typeof d&&(c=a.extend(!0,c,d));b.sortable(c)};a.pkp.classes.features.OrderItemsFeature.prototype.getRowsDataId=function(b){var c,d=[],e;for(c in this.itemsOrder)e=a("#"+this.itemsOrder[c],b),1>e.length||(e=this.gridHandler.getRowDataId(e),
...
function(){if("undefined"!==typeof tinyMCE){tinyMCE.PluginManager.load("jbimages",a.pkp.app.baseUrl+"/plugins/generic/tinymce/plugins/justboil.me/plugin.js");tinyMCE.PluginManager.load("pkpTags",a.pkp.app.baseUrl+"/plugins/generic/tinymce/plugins/pkpTags/plugin.js");tinyMCE.PluginManager.load("pkpwordcount",a.pkp.app.baseUrl+"/plugins/generic/tinymce/plugins/pkpWordcount/plugin.js");var b=a.pkp.app.tinyMceContentCSS;a.pkp.app.cdnEnabled&&(b=b+", "+a.pkp.app.tinyMceContentFont);b={width:"100%",resize:"both",
entity_encoding:"raw",plugins:"paste,fullscreen,link,lists,code,-jbimages,-pkpTags,noneditable",convert_urls:!1,forced_root_block:"p",paste_auto_cleanup_on_paste:!0,apply_source_formatting:!1,theme:"modern",toolbar:"copy paste | bold italic underline | link unlink code fullscreen | jbimages | pkpTags",richToolbar:"copy paste | bold italic underline | bullist numlist | superscript subscript | link unlink code fullscreen | jbimages | pkpTags",statusbar:!1,content_css:b};b="undefined"!==typeof a.pkp.plugins.tinymceplugin&&
typeof a.pkp.plugins.tinymceplugin.tinymceParams?a.extend({},b,a.pkp.plugins.tinymceplugin.tinymceParams):a.extend({},b);b.init_instance_callback=a.pkp.controllers.SiteHandler.prototype.triggerTinyMCEInitialized;b.setup=a.pkp.controllers.SiteHandler.prototype.triggerTinyMCESetup;tinyMCE.init(b)}};a.pkp.controllers.SiteHandler.prototype.triggerTinyMCEInitialized=function(b){a("#"+a.pkp.classes.Helper.escapeJQuerySelector(b.id)).trigger("tinyMCEInitialized",[b])};a.pkp.controllers.SiteHandler.prototype.triggerTinyMCESetup=
function(b){var c=a("#"+a.pkp.classes.Helper.escapeJQuerySelector(b.id));c.attr("readonly")&&(b.settings.readonly=!0);c.attr("wordCount")&&0<c.attr("wordCount")&&(b.settings.plugins+=",pkpwordcount",b.settings.statusbar=!0);c=c.attr("rows")||10;b.settings.height=(20*c).toString()+"px";b.on("init",function(b){var c=a("#"+b.id),f,h;f=a("#"+b.id).attr("placeholder");""!==f&&(h=a("<span></span>"),h.html(f),h.addClass("mcePlaceholder"),h.attr("id","mcePlaceholder-"+b.id),b.target.getContent().length&&
h.hide(),b=a("<div></div>"),b.addClass("mcePlaceholderParent"),c.wrap(b),c.parent().append(h))});b.on("activate",function(b){a("#mcePlaceholder-"+b.id).hide()});b.on("deactivate",function(b){b.target.getContent().length||a("#mcePlaceholder-"+b.id).show();b.target.dom.addClass(b.target.dom.select("li"),"show")});b.on("BeforeSetContent",function(c){var e=a.pkp.classes.TinyMCEHelper.prototype.getVariableMap("#"+a.pkp.classes.Helper.escapeJQuerySelector(b.id));c.content=c.content.replace(/\{\$([a-zA-Z]+)\}(?![^<]*>)/g,
...
d.split("#")[1];e=a.find("li a");for(f=0;f<e.length;f++)d==e[f].getAttribute("name")&&(c.selected=f)}a.tabs({ajaxOptions:{dataType:"json",cache:!1,dataFilter:this.callbackWrapper(this.dataFilter)},disabled:c.disabled,active:c.selected});window.addEventListener("hashchange",function(c){c=c.newURL.split("#");2>c.length||(c=c[1],c=a.find('li > a[name="'+c+'"]'),c.length&&c.click())},!1)};a.pkp.classes.Helper.inherits(a.pkp.controllers.TabHandler,a.pkp.classes.Handler);a.pkp.controllers.TabHandler.prototype.$currentTab_=
...
null;a.pkp.controllers.NotificationHandler.prototype.fetchNotificationHandler_=function(){var b={};b.requestOptions=this.options_.requestOptions;a.ajax({type:"POST",url:this.options_.fetchNotificationUrl,data:b,success:this.callbackWrapper(this.showNotificationResponseHandler_),dataType:"json",async:!1})};a.pkp.controllers.NotificationHandler.prototype.showNotificationResponseHandler_=function(b,c){clearTimeout(this.trivialTimer_);var d=this.getHtmlElement(),e=this.handleJson(c),f,h,i;if(!1!==e)if(e.content.inPlace){f=
...
errorClass:"error",highlight:function(b,c){a(b).parent().parent().addClass(c)},unhighlight:function(b,c){a(b).parent().parent().removeClass(c)},submitHandler:this.callbackWrapper(this.submitHandler_),showErrors:this.callbackWrapper(this.showErrors),errorPlacement:function(a,b){b.is(":checkbox")?b.parent().closest(":not(label)").append(a):a.insertAfter(b)}});a("[id^='cancelFormButton-']",b).click(this.callbackWrapper(this.cancelForm));b.find(".showMore, .showLess").bind("click",this.switchViz);d.checkForm()?
...
null),"json")):this.enableControls(),this.callFeaturesHook("addElement",d));return!1};a.pkp.controllers.listbuilder.ListbuilderHandler.prototype.fetchOptionsResponseHandler_=function(b,c){var d=this.handleJson(c),e=this.getHtmlElement(),f=[],h,i,j,n,k,q,p,s,m,t;if(!1!==d){e.find(".gridCellDisplay :input").each(function(b,c){f[b]=a(c).val()});e=e.find(".gridRowEdit:visible .selectMenu:input");h=0;for(i=e.length;h<i;h++){j=a(e[h]);n=j.parents(".gridCellContainer");k=0;j.children().empty();q=null;for(q in d.content[h])if(q!=
a.pkp.cons.LISTBUILDER_OPTGROUP_LABEL)if("object"==typeof d.content[h][q]){if(void 0!==d.content[h][a.pkp.cons.LISTBUILDER_OPTGROUP_LABEL]&&"object"==typeof d.content[h][a.pkp.cons.LISTBUILDER_OPTGROUP_LABEL]&&(s=d.content[h][a.pkp.cons.LISTBUILDER_OPTGROUP_LABEL][q])){m=a("<optgroup></optgroup>");m.attr("label",s);j.append(m);s=null;t=0;for(s in d.content[h][q])if(p=this.populatePulldown_(m,f,d.content[h][q][s],s))k++,t++;0===t&&m.remove()}}else(p=this.populatePulldown_(j,f,d.content[h][q],q))&&
k++;j=p;1===k&&j&&(j.attr("selected","selected"),this.availableOptions_=!1);0===k&&(n.find(".gridCellDisplay").show(),n.find(".gridCellEdit").hide())}}this.enableControls();return!1};a.pkp.controllers.listbuilder.ListbuilderHandler.prototype.populatePulldown_=function(b,c,d,e){var f=b.parents(".gridCellContainer").find(".gridCellDisplay :input").val(),h=!1,i;if(e!=f)for(i=0;i<c.length;i++)c[i]==e&&(h=!0);if(h)return!1;c=a("<option/>");c.attr("value",e);c.text(d);e==f&&c.attr("selected","selected");
...
function(a,c){var d=this.getHtmlElement();0<parseInt(d.find("#revisedFileId").val(),10)&&(d.submit(),c.preventDefault())};a.pkp.controllers.wizard.fileUpload.form.RevisionConfirmationHandler.prototype.handleResponse=function(a,c){!0===c.status&&this.trigger("fileUploaded",c.uploadedFile);return this.parent("handleResponse",a,c)}})(jQuery);(function(a){a.pkp.controllers.grid.navigationMenus=a.pkp.controllers.grid.navigationMenus||{form:{}};a.pkp.controllers.grid.navigationMenus.form.NavigationMenuFormHandler=function(a,c){this.okButton_=c.okButton;this.warningModalTitle_=c.warningModalTitle;this.submenuWarning_=c.submenuWarning;this.itemTypeConditionalWarnings_=c.itemTypeConditionalWarnings;a.on("click",".btnConditionalDisplay",this.callbackWrapper(this.showConditionalDisplayWarning));a.on("click",".btnSubmenuWarning",this.callbackWrapper(this.showSubmenuWarning));
...
this.getFetchExtraParams();d.selectedNotificationIds=c.content;this.setFetchExtraParams(d);this.handleJson(c)}})(jQuery);(function(a){a.pkp.controllers.tab=a.pkp.controllers.tab||{};a.pkp.controllers.tab.workflow=a.pkp.controllers.tab.workflow||{};a.pkp.controllers.tab.workflow.WorkflowTabHandler=function(a,c){var d,e,f,h;this.parent(a,c);if(d=document.location.toString().match("workflow/([^/]+)/")){d=d[1];h=a.find("li a");for(f=0;f<h.length;f++)e=RegExp(d),h[f].getAttribute("class").match(e)&&(c.selected=f)}};a.pkp.classes.Helper.inherits(a.pkp.controllers.tab.workflow.WorkflowTabHandler,a.pkp.controllers.TabHandler)})(jQuery);jQuery.pkp.controllers.informationCenter=jQuery.pkp.controllers.informationCenter||{};
...
60;c<b.height()&&b.height(c).css("overflow-y","scroll")};a.pkp.pages.header.TasksHandler.prototype.fetchUnreadNotificationsCountHandler_=function(){a.get(this.options_.fetchUnreadNotificationsCountUrl,this.callbackWrapper(this.updateUnreadNotificationsCountHandler_),"json")};a.pkp.pages.header.TasksHandler.prototype.updateUnreadNotificationsCountHandler_=function(a,c){var d=this.getHtmlElement().find("#unreadNotificationCount");d.html(c.content);"0"==c.content?d.removeClass("hasTasks"):d.addClass("hasTasks")}})(jQuery);(function(a){a.pkp.pages.submission=a.pkp.pages.submission||{};a.pkp.pages.submission.SubmissionTabHandler=function(a,c){this.parent(a,c);this.submissionProgress_=c.submissionProgress;this.cancelUrl_=c.cancelUrl;this.cancelConfirmText_=c.cancelConfirmText;this.bind("setStep",this.setStepHandler);this.bind("formCanceled",this.formCanceledHandler);this.getHtmlElement().tabs("option","disabled",this.getDisabledSteps(this.submissionProgress_))};a.pkp.classes.Helper.inherits(a.pkp.pages.submission.SubmissionTabHandler,
...
a.pkp.classes.Helper.inherits(a.pkp.controllers.tab.issueEntry.IssueEntryTabHandler,a.pkp.controllers.TabHandler);a.pkp.controllers.tab.issueEntry.IssueEntryTabHandler.prototype.tabContentUrl_=null;a.pkp.controllers.tab.issueEntry.IssueEntryTabHandler.prototype.gridRefreshRequested=function(b,c){a(c.target).attr("id").match(/^galleysGridContainer/)&&this.tabsUrl_&&this.tabContentUrl_&&a.get(this.tabsUrl_,null,this.callbackWrapper(this.updateTabsHandler_),"json")};a.pkp.controllers.tab.issueEntry.IssueEntryTabHandler.prototype.updateTabsHandler_=
function(a,c){var d=this.handleJson(c),e=this.getHtmlElement(),f=e.find("li a"),h={},i=/galley(\d+)/,j,n,k;for(n=0;n<f.length;n++)k=f[n].getAttribute("id"),k=i.exec(k),null!==k&&(h[k[1]]=n);for(j in d.galleys)h.hasOwnProperty(j)||(f=this.tabContentUrl_+"&galleyId="+encodeURIComponent(j),f=f.replace(/[$]/g,"$$$$"),e.tabs("add",f,d.galleys[j]),e.find("li a").filter(":last").attr("id","galley"+j));for(j in h)d.galleys.hasOwnProperty(j)?e.find("li a").filter('[id="galley'+j+'"]').html(d.galleys[j]):e.tabs("remove",
h[j])};a.pkp.controllers.tab.issueEntry.IssueEntryTabHandler.prototype.addGalleysGridRowActionHandlers_=function(){var b=a('[id^="galleysGridContainer"]',this.getHtmlElement());b.length&&(b=a('a[id*="galleyTab"]',b),b.click(this.callbackWrapper(this.galleysGridLinkClickHandler_)))};a.pkp.controllers.tab.issueEntry.IssueEntryTabHandler.prototype.galleysGridLinkClickHandler_=function(b){var c=a('[id^="galleysGridContainer"]',this.getHtmlElement()).children("div"),c=a.pkp.classes.Handler.getHandler(c),
b=c.getParentRow(a(b)),b=c.getRowDataId(b);this.getHtmlElement().tabs({active:this.getTabPositionByGalleyId_(b,this.getHtmlElement())})};a.pkp.controllers.tab.issueEntry.IssueEntryTabHandler.prototype.getTabPositionByGalleyId_=function(b,c){var d=a("#galley"+b,c).parent("li");return d.length?c.find("li").index(d):null}})(jQuery);(function(a){a.pkp.controllers.tab.issueEntry.form=a.pkp.controllers.tab.issueEntry.form||{};a.pkp.controllers.tab.issueEntry.form.IssueEntryPublicationMetadataFormHandler=function(b,c){this.parent(b,c);a("#paymentReceivedButton",b).click(this.callbackWrapper(this.paymentReceivedHandler));a("#waivePaymentButton",b).click(this.callbackWrapper(this.waivePaymentHandler));c.arePermissionsAttached&&b.find("#attachPermissions").prop("checked",!0);a("#issueId",b).change(this.callbackWrapper(this.checkAttachMetadata));
...
!0)}})(jQuery);(function(a){a.fn.pkpHandler=function(b,c){this.each(function(){var d=a(this);c=c||{};a.pkp.classes.Helper.objectFactory(b,[d,c])});return this};a.fn.pkpAjaxHtml=function(b,c){var d=this.first();a.ajax({url:b,dataType:"json",success:function(a){d.find("#loading").hide();!0===a.status?(a.content&&d.html(a.content),c&&c()):(d.trigger("ajaxHtmlError",a.content),alert(a.content))},error:function(){alert("Failed Ajax request or invalid JSON returned.")}});d.html("<div id='loading' class='throbber'></div>");
return this}})(jQuery);
