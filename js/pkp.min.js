...
arguments);var a=this.prop.apply(this,arguments);return a&&a.jquery||"string"===typeof a?a:this.attr.apply(this,arguments)};a.fn.ajaxSubmit=function(c){function b(d){d=a.param(d,c.traditional).split("&");var e=d.length,f=[],g,h;for(g=0;g<e;g++)d[g]=d[g].replace(/\+/g," "),h=d[g].split("="),f.push([decodeURIComponent(h[0]),decodeURIComponent(h[1])]);return f}function k(d){for(var e=new FormData,f=0;f<d.length;f++)e.append(d[f].name,d[f].value);if(c.extraData)for(d=b(c.extraData),f=0;f<d.length;f++)d[f]&&
e.append(d[f][0],d[f][1]);c.data=null;f=a.extend(!0,{},a.ajaxSettings,c,{contentType:!1,processData:!1,cache:!1,type:t||"POST"});c.uploadProgress&&(f.xhr=function(){var b=a.ajaxSettings.xhr();b.upload&&b.upload.addEventListener("progress",function(a){var b=0,d=a.loaded||a.position,e=a.total;a.lengthComputable&&(b=Math.ceil(100*(d/e)));c.uploadProgress(a,d,e,b)},!1);return b});f.data=null;var g=f.beforeSend;f.beforeSend=function(a,b){b.data=c.formData?c.formData:e;g&&g.call(this,a,b)};return a.ajax(f)}
function u(b){function e(a){var c=null;try{a.contentWindow&&(c=a.contentWindow.document)}catch(b){d("cannot get iframe.contentWindow document: "+b)}if(c)return c;try{c=a.contentDocument?a.contentDocument:a.document}catch(f){d("cannot get iframe.contentDocument: "+f),c=a.document}return c}function f(){function c(){try{var a=e(p).readyState;d("state = "+a);a&&"uninitialized"==a.toLowerCase()&&setTimeout(c,50)}catch(b){d("Server abort: ",b," (",b.name,")"),g(M),x&&clearTimeout(x),x=void 0}}var b=q.attr2("target"),
H=q.attr2("action"),h=q.attr("enctype")||q.attr("encoding")||"multipart/form-data";y.setAttribute("target",n);t&&!/post/i.test(t)||y.setAttribute("method","POST");H!=k.url&&y.setAttribute("action",k.url);k.skipEncodingOverride||t&&!/post/i.test(t)||q.attr({encoding:"multipart/form-data",enctype:"multipart/form-data"});k.timeout&&(x=setTimeout(function(){s=!0;g(R)},k.timeout));var z=[];try{if(k.extraData)for(var D in k.extraData)k.extraData.hasOwnProperty(D)&&(a.isPlainObject(k.extraData[D])&&k.extraData[D].hasOwnProperty("name")&&
k.extraData[D].hasOwnProperty("value")?z.push(a('<input type="hidden" name="'+k.extraData[D].name+'">').val(k.extraData[D].value).appendTo(y)[0]):z.push(a('<input type="hidden" name="'+D+'">').val(k.extraData[D]).appendTo(y)[0]));k.iframeTarget||u.appendTo("body");p.attachEvent?p.attachEvent("onload",g):p.addEventListener("load",g,!1);setTimeout(c,15);try{y.submit()}catch(m){document.createElement("form").submit.apply(y)}}finally{y.setAttribute("action",H),y.setAttribute("enctype",h),b?y.setAttribute("target",
b):q.removeAttr("target"),a(z).remove()}}function g(c){if(!r.aborted&&!S)if(z=e(p),z||(d("cannot access response document"),c=M),c===R&&r)r.abort("timeout"),w.reject(r,"timeout");else if(c==M&&r)r.abort("server abort"),w.reject(r,"error","server abort");else if(z&&z.location.href!=k.iframeSrc||s){p.detachEvent?p.detachEvent("onload",g):p.removeEventListener("load",g,!1);c="success";var b;try{if(s)throw"timeout";var f="xml"==k.dataType||z.XMLDocument||a.isXMLDoc(z);d("isXml="+f);if(!f&&(window.opera&&
(null===z.body||!z.body.innerHTML))&&--D){d("requeing onLoad callback, DOM not available");setTimeout(g,250);return}var h=z.body?z.body:z.documentElement;r.responseText=h?h.innerHTML:null;r.responseXML=z.XMLDocument?z.XMLDocument:z;f&&(k.dataType="xml");r.getResponseHeader=function(a){return{"content-type":k.dataType}[a.toLowerCase()]};h&&(r.status=Number(h.getAttribute("status"))||r.status,r.statusText=h.getAttribute("statusText")||r.statusText);var y=(k.dataType||"").toLowerCase(),m=/(json|script|text)/.test(y);
if(m||k.textarea){var l=z.getElementsByTagName("textarea")[0];if(l)r.responseText=l.value,r.status=Number(l.getAttribute("status"))||r.status,r.statusText=l.getAttribute("statusText")||r.statusText;else if(m){var F=z.getElementsByTagName("pre")[0],t=z.getElementsByTagName("body")[0];F?r.responseText=F.textContent?F.textContent:F.innerText:t&&(r.responseText=t.textContent?t.textContent:t.innerText)}}else"xml"==y&&(!r.responseXML&&r.responseText)&&(r.responseXML=W(r.responseText));try{H=X(r,y,k)}catch(n){c=
"parsererror",r.error=b=n||c}}catch(I){d("error caught: ",I),c="error",r.error=b=I||c}r.aborted&&(d("upload aborted"),c=null);r.status&&(c=200<=r.status&&300>r.status||304===r.status?"success":"error");"success"===c?(k.success&&k.success.call(k.context,H,"success",r),w.resolve(r.responseText,"success",r),A&&a.event.trigger("ajaxSuccess",[r,k])):c&&(void 0===b&&(b=r.statusText),k.error&&k.error.call(k.context,r,c,b),w.reject(r,"error",b),A&&a.event.trigger("ajaxError",[r,k,b]));A&&a.event.trigger("ajaxComplete",
[r,k]);A&&!--a.active&&a.event.trigger("ajaxStop");k.complete&&k.complete.call(k.context,r,c);S=!0;k.timeout&&clearTimeout(x);setTimeout(function(){k.iframeTarget?u.attr("src",k.iframeSrc):u.remove();r.responseXML=null},100)}}var y=q[0],m,k,A,n,u,p,r,s,x,w=a.Deferred();w.abort=function(a){r.abort(a)};if(b)for(m=0;m<v.length;m++)b=a(v[m]),h?b.prop("disabled",!1):b.removeAttr("disabled");k=a.extend(!0,{},a.ajaxSettings,c);k.context=k.context||k;n="jqFormIO"+(new Date).getTime();k.iframeTarget?(u=a(k.iframeTarget),
(m=u.attr2("name"))?n=m:u.attr2("name",n)):(u=a('<iframe name="'+n+'" src="'+k.iframeSrc+'" />'),u.css({position:"absolute",top:"-1000px",left:"-1000px"}));p=u[0];r={aborted:0,responseText:null,responseXML:null,status:0,statusText:"n/a",getAllResponseHeaders:function(){},getResponseHeader:function(){},setRequestHeader:function(){},abort:function(c){var b="timeout"===c?"timeout":"aborted";d("aborting upload... "+b);this.aborted=1;try{p.contentWindow.document.execCommand&&p.contentWindow.document.execCommand("Stop")}catch(e){}u.attr("src",
k.iframeSrc);r.error=b;k.error&&k.error.call(k.context,r,b,c);A&&a.event.trigger("ajaxError",[r,k,b]);k.complete&&k.complete.call(k.context,r,b)}};(A=k.global)&&0===a.active++&&a.event.trigger("ajaxStart");A&&a.event.trigger("ajaxSend",[r,k]);if(k.beforeSend&&!1===k.beforeSend.call(k.context,r,k))return k.global&&a.active--,w.reject(),w;if(r.aborted)return w.reject(),w;(b=y.clk)&&(m=b.name)&&!b.disabled&&(k.extraData=k.extraData||{},k.extraData[m]=b.value,"image"==b.type&&(k.extraData[m+".x"]=y.clk_x,
k.extraData[m+".y"]=y.clk_y));var R=1,M=2;b=a("meta[name=csrf-token]").attr("content");(m=a("meta[name=csrf-param]").attr("content"))&&b&&(k.extraData=k.extraData||{},k.extraData[m]=b);k.forceSync?f():setTimeout(f,10);var H,z,D=50,S,W=a.parseXML||function(a,c){window.ActiveXObject?(c=new ActiveXObject("Microsoft.XMLDOM"),c.async="false",c.loadXML(a)):c=(new DOMParser).parseFromString(a,"text/xml");return c&&c.documentElement&&"parsererror"!=c.documentElement.nodeName?c:null},I=a.parseJSON||function(a){return window.eval("("+
a+")")},X=function(c,b,d){var e=c.getResponseHeader("content-type")||"",f="xml"===b||!b&&0<=e.indexOf("xml");c=f?c.responseXML:c.responseText;f&&"parsererror"===c.documentElement.nodeName&&a.error&&a.error("parsererror");d&&d.dataFilter&&(c=d.dataFilter(c,b));"string"===typeof c&&("json"===b||!b&&0<=e.indexOf("json")?c=I(c):("script"===b||!b&&0<=e.indexOf("javascript"))&&a.globalEval(c));return c};return w}if(!this.length)return d("ajaxSubmit: skipping submit process - no element selected"),this;
var t,n,q=this;"function"==typeof c?c={success:c}:void 0===c&&(c={});t=c.type||this.attr2("method");n=c.url||this.attr2("action");(n=(n="string"===typeof n?a.trim(n):"")||window.location.href||"")&&(n=(n.match(/^([^#]+)/)||[])[1]);c=a.extend(!0,{url:n,success:a.ajaxSettings.success,type:t||a.ajaxSettings.type,iframeSrc:/^https/i.test(window.location.href||"")?"javascript:false":"about:blank"},c);n={};this.trigger("form-pre-serialize",[this,c,n]);if(n.veto)return d("ajaxSubmit: submit vetoed via form-pre-serialize trigger"),
this;if(c.beforeSerialize&&!1===c.beforeSerialize(this,c))return d("ajaxSubmit: submit aborted via beforeSerialize callback"),this;var s=c.traditional;void 0===s&&(s=a.ajaxSettings.traditional);var v=[],p,g=this.formToArray(c.semantic,v);c.data&&(c.extraData=c.data,p=a.param(c.data,s));if(c.beforeSubmit&&!1===c.beforeSubmit(g,this,c))return d("ajaxSubmit: submit aborted via beforeSubmit callback"),this;this.trigger("form-submit-validate",[g,this,c,n]);if(n.veto)return d("ajaxSubmit: submit vetoed via form-submit-validate trigger"),
this;n=a.param(g,s);p&&(n=n?n+"&"+p:p);"GET"==c.type.toUpperCase()?(c.url+=(0<=c.url.indexOf("?")?"&":"?")+n,c.data=null):c.data=n;var w=[];c.resetForm&&w.push(function(){q.resetForm()});c.clearForm&&w.push(function(){q.clearForm(c.includeHidden)});if(!c.dataType&&c.target){var x=c.success||function(){};w.push(function(b){var d=c.replaceTarget?"replaceWith":"html";a(c.target)[d](b).each(x,arguments)})}else c.success&&w.push(c.success);c.success=function(a,b,d){for(var e=c.context||this,f=0,g=w.length;f<
g;f++)w[f].apply(e,[a,b,d||q,q])};if(c.error){var C=c.error;c.error=function(a,b,d){C.apply(c.context||this,[a,b,d,q])}}if(c.complete){var y=c.complete;c.complete=function(a,b){y.apply(c.context||this,[a,b,q])}}p=0<a("input[type=file]:enabled",this).filter(function(){return""!==a(this).val()}).length;n="multipart/form-data"==q.attr("enctype")||"multipart/form-data"==q.attr("encoding");s=e&&f;d("fileAPI :"+s);var A;!1!==c.iframe&&(c.iframe||(p||n)&&!s)?c.closeKeepAlive?a.get(c.closeKeepAlive,function(){A=
u(g)}):A=u(g):A=(p||n)&&s?k(g):a.ajax(c);q.removeData("jqxhr").data("jqxhr",A);for(p=0;p<v.length;p++)v[p]=null;this.trigger("form-submit-notify",[this,c]);return this};a.fn.ajaxForm=function(e){e=e||{};e.delegation=e.delegation&&a.isFunction(a.fn.on);if(!e.delegation&&0===this.length){var f=this.selector,h=this.context;if(!a.isReady&&f)return d("DOM not ready, queuing ajaxForm"),a(function(){a(f,h).ajaxForm(e)}),this;d("terminating; zero elements found by selector"+(a.isReady?"":" (DOM not ready)"));
return this}return e.delegation?(a(document).off("submit.form-plugin",this.selector,c).off("click.form-plugin",this.selector,b).on("submit.form-plugin",this.selector,e,c).on("click.form-plugin",this.selector,e,b),this):this.ajaxFormUnbind().bind("submit.form-plugin",e,c).bind("click.form-plugin",e,b)};a.fn.ajaxFormUnbind=function(){return this.unbind("submit.form-plugin click.form-plugin")};a.fn.formToArray=function(c,b){var d=[];if(0===this.length)return d;var f=this[0],h=this.attr("id"),n=c?f.getElementsByTagName("*"):
f.elements;n&&!/MSIE [678]/.test(navigator.userAgent)&&(n=a(n).get());h&&(h=a(':input[form="'+h+'"]').get(),h.length&&(n=(n||[]).concat(h)));if(!n||!n.length)return d;var q,s,v,p,g;q=0;for(g=n.length;q<g;q++)if(p=n[q],(h=p.name)&&!p.disabled)if(c&&f.clk&&"image"==p.type)f.clk==p&&(d.push({name:h,value:a(p).val(),type:p.type}),d.push({name:h+".x",value:f.clk_x},{name:h+".y",value:f.clk_y}));else if((v=a.fieldValue(p,!0))&&v.constructor==Array)for(b&&b.push(p),s=0,p=v.length;s<p;s++)d.push({name:h,
value:v[s]});else if(e&&"file"==p.type)if(b&&b.push(p),v=p.files,v.length)for(s=0;s<v.length;s++)d.push({name:h,value:v[s],type:p.type});else d.push({name:h,value:"",type:p.type});else null!==v&&"undefined"!=typeof v&&(b&&b.push(p),d.push({name:h,value:v,type:p.type,required:p.required}));!c&&f.clk&&(n=a(f.clk),q=n[0],(h=q.name)&&(!q.disabled&&"image"==q.type)&&(d.push({name:h,value:n.val()}),d.push({name:h+".x",value:f.clk_x},{name:h+".y",value:f.clk_y})));return d};a.fn.formSerialize=function(c){return a.param(this.formToArray(c))};
a.fn.fieldSerialize=function(c){var b=[];this.each(function(){var d=this.name;if(d){var e=a.fieldValue(this,c);if(e&&e.constructor==Array)for(var f=0,h=e.length;f<h;f++)b.push({name:d,value:e[f]});else null!==e&&"undefined"!=typeof e&&b.push({name:this.name,value:e})}});return a.param(b)};a.fn.fieldValue=function(c){for(var b=[],d=0,e=this.length;d<e;d++){var f=a.fieldValue(this[d],c);null===f||("undefined"==typeof f||f.constructor==Array&&!f.length)||(f.constructor==Array?a.merge(b,f):b.push(f))}return b};
a.fieldValue=function(c,b){var d=c.name,e=c.type,f=c.tagName.toLowerCase();void 0===b&&(b=!0);if(b&&(!d||c.disabled||"reset"==e||"button"==e||("checkbox"==e||"radio"==e)&&!c.checked||("submit"==e||"image"==e)&&c.form&&c.form.clk!=c||"select"==f&&-1==c.selectedIndex))return null;if("select"==f){var h=c.selectedIndex;if(0>h)return null;for(var d=[],f=c.options,q=(e="select-one"==e)?h+1:f.length,h=e?h:0;h<q;h++){var s=f[h];if(s.selected){var v=s.value;v||(v=s.attributes&&s.attributes.value&&!s.attributes.value.specified?
s.text:s.value);if(e)return v;d.push(v)}}return d}return a(c).val()};a.fn.clearForm=function(c){return this.each(function(){a("input,select,textarea",this).clearFields(c)})};a.fn.clearFields=a.fn.clearInputs=function(c){var b=/^(?:color|date|datetime|email|month|number|password|range|search|tel|text|time|url|week)$/i;return this.each(function(){var d=this.type,e=this.tagName.toLowerCase();b.test(d)||"textarea"==e?this.value="":"checkbox"==d||"radio"==d?this.checked=!1:"select"==e?this.selectedIndex=
-1:"file"==d?/MSIE/.test(navigator.userAgent)?a(this).replaceWith(a(this).clone(!0)):a(this).val(""):c&&(!0===c&&/hidden/.test(d)||"string"==typeof c&&a(this).is(c))&&(this.value="")})};a.fn.resetForm=function(){return this.each(function(){("function"==typeof this.reset||"object"==typeof this.reset&&!this.reset.nodeType)&&this.reset()})};a.fn.enable=function(a){void 0===a&&(a=!0);return this.each(function(){this.disabled=!a})};a.fn.selected=function(c){void 0===c&&(c=!0);return this.each(function(){var b=
...
this._trigger("afterTagRemoved",null,{tag:c,tagLabel:this.tagLabel(c)})}},removeTagByLabel:function(a,b){var d=this._findTagByLabel(a);if(!d)throw"No such tag exists with the name '"+a+"'";this.removeTag(d,b)},removeAll:function(){var a=this;this._tags().each(function(b,d){a.removeTag(d,!1)})}})})(jQuery);jQuery.fn.sortElements=function(){var a=[].sort;return function(c,b){b=b||function(){return this};var d=this.map(function(){var a=b.call(this),c=a.parentNode,d=c.insertBefore(document.createTextNode(""),a.nextSibling);return function(){if(c===this)throw Error("You can't sort elements if any one is a descendant of another.");c.insertBefore(this,d);c.removeChild(d)}});return a.call(this,c).each(function(a){d[a].call(b.call(this))})}}();(function(a){"function"===typeof define&&define.amd?define(["jquery"],a):a(jQuery)})(function(a){function c(a){return e.raw?a:encodeURIComponent(a)}function b(c,b){var l;if(e.raw)l=c;else a:{var m=c;0===m.indexOf('"')&&(m=m.slice(1,-1).replace(/\\"/g,'"').replace(/\\\\/g,"\\"));try{m=decodeURIComponent(m.replace(d," "))}catch(k){l=void 0;break a}try{l=e.json?JSON.parse(m):m;break a}catch(u){}l=void 0}return a.isFunction(b)?b(l):l}var d=/\+/g,e=a.cookie=function(d,h,l){if(void 0!==h&&!a.isFunction(h)){l=
a.extend({},e.defaults,l);if("number"===typeof l.expires){var m=l.expires,k=l.expires=new Date;k.setDate(k.getDate()+m)}return document.cookie=[c(d),"=",c(e.json?JSON.stringify(h):String(h)),l.expires?"; expires="+l.expires.toUTCString():"",l.path?"; path="+l.path:"",l.domain?"; domain="+l.domain:"",l.secure?"; secure":""].join("")}l=d?void 0:{};for(var m=document.cookie?document.cookie.split("; "):[],k=0,u=m.length;k<u;k++){var t=m[k].split("="),n;n=t.shift();n=e.raw?n:decodeURIComponent(n);t=t.join("=");
if(d&&d===n){l=b(t,h);break}d||void 0===(t=b(t))||(l[n]=t)}return l};e.defaults={};a.removeCookie=function(c,b){return void 0!==a.cookie(c)?(a.cookie(c,"",a.extend({},b,{expires:-1})),!0):!1}});(function(a){a.fn.equalizeElementHeights=function(){var c=this.map(function(c,d){return a(d).height()}).get();return this.height(Math.max.apply(this,c))}})(jQuery);(function(a){a.fn.jLabel=function(c){function b(a){this.equals=function(a){return a.attr("id")==this.input.attr("id")};this.input=a;this.label=e(a);""!=this.input.val()&&this.label.hide()}function d(c){var b;a.each(h,function(){if(this.equals(c))return b=this,!1});return b}function e(c){var b=a("label[for="+c.attr("id")+"]");0==b.size()&&(b=a("<label>").attr("for",c.attr("id")).text(c.attr("title")));c.before(b);b.css({"font-family":c.css("font-family"),"font-size":c.css("font-size"),"font-style":c.css("font-style"),
"font-variant":c.css("font-variant"),"font-weight":c.css("font-weight"),"letter-spacing":c.css("letter-spacing"),"line-height":c.css("line-height"),"text-decoration":c.css("text-decoration"),"text-transform":c.css("text-transform"),color:c.css("color"),cursor:c.css("cursor"),width:c.css("width"),display:"inline-block",overflow:"hidden"});b.mousedown(function(){return!1}).css({position:"relative","z-index":"100","margin-right":-b.width(),left:l.xShift+parseInt(c.css("padding-left"))+"px",top:l.yShift+
"px"});return b}function f(a){var c=d(a).label;""==a.val()?c.stop().fadeTo(l.speed,l.opacity):c.is(":visible")&&c.stop().fadeTo(l.speed,0,function(){c.hide()})}var h=[],l=a.extend({},a.fn.jLabel.defaults,c);return this.each(function(){var c=a(this);h.push(new b(c));c.focus(function(){var c=a(this);""==c.val()&&d(c).label.stop().fadeTo(l.speed,l.opacity)}).blur(function(){var c=a(this);""==c.val()&&d(c).label.stop().fadeTo(l.speed,1)}).keyup(function(){f(a(this))}).change(function(){f(a(this))})})};
a.fn.jLabel.defaults={speed:200,opacity:0.4,xShift:2,yShift:0}})(jQuery);jQuery&&function(a){a.extend(a.fn,{selectBox:function(c,b){var d,e="",f=navigator.platform.match(/mac/i),h=function(c,b){var d;if(navigator.userAgent.match(/iPad|iPhone|Android|IEMobile|BlackBerry/i)||"select"!==c.tagName.toLowerCase())return!1;c=a(c);if(c.data("selectBox-control"))return!1;var e=a('<a class="selectBox" />'),f=c.attr("multiple")||1<parseInt(c.attr("size")),h=b||{};e.width(c.outerWidth()).addClass(c.attr("class")).attr("title",c.attr("title")||"").attr("tabindex",parseInt(c.attr("tabindex"))).css("display",
"inline-block").bind("focus.selectBox",function(){this!==document.activeElement&&document.body!==document.activeElement&&a(document.activeElement).blur();e.hasClass("selectBox-active")||(e.addClass("selectBox-active"),c.trigger("focus"))}).bind("blur.selectBox",function(){e.hasClass("selectBox-active")&&(e.removeClass("selectBox-active"),c.trigger("blur"))});a(window).data("selectBox-bindings")||a(window).data("selectBox-bindings",!0).bind("scroll.selectBox",n).bind("resize.selectBox",n);c.attr("disabled")&&
e.addClass("selectBox-disabled");c.bind("click.selectBox",function(a){e.focus();a.preventDefault()});if(f){if(d=l(c,"inline"),e.append(d).data("selectBox-options",d).addClass("selectBox-inline selectBox-menuShowing").bind("keydown.selectBox",function(a){g(c,a)}).bind("keypress.selectBox",function(a){w(c,a)}).bind("mousedown.selectBox",function(c){a(c.target).is("A.selectBox-inline")&&c.preventDefault();e.hasClass("selectBox-focus")||e.focus()}).insertAfter(c),!c[0].style.height){var f=c.attr("size")?
parseInt(c.attr("size")):5,p=e.clone().removeAttr("id").css({position:"absolute",top:"-9999em"}).show().appendTo("body");p.find(".selectBox-options").html("<li><a>\u00a0</a></li>");var q=parseInt(p.find(".selectBox-options A:first").html("&nbsp;").outerHeight());p.remove();e.height(q*f)}}else f=a('<span class="selectBox-label" />'),p=a('<span class="selectBox-arrow" />'),f.attr("class",m(c)).text(k(c)),d=l(c,"dropdown"),d.appendTo("BODY"),e.data("selectBox-options",d).addClass("selectBox-dropdown").append(f).append(p).bind("mousedown.selectBox",
function(a){e.hasClass("selectBox-menuShowing")?n():(a.stopPropagation(),d.data("selectBox-down-at-x",a.screenX).data("selectBox-down-at-y",a.screenY),t(c))}).bind("keydown.selectBox",function(a){g(c,a)}).bind("keypress.selectBox",function(a){w(c,a)}).bind("open.selectBox",function(a,b){b&&!0===b._selectBox||t(c)}).bind("close.selectBox",function(a,c){c&&!0===c._selectBox||n()}).insertAfter(c),p=e.width()-p.outerWidth()-parseInt(f.css("paddingLeft"))-parseInt(f.css("paddingLeft")),f.width(p);C(e);
c.addClass("selectBox").data("selectBox-control",e).data("selectBox-settings",h).hide()},l=function(c,b){var d,e=function(c,b){c.children("OPTION, OPTGROUP").each(function(){if(a(this).is("OPTION"))if(0<a(this).length){var c=a(this),d=b,f=a("<li />"),g=a("<a />");f.addClass(c.attr("class"));f.data(c.data());g.attr("rel",c.val()).text(c.text());f.append(g);c.attr("disabled")&&f.addClass("selectBox-disabled");c.attr("selected")&&f.addClass("selectBox-selected");d.append(f)}else b.append("<li>\u00a0</li>");
else c=a('<li class="selectBox-optgroup" />'),c.text(a(this).attr("label")),b.append(c),b=e(a(this),b)});return b};switch(b){case "inline":return d=a('<ul class="selectBox-options" />'),d=e(c,d),d.find("A").bind("mouseover.selectBox",function(b){s(c,a(this).parent())}).bind("mouseout.selectBox",function(b){v(c,a(this).parent())}).bind("mousedown.selectBox",function(a){a.preventDefault();c.selectBox("control").hasClass("selectBox-active")||c.selectBox("control").focus()}).bind("mouseup.selectBox",
function(b){n();q(c,a(this).parent(),b)}),C(d),d;case "dropdown":d=a('<ul class="selectBox-dropdown-menu selectBox-options" />');d=e(c,d);d.data("selectBox-select",c).css("display","none").appendTo("BODY").find("A").bind("mousedown.selectBox",function(a){a.preventDefault();a.screenX===d.data("selectBox-down-at-x")&&a.screenY===d.data("selectBox-down-at-y")&&(d.removeData("selectBox-down-at-x").removeData("selectBox-down-at-y"),n())}).bind("mouseup.selectBox",function(b){if(b.screenX!==d.data("selectBox-down-at-x")||
b.screenY!==d.data("selectBox-down-at-y"))d.removeData("selectBox-down-at-x").removeData("selectBox-down-at-y"),q(c,a(this).parent()),n()}).bind("mouseover.selectBox",function(b){s(c,a(this).parent())}).bind("mouseout.selectBox",function(b){v(c,a(this).parent())});var f=c.attr("class")||"";if(""!==f){var f=f.split(" "),g;for(g in f)d.addClass(f[g]+"-selectBox-dropdown-menu")}C(d);return d}},m=function(c){return("selectBox-label "+(a(c).find("OPTION:selected").attr("class")||"")).replace(/\s+$/,"")},
k=function(c){return a(c).find("OPTION:selected").text()||"\u00a0"},u=function(c){c=a(c);var b=c.data("selectBox-control");b&&b.find(".selectBox-label").attr("class",m(c)).text(k(c))},t=function(c){c=a(c);var b=c.data("selectBox-control"),d=c.data("selectBox-settings"),e=b.data("selectBox-options");if(b.hasClass("selectBox-disabled"))return!1;n();var f=isNaN(b.css("borderBottomWidth"))?0:parseInt(b.css("borderBottomWidth"));e.width(b.innerWidth()).css({top:b.offset().top+b.outerHeight()-f,left:b.offset().left});
if(c.triggerHandler("beforeopen"))return!1;f=function(){c.triggerHandler("open",{_selectBox:!0})};switch(d.menuTransition){case "fade":e.fadeIn(d.menuSpeed,f);break;case "slide":e.slideDown(d.menuSpeed,f);break;default:e.show(d.menuSpeed,f)}d.menuSpeed||f();d=e.find(".selectBox-selected:first");p(c,d,!0);s(c,d);b.addClass("selectBox-menuShowing");a(document).bind("mousedown.selectBox",function(c){a(c.target).parents().andSelf().hasClass("selectBox-options")||n()})},n=function(){0!==a(".selectBox-dropdown-menu:visible").length&&
...
var g=0,h=[];c.attr("multiple")?e.find(".selectBox-selected A").each(function(){h[g++]=a(this).attr("rel")}):h=b.find("A").attr("rel");e.data("selectBox-last-selected",b);c.val()!==h&&(c.val(h),u(c),c.trigger("change"));return!0},s=function(c,b){c=a(c);b=a(b);c.data("selectBox-control").data("selectBox-options").find(".selectBox-hover").removeClass("selectBox-hover");b.addClass("selectBox-hover")},v=function(c,b){c=a(c);a(b);c.data("selectBox-control").data("selectBox-options").find(".selectBox-hover").removeClass("selectBox-hover")},
p=function(c,b,d){if(b&&0!==b.length){c=a(c);c=c.data("selectBox-control");var e=c.data("selectBox-options");c=c.hasClass("selectBox-dropdown")?e:e.parent();var e=parseInt(b.offset().top-c.position().top),f=parseInt(e+b.outerHeight());d?c.scrollTop(b.offset().top-c.offset().top+c.scrollTop()-c.height()/2):(0>e&&c.scrollTop(b.offset().top-c.offset().top+c.scrollTop()),f>c.height()&&c.scrollTop(b.offset().top+b.outerHeight()-c.offset().top+c.scrollTop()-c.height()))}},g=function(c,b){c=a(c);var d=c.data("selectBox-control"),
f=d.data("selectBox-options"),g=c.data("selectBox-settings"),h=0,k=0;if(!d.hasClass("selectBox-disabled"))switch(b.keyCode){case 8:b.preventDefault();e="";break;case 9:case 27:n();v(c);break;case 13:d.hasClass("selectBox-menuShowing")?(q(c,f.find("LI.selectBox-hover:first"),b),d.hasClass("selectBox-dropdown")&&n()):t(c);break;case 38:case 37:b.preventDefault();if(d.hasClass("selectBox-menuShowing")){d=f.find(".selectBox-hover").prev("LI");h=f.find("LI:not(.selectBox-optgroup)").length;for(k=0;(0===
d.length||d.hasClass("selectBox-disabled")||d.hasClass("selectBox-optgroup"))&&!(d=d.prev("LI"),0===d.length&&(d=g.loopOptions?f.find("LI:last"):f.find("LI:first")),++k>=h););s(c,d);q(c,d,b);p(c,d)}else t(c);break;case 40:case 39:if(b.preventDefault(),d.hasClass("selectBox-menuShowing")){d=f.find(".selectBox-hover").next("LI");h=f.find("LI:not(.selectBox-optgroup)").length;for(k=0;(0===d.length||d.hasClass("selectBox-disabled")||d.hasClass("selectBox-optgroup"))&&!(d=d.next("LI"),0===d.length&&(d=
g.loopOptions?f.find("LI:first"):f.find("LI:last")),++k>=h););s(c,d);q(c,d,b);p(c,d)}else t(c)}},w=function(c,b){c=a(c);var f=c.data("selectBox-control"),g=f.data("selectBox-options");if(!f.hasClass("selectBox-disabled"))switch(b.keyCode){case 9:case 27:case 13:case 38:case 37:case 40:case 39:break;default:f.hasClass("selectBox-menuShowing")||t(c),b.preventDefault(),clearTimeout(d),e+=String.fromCharCode(b.charCode||b.keyCode),g.find("A").each(function(){if(a(this).text().substr(0,e.length).toLowerCase()===
e.toLowerCase())return s(c,a(this).parent()),p(c,a(this).parent()),!1}),d=setTimeout(function(){e=""},1E3)}},x=function(c,b){c=a(c);c.val(b);b=c.val();null===b&&(b=c.children().first().val(),c.val(b));var d=c.data("selectBox-control");if(d){var e=c.data("selectBox-settings"),d=d.data("selectBox-options");u(c);d.find(".selectBox-selected").removeClass("selectBox-selected");d.find("A").each(function(){if("object"===typeof b)for(var c=0;c<b.length;c++)a(this).attr("rel")==b[c]&&a(this).parent().addClass("selectBox-selected");
else a(this).attr("rel")==b&&a(this).parent().addClass("selectBox-selected")});e.change&&e.change.call(c)}},C=function(c){a(c).css("MozUserSelect","none").bind("selectstart",function(a){a.preventDefault()})};switch(c){case "control":return a(this).data("selectBox-control");case "settings":if(!b)return a(this).data("selectBox-settings");a(this).each(function(){a(this).data("selectBox-settings",a.extend(!0,a(this).data("selectBox-settings"),b))});break;case "options":if(void 0===b)return a(this).data("selectBox-control").data("selectBox-options");
...
"inline",d=l(c,f),e.data("selectBox-options",d),f){case "inline":e.append(d);break;case "dropdown":u(c),a("BODY").append(d)}});break;case "value":if(void 0===b)return a(this).val();a(this).each(function(){x(this,b)});break;case "refresh":a(this).each(function(){var c;c=a(this);c.selectBox("options",c.html())});break;case "enable":a(this).each(function(){var c;c=a(this);c.attr("disabled",!1);(c=c.data("selectBox-control"))&&c.removeClass("selectBox-disabled")});break;case "disable":a(this).each(function(){var c;
c=a(this);c.attr("disabled",!0);(c=c.data("selectBox-control"))&&c.addClass("selectBox-disabled")});break;case "destroy":a(this).each(function(){var c;c=a(this);var b=c.data("selectBox-control");b&&(b.data("selectBox-options").remove(),b.remove(),c.removeClass("selectBox").removeData("selectBox-control").data("selectBox-control",null).removeData("selectBox-settings").data("selectBox-settings",null).show())});break;default:a(this).each(function(){h(this,c)})}return a(this)}})}(jQuery);(function(){function a(a){return function(c,b,d,e){b=w(b,e,4);var f=!B(c)&&g.keys(c),h=(f||c).length,k=0<a?0:h-1;3>arguments.length&&(d=c[f?f[k]:k],k+=a);for(var l=b,m=d;0<=k&&k<h;k+=a)var n=f?f[k]:k,m=l(m,c[n],n,c);return m}}function c(a){return function(c,b,d){b=x(b,d);d=E(c);for(var e=0<a?0:d-1;0<=e&&e<d;e+=a)if(b(c[e],e,c))return e;return-1}}function b(a,c,b){return function(d,e,f){var h=0,l=E(d);if("number"==typeof f)0<a?h=0<=f?f:Math.max(f+l,h):l=0<=f?Math.min(f+1,l):f+l+1;else if(b&&f&&l)return f=
b(d,e),d[f]===e?f:-1;if(e!==e)return f=c(k.call(d,h,l),g.isNaN),0<=f?f+h:-1;for(f=0<a?h:l-1;0<=f&&f<l;f+=a)if(d[f]===e)return f;return-1}}function d(a,c){var b=Q.length,d=a.constructor,d=g.isFunction(d)&&d.prototype||l,e="constructor";for(g.has(a,e)&&!g.contains(c,e)&&c.push(e);b--;)e=Q[b],e in a&&(a[e]!==d[e]&&!g.contains(c,e))&&c.push(e)}var e=this,f=e._,h=Array.prototype,l=Object.prototype,m=h.push,k=h.slice,u=l.toString,t=l.hasOwnProperty,n=Array.isArray,q=Object.keys,s=Function.prototype.bind,
v=Object.create,p=function(){},g=function(a){if(a instanceof g)return a;if(!(this instanceof g))return new g(a);this._wrapped=a};"undefined"!==typeof exports?("undefined"!==typeof module&&module.exports&&(exports=module.exports=g),exports._=g):e._=g;g.VERSION="1.8.3";var w=function(a,c,b){if(void 0===c)return a;switch(null==b?3:b){case 1:return function(b){return a.call(c,b)};case 2:return function(b,d){return a.call(c,b,d)};case 3:return function(b,d,e){return a.call(c,b,d,e)};case 4:return function(b,
d,e,f){return a.call(c,b,d,e,f)}}return function(){return a.apply(c,arguments)}},x=function(a,c,b){return null==a?g.identity:g.isFunction(a)?w(a,c,b):g.isObject(a)?g.matcher(a):g.property(a)};g.iteratee=function(a,c){return x(a,c,Infinity)};var C=function(a,c){return function(b){var d=arguments.length;if(2>d||null==b)return b;for(var e=1;e<d;e++)for(var f=arguments[e],g=a(f),h=g.length,k=0;k<h;k++){var l=g[k];c&&void 0!==b[l]||(b[l]=f[l])}return b}},y=function(a){if(!g.isObject(a))return{};if(v)return v(a);
p.prototype=a;a=new p;p.prototype=null;return a},A=function(a){return function(c){return null==c?void 0:c[a]}},F=Math.pow(2,53)-1,E=A("length"),B=function(a){a=E(a);return"number"==typeof a&&0<=a&&a<=F};g.each=g.forEach=function(a,c,b){c=w(c,b);var d;if(B(a))for(b=0,d=a.length;b<d;b++)c(a[b],b,a);else{var e=g.keys(a);b=0;for(d=e.length;b<d;b++)c(a[e[b]],e[b],a)}return a};g.map=g.collect=function(a,c,b){c=x(c,b);b=!B(a)&&g.keys(a);for(var d=(b||a).length,e=Array(d),f=0;f<d;f++){var h=b?b[f]:f;e[f]=
c(a[h],h,a)}return e};g.reduce=g.foldl=g.inject=a(1);g.reduceRight=g.foldr=a(-1);g.find=g.detect=function(a,c,b){c=B(a)?g.findIndex(a,c,b):g.findKey(a,c,b);if(void 0!==c&&-1!==c)return a[c]};g.filter=g.select=function(a,c,b){var d=[];c=x(c,b);g.each(a,function(a,b,e){c(a,b,e)&&d.push(a)});return d};g.reject=function(a,c,b){return g.filter(a,g.negate(x(c)),b)};g.every=g.all=function(a,c,b){c=x(c,b);b=!B(a)&&g.keys(a);for(var d=(b||a).length,e=0;e<d;e++){var f=b?b[e]:e;if(!c(a[f],f,a))return!1}return!0};
g.some=g.any=function(a,c,b){c=x(c,b);b=!B(a)&&g.keys(a);for(var d=(b||a).length,e=0;e<d;e++){var f=b?b[e]:e;if(c(a[f],f,a))return!0}return!1};g.contains=g.includes=g.include=function(a,c,b,d){B(a)||(a=g.values(a));if("number"!=typeof b||d)b=0;return 0<=g.indexOf(a,c,b)};g.invoke=function(a,c){var b=k.call(arguments,2),d=g.isFunction(c);return g.map(a,function(a){var e=d?c:a[c];return null==e?e:e.apply(a,b)})};g.pluck=function(a,c){return g.map(a,g.property(c))};g.where=function(a,c){return g.filter(a,
g.matcher(c))};g.findWhere=function(a,c){return g.find(a,g.matcher(c))};g.max=function(a,c,b){var d=-Infinity,e=-Infinity,f;if(null==c&&null!=a){a=B(a)?a:g.values(a);for(var h=0,k=a.length;h<k;h++)b=a[h],b>d&&(d=b)}else c=x(c,b),g.each(a,function(a,b,g){f=c(a,b,g);if(f>e||-Infinity===f&&-Infinity===d)d=a,e=f});return d};g.min=function(a,c,b){var d=Infinity,e=Infinity,f;if(null==c&&null!=a){a=B(a)?a:g.values(a);for(var h=0,k=a.length;h<k;h++)b=a[h],b<d&&(d=b)}else c=x(c,b),g.each(a,function(a,b,g){f=
c(a,b,g);if(f<e||Infinity===f&&Infinity===d)d=a,e=f});return d};g.shuffle=function(a){a=B(a)?a:g.values(a);for(var c=a.length,b=Array(c),d=0,e;d<c;d++)e=g.random(0,d),e!==d&&(b[d]=b[e]),b[e]=a[d];return b};g.sample=function(a,c,b){return null==c||b?(B(a)||(a=g.values(a)),a[g.random(a.length-1)]):g.shuffle(a).slice(0,Math.max(0,c))};g.sortBy=function(a,c,b){c=x(c,b);return g.pluck(g.map(a,function(a,b,d){return{value:a,index:b,criteria:c(a,b,d)}}).sort(function(a,c){var b=a.criteria,d=c.criteria;if(b!==
d){if(b>d||void 0===b)return 1;if(b<d||void 0===d)return-1}return a.index-c.index}),"value")};var J=function(a){return function(c,b,d){var e={};b=x(b,d);g.each(c,function(d,f){var g=b(d,f,c);a(e,d,g)});return e}};g.groupBy=J(function(a,c,b){g.has(a,b)?a[b].push(c):a[b]=[c]});g.indexBy=J(function(a,c,b){a[b]=c});g.countBy=J(function(a,c,b){g.has(a,b)?a[b]++:a[b]=1});g.toArray=function(a){return a?g.isArray(a)?k.call(a):B(a)?g.map(a,g.identity):g.values(a):[]};g.size=function(a){return null==a?0:B(a)?
a.length:g.keys(a).length};g.partition=function(a,c,b){c=x(c,b);var d=[],e=[];g.each(a,function(a,b,f){(c(a,b,f)?d:e).push(a)});return[d,e]};g.first=g.head=g.take=function(a,c,b){return null==a?void 0:null==c||b?a[0]:g.initial(a,a.length-c)};g.initial=function(a,c,b){return k.call(a,0,Math.max(0,a.length-(null==c||b?1:c)))};g.last=function(a,c,b){return null==a?void 0:null==c||b?a[a.length-1]:g.rest(a,Math.max(0,a.length-c))};g.rest=g.tail=g.drop=function(a,c,b){return k.call(a,null==c||b?1:c)};g.compact=
function(a){return g.filter(a,g.identity)};var G=function(a,c,b,d){var e=[],f=0;d=d||0;for(var h=E(a);d<h;d++){var k=a[d];if(B(k)&&(g.isArray(k)||g.isArguments(k))){c||(k=G(k,c,b));var l=0,m=k.length;for(e.length+=m;l<m;)e[f++]=k[l++]}else b||(e[f++]=k)}return e};g.flatten=function(a,c){return G(a,c,!1)};g.without=function(a){return g.difference(a,k.call(arguments,1))};g.uniq=g.unique=function(a,c,b,d){g.isBoolean(c)||(d=b,b=c,c=!1);null!=b&&(b=x(b,d));d=[];for(var e=[],f=0,h=E(a);f<h;f++){var k=
a[f],l=b?b(k,f,a):k;c?(f&&e===l||d.push(k),e=l):b?g.contains(e,l)||(e.push(l),d.push(k)):g.contains(d,k)||d.push(k)}return d};g.union=function(){return g.uniq(G(arguments,!0,!0))};g.intersection=function(a){for(var c=[],b=arguments.length,d=0,e=E(a);d<e;d++){var f=a[d];if(!g.contains(c,f)){for(var h=1;h<b&&g.contains(arguments[h],f);h++);h===b&&c.push(f)}}return c};g.difference=function(a){var c=G(arguments,!0,!0,1);return g.filter(a,function(a){return!g.contains(c,a)})};g.zip=function(){return g.unzip(arguments)};
g.unzip=function(a){for(var c=a&&g.max(a,E).length||0,b=Array(c),d=0;d<c;d++)b[d]=g.pluck(a,d);return b};g.object=function(a,c){for(var b={},d=0,e=E(a);d<e;d++)c?b[a[d]]=c[d]:b[a[d][0]]=a[d][1];return b};g.findIndex=c(1);g.findLastIndex=c(-1);g.sortedIndex=function(a,c,b,d){b=x(b,d,1);c=b(c);d=0;for(var e=E(a);d<e;){var f=Math.floor((d+e)/2);b(a[f])<c?d=f+1:e=f}return d};g.indexOf=b(1,g.findIndex,g.sortedIndex);g.lastIndexOf=b(-1,g.findLastIndex);g.range=function(a,c,b){null==c&&(c=a||0,a=0);b=b||
1;c=Math.max(Math.ceil((c-a)/b),0);for(var d=Array(c),e=0;e<c;e++,a+=b)d[e]=a;return d};var O=function(a,c,b,d,e){if(!(d instanceof c))return a.apply(b,e);c=y(a.prototype);a=a.apply(c,e);return g.isObject(a)?a:c};g.bind=function(a,c){if(s&&a.bind===s)return s.apply(a,k.call(arguments,1));if(!g.isFunction(a))throw new TypeError("Bind must be called on a function");var b=k.call(arguments,2),d=function(){return O(a,d,c,this,b.concat(k.call(arguments)))};return d};g.partial=function(a){var c=k.call(arguments,
...
{};return b};g.delay=function(a,c){var b=k.call(arguments,2);return setTimeout(function(){return a.apply(null,b)},c)};g.defer=g.partial(g.delay,g,1);g.throttle=function(a,c,b){var d,e,f,h=null,k=0;b||(b={});var l=function(){k=!1===b.leading?0:g.now();h=null;f=a.apply(d,e);h||(d=e=null)};return function(){var m=g.now();k||!1!==b.leading||(k=m);var n=c-(m-k);d=this;e=arguments;0>=n||n>c?(h&&(clearTimeout(h),h=null),k=m,f=a.apply(d,e),h||(d=e=null)):h||!1===b.trailing||(h=setTimeout(l,n));return f}};
g.debounce=function(a,c,b){var d,e,f,h,k,l=function(){var m=g.now()-h;m<c&&0<=m?d=setTimeout(l,c-m):(d=null,b||(k=a.apply(f,e),d||(f=e=null)))};return function(){f=this;e=arguments;h=g.now();var m=b&&!d;d||(d=setTimeout(l,c));m&&(k=a.apply(f,e),f=e=null);return k}};g.wrap=function(a,c){return g.partial(c,a)};g.negate=function(a){return function(){return!a.apply(this,arguments)}};g.compose=function(){var a=arguments,c=a.length-1;return function(){for(var b=c,d=a[c].apply(this,arguments);b--;)d=a[b].call(this,
d);return d}};g.after=function(a,c){return function(){if(1>--a)return c.apply(this,arguments)}};g.before=function(a,c){var b;return function(){0<--a&&(b=c.apply(this,arguments));1>=a&&(c=null);return b}};g.once=g.partial(g.before,2);var P=!{toString:null}.propertyIsEnumerable("toString"),Q="valueOf isPrototypeOf toString propertyIsEnumerable hasOwnProperty toLocaleString".split(" ");g.keys=function(a){if(!g.isObject(a))return[];if(q)return q(a);var c=[],b;for(b in a)g.has(a,b)&&c.push(b);P&&d(a,c);
return c};g.allKeys=function(a){if(!g.isObject(a))return[];var c=[],b;for(b in a)c.push(b);P&&d(a,c);return c};g.values=function(a){for(var c=g.keys(a),b=c.length,d=Array(b),e=0;e<b;e++)d[e]=a[c[e]];return d};g.mapObject=function(a,c,b){c=x(c,b);b=g.keys(a);for(var d=b.length,e={},f,h=0;h<d;h++)f=b[h],e[f]=c(a[f],f,a);return e};g.pairs=function(a){for(var c=g.keys(a),b=c.length,d=Array(b),e=0;e<b;e++)d[e]=[c[e],a[c[e]]];return d};g.invert=function(a){for(var c={},b=g.keys(a),d=0,e=b.length;d<e;d++)c[a[b[d]]]=
b[d];return c};g.functions=g.methods=function(a){var c=[],b;for(b in a)g.isFunction(a[b])&&c.push(b);return c.sort()};g.extend=C(g.allKeys);g.extendOwn=g.assign=C(g.keys);g.findKey=function(a,c,b){c=x(c,b);b=g.keys(a);for(var d,e=0,f=b.length;e<f;e++)if(d=b[e],c(a[d],d,a))return d};g.pick=function(a,c,b){var d={},e=a,f,h;if(null==e)return d;g.isFunction(c)?(h=g.allKeys(e),f=w(c,b)):(h=G(arguments,!1,!1,1),f=function(a,c,b){return c in b},e=Object(e));for(var k=0,l=h.length;k<l;k++){var m=h[k],n=e[m];
f(n,m,e)&&(d[m]=n)}return d};g.omit=function(a,c,b){if(g.isFunction(c))c=g.negate(c);else{var d=g.map(G(arguments,!1,!1,1),String);c=function(a,c){return!g.contains(d,c)}}return g.pick(a,c,b)};g.defaults=C(g.allKeys,!0);g.create=function(a,c){var b=y(a);c&&g.extendOwn(b,c);return b};g.clone=function(a){return g.isObject(a)?g.isArray(a)?a.slice():g.extend({},a):a};g.tap=function(a,c){c(a);return a};g.isMatch=function(a,c){var b=g.keys(c),d=b.length;if(null==a)return!d;for(var e=Object(a),f=0;f<d;f++){var h=
b[f];if(c[h]!==e[h]||!(h in e))return!1}return!0};var K=function(a,c,b,d){if(a===c)return 0!==a||1/a===1/c;if(null==a||null==c)return a===c;a instanceof g&&(a=a._wrapped);c instanceof g&&(c=c._wrapped);var e=u.call(a);if(e!==u.call(c))return!1;switch(e){case "[object RegExp]":case "[object String]":return""+a===""+c;case "[object Number]":return+a!==+a?+c!==+c:0===+a?1/+a===1/c:+a===+c;case "[object Date]":case "[object Boolean]":return+a===+c}e="[object Array]"===e;if(!e){if("object"!=typeof a||
...
g.isEqual=function(a,c){return K(a,c)};g.isEmpty=function(a){return null==a?!0:B(a)&&(g.isArray(a)||g.isString(a)||g.isArguments(a))?0===a.length:0===g.keys(a).length};g.isElement=function(a){return!(!a||1!==a.nodeType)};g.isArray=n||function(a){return"[object Array]"===u.call(a)};g.isObject=function(a){var c=typeof a;return"function"===c||"object"===c&&!!a};g.each("Arguments Function String Number Date RegExp Error".split(" "),function(a){g["is"+a]=function(c){return u.call(c)==="[object "+a+"]"}});
...
t.call(a,c)};g.noConflict=function(){e._=f;return this};g.identity=function(a){return a};g.constant=function(a){return function(){return a}};g.noop=function(){};g.property=A;g.propertyOf=function(a){return null==a?function(){}:function(c){return a[c]}};g.matcher=g.matches=function(a){a=g.extendOwn({},a);return function(c){return g.isMatch(c,a)}};g.times=function(a,c,b){var d=Array(Math.max(0,a));c=w(c,b,1);for(b=0;b<a;b++)d[b]=c(b);return d};g.random=function(a,c){null==c&&(c=a,a=0);return a+Math.floor(Math.random()*
(c-a+1))};g.now=Date.now||function(){return(new Date).getTime()};n={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#x27;","`":"&#x60;"};C=g.invert(n);A=function(a){var c=function(c){return a[c]},b="(?:"+g.keys(a).join("|")+")",d=RegExp(b),e=RegExp(b,"g");return function(a){a=null==a?"":""+a;return d.test(a)?a.replace(e,c):a}};g.escape=A(n);g.unescape=A(C);g.result=function(a,c,b){c=null==a?void 0:a[c];void 0===c&&(c=b);return g.isFunction(c)?c.call(a):c};var V=0;g.uniqueId=function(a){var c=
++V+"";return a?a+c:c};g.templateSettings={evaluate:/<%([\s\S]+?)%>/g,interpolate:/<%=([\s\S]+?)%>/g,escape:/<%-([\s\S]+?)%>/g};var L=/(.)^/,r={"'":"'","\\":"\\","\r":"r","\n":"n","\u2028":"u2028","\u2029":"u2029"},U=/\\|'|\r|\n|\u2028|\u2029/g,T=function(a){return"\\"+r[a]};g.template=function(a,c,b){!c&&b&&(c=b);c=g.defaults({},c,g.templateSettings);b=RegExp([(c.escape||L).source,(c.interpolate||L).source,(c.evaluate||L).source].join("|")+"|$","g");var d=0,e="__p+='";a.replace(b,function(c,b,f,
g,h){e+=a.slice(d,h).replace(U,T);d=h+c.length;b?e+="'+\n((__t=("+b+"))==null?'':_.escape(__t))+\n'":f?e+="'+\n((__t=("+f+"))==null?'':__t)+\n'":g&&(e+="';\n"+g+"\n__p+='");return c});e+="';\n";c.variable||(e="with(obj||{}){\n"+e+"}\n");e="var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};\n"+e+"return __p;\n";try{var f=new Function(c.variable||"obj","_",e)}catch(h){throw h.source=e,h;}b=function(a){return f.call(this,a,g)};b.source="function("+(c.variable||"obj")+
"){\n"+e+"}";return b};g.chain=function(a){a=g(a);a._chain=!0;return a};var N=function(a,c){return a._chain?g(c).chain():c};g.mixin=function(a){g.each(g.functions(a),function(c){var b=g[c]=a[c];g.prototype[c]=function(){var a=[this._wrapped];m.apply(a,arguments);return N(this,b.apply(g,a))}})};g.mixin(g);g.each("pop push reverse shift sort splice unshift".split(" "),function(a){var c=h[a];g.prototype[a]=function(){var b=this._wrapped;c.apply(b,arguments);"shift"!==a&&"splice"!==a||0!==b.length||delete b[0];
return N(this,b)}});g.each(["concat","join","slice"],function(a){var c=h[a];g.prototype[a]=function(){return N(this,c.apply(this._wrapped,arguments))}});g.prototype.value=function(){return this._wrapped};g.prototype.valueOf=g.prototype.toJSON=g.prototype.value;g.prototype.toString=function(){return""+this._wrapped};"function"===typeof define&&define.amd&&define("underscore",[],function(){return g})}).call(this);var JSON;JSON||(JSON={});
(function(){function a(a){return 10>a?"0"+a:a}function c(a){e.lastIndex=0;return e.test(a)?'"'+a.replace(e,function(a){var c=l[a];return"string"===typeof c?c:"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4)})+'"':'"'+a+'"'}function b(a,d){var e,l,q,s,v=f,p,g=d[a];g&&("object"===typeof g&&"function"===typeof g.toJSON)&&(g=g.toJSON(a));"function"===typeof m&&(g=m.call(d,a,g));switch(typeof g){case "string":return c(g);case "number":return isFinite(g)?String(g):"null";case "boolean":case "null":return String(g);case "object":if(!g)return"null";
f+=h;p=[];if("[object Array]"===Object.prototype.toString.apply(g)){s=g.length;for(e=0;e<s;e+=1)p[e]=b(e,g)||"null";q=0===p.length?"[]":f?"[\n"+f+p.join(",\n"+f)+"\n"+v+"]":"["+p.join(",")+"]";f=v;return q}if(m&&"object"===typeof m)for(s=m.length,e=0;e<s;e+=1)"string"===typeof m[e]&&(l=m[e],(q=b(l,g))&&p.push(c(l)+(f?": ":":")+q));else for(l in g)Object.prototype.hasOwnProperty.call(g,l)&&(q=b(l,g))&&p.push(c(l)+(f?": ":":")+q);q=0===p.length?"{}":f?"{\n"+f+p.join(",\n"+f)+"\n"+v+"}":"{"+p.join(",")+
"}";f=v;return q}}"function"!==typeof Date.prototype.toJSON&&(Date.prototype.toJSON=function(c){return isFinite(this.valueOf())?this.getUTCFullYear()+"-"+a(this.getUTCMonth()+1)+"-"+a(this.getUTCDate())+"T"+a(this.getUTCHours())+":"+a(this.getUTCMinutes())+":"+a(this.getUTCSeconds())+"Z":null},String.prototype.toJSON=Number.prototype.toJSON=Boolean.prototype.toJSON=function(a){return this.valueOf()});var d=/[\u0000\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,
e=/[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,f,h,l={"\b":"\\b","\t":"\\t","\n":"\\n","\f":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"},m;"function"!==typeof JSON.stringify&&(JSON.stringify=function(a,c,d){var e;h=f="";if("number"===typeof d)for(e=0;e<d;e+=1)h+=" ";else"string"===typeof d&&(h=d);if((m=c)&&"function"!==typeof c&&("object"!==typeof c||"number"!==typeof c.length))throw Error("JSON.stringify");return b("",{"":a})});
...
a.pkp.classes.Handler.getHandler(a(d[c])).handlerChildren_.push(e)});b.eventBridge&&(this.eventBridge_=b.eventBridge);if(b.publishChangeEvents)for(this.publishChangeEvents_=b.publishChangeEvents,f=0;f<this.publishChangeEvents_.length;f++)this.publishEvent(this.publishChangeEvents_[f]);else this.publishChangeEvents_=[];this.data("handler",this)};a.pkp.classes.Handler.prototype.publishChangeEvents_=null;a.pkp.classes.Handler.prototype.$htmlElement_=null;a.pkp.classes.Handler.prototype.eventBindings_=
...
a.pkp.classes.Handler.prototype.getHtmlElement=function(){a.pkp.classes.Handler.checkContext_(this);return this.$htmlElement_};a.pkp.classes.Handler.prototype.publishChangeEvents=function(){var a;for(a=0;a<this.publishChangeEvents_.length;a++)this.trigger(this.publishChangeEvents_[a])};a.pkp.classes.Handler.prototype.handleEvent=function(c){var b,d,e,f,h,l;b=a(this);d=a.pkp.classes.Handler.getHandler(b);if(b[0]!==d.getHtmlElement.call(d)[0])throw Error("An invalid handler is bound to the calling element of an event!");
b=d.eventBindings_[c.type];if(void 0===b)return!1;e=a.makeArray(arguments);f=!0;e.unshift(this);h=0;for(l=b.length;h<l&&(!1===b[h].apply(d,e)&&(f=!1),!c.isImmediatePropagationStopped());h++);c.stopPropagation();return f};a.pkp.classes.Handler.prototype.callbackWrapper=function(c,b){a.pkp.classes.Handler.checkContext_(this);b||(b=this);return function(){var d;d=a.makeArray(arguments);d.unshift(this);return c.apply(b,d)}};a.pkp.classes.Handler.prototype.remoteResponse=function(a,b){return this.handleJson(b)};
...
2));this.triggerPublicEvent_(a,f)}))};a.pkp.classes.Handler.prototype.switchViz=function(c){a(c.currentTarget).parent().parent().find("span").toggle()};a.pkp.classes.Handler.prototype.initializeTinyMCE=function(){if("undefined"!==typeof tinyMCE){var c=this.getHtmlElement().attr("id"),b=tinyMCE.EditorManager.settings;b.defaultToolbar=b.toolbar;a("#"+c).find(".richContent").each(function(){var c=a(this).attr("id"),b=a("<div></div>"),f=a("<div></div>"),h=tinyMCE.EditorManager.settings;a(this).hasClass("extendedRichContent")?
h.toolbar=h.richToolbar:h.toolbar=h.defaultToolbar;tinyMCE.EditorManager.createEditor(c,h).render();if(a(this).hasClass("localizable")||a(this).hasClass("flag"))if(b.addClass("mceLocalizationIcon localizable"),b.attr("id","mceLocalizationIcon-"+c),a(this).wrap(f),a(this).parent().append(b),a(this).hasClass("localizable"))b.addClass("mceGlobe");else if(a(this).hasClass("flag")&&(c=a(this).attr("class").split(" "),c.length))for(f=0;f<c.length;f++)if(c[f].match(/^flag_[a-z]{2}_[A-Z]{2}$/)){b.addClass(c[f]);
break}})}};a.pkp.classes.Handler.prototype.triggerPublicEvent_=function(c,b){this.getHtmlElement().parent().trigger(c,b);this.eventBridge_&&a('[id^="'+this.eventBridge_+'"]').trigger(c,b)};a.pkp.classes.Handler.prototype.replaceWith=function(a){this.unbindGlobalAll();this.getHtmlElement().replaceWith(a)};a.pkp.classes.Handler.prototype.replacePartialWith=function(c,b){a.pkp.classes.Handler.hasHandler(b)?a.pkp.classes.Handler.getHandler(b).replaceWith(c):(this.unbindPartial(b),b.replaceWith(c))};a.pkp.classes.Handler.prototype.html=
function(a){this.unbindGlobalChildren();this.getHtmlElement().html(a)};a.pkp.classes.Handler.prototype.unbindPartial=function(c){a("*",c).each(function(){if(a.pkp.classes.Handler.hasHandler(a(this))){var c=a.pkp.classes.Handler.getHandler(a(this));c.callbackWrapper(c.unbindGlobalAll())}})};a.pkp.classes.Handler.checkContext_=function(c){if(!(c instanceof a.pkp.classes.Handler))throw Error("Trying to call handler method in non-handler context!");}})(jQuery);(function(a){a.pkp.classes.TinyMCEHelper=function(){throw Error("Trying to instantiate the TinyMCEHelper singleton!");};a.pkp.classes.TinyMCEHelper.prototype.getVariableMap=function(c){c=a(c).attr("data-variables");return void 0!==c?a.parseJSON(decodeURIComponent(c)):[]};a.pkp.classes.TinyMCEHelper.prototype.getVariableTypesMap=function(c){c=a(c).attr("data-variablesType");return void 0!==c?a.parseJSON(decodeURIComponent(c)):[]};a.pkp.classes.TinyMCEHelper.prototype.getVariableElement=function(c,
b,d){d=a.pkp.classes.TinyMCEHelper.prototype.getVariableTypesMap(d);return void 0!=d[c]&&(d=d[c],d==a.pkp.cons.INSERT_TAG_VARIABLE_TYPE_PLAIN_TEXT)?a("<div/>").append(a("<span/>").text(b)):a("<div/>").append(a("<span/>").addClass("pkpTag mceNonEditable").attr("data-symbolic",c).text(b))}})(jQuery);(function(a){a.pkp.classes.linkAction=a.pkp.classes.linkAction||{};a.pkp.classes.linkAction.LinkActionRequest=function(a,b){this.$linkActionElement=a;this.options=b;a.is("a")&&b.url&&a.attr("href",b.url)};a.pkp.classes.linkAction.LinkActionRequest.prototype.$linkActionElement=null;a.pkp.classes.linkAction.LinkActionRequest.prototype.options=null;a.pkp.classes.linkAction.LinkActionRequest.prototype.activate=function(a,b){this.getLinkActionElement().trigger("actionStart");return!1};a.pkp.classes.linkAction.LinkActionRequest.prototype.finish=
...
this.$linkActionElement.focus();this.$modal_.remove();return this.parent("finish")}})(jQuery);(function(a){a.pkp.classes.notification=a.pkp.classes.notification||{};a.pkp.classes.notification.NotificationHelper=function(){};a.pkp.classes.notification.NotificationHelper.redirectNotifyUserEvent=function(c,b){var d,e,f,h,l,m,k,u,t,n,q;if(void 0!==b.content)c.getHtmlElement().parent().trigger("notifyUser",[b]);else{d=c.getHtmlElement();e=!1;!(c instanceof a.pkp.controllers.SiteHandler)&&0<a(b).parents(".pkp_controllers_grid").length&&(d.parent().trigger("notifyUser"),e=!0);d=a(".pkp_notification",
d);f=[];h=0;for(l=d.length;h<l;h++)if(k=a(d[h]),!(0<k.parents(":hidden").length)){m=k.parents();t=0;for(n=m.length;t<n;t++)if(u=a(m[t]).data("pkp.handler"),u instanceof a.pkp.classes.Handler){q=a(m[t]);break}if(q.has(b[0]).length||q[0]===b[0]){if(0<k.parents(".ui-accordion:first").length&&(m=k.parents(".ui-accordion:first"),!m.has(b[0])))continue;f.push(k)}}if(f.length)for(h=f.length-1;-1<h;h--)f[h].triggerHandler("notifyUser");else e||c.getHtmlElement().parent().trigger("notifyUser")}}})(jQuery);(function(a){a.pkp.classes.features=a.pkp.classes.features||{};a.pkp.classes.features.Feature=function(a,b){this.gridHandler=a;this.options_=b;this.addFeatureHtml(this.getGridHtmlElement(),b)};a.pkp.classes.features.Feature.prototype.gridHandler=null;a.pkp.classes.features.Feature.prototype.options_=null;a.pkp.classes.features.Feature.prototype.setOptions=function(a){this.options_=a};a.pkp.classes.features.Feature.prototype.getOptions=function(){return this.options_};a.pkp.classes.features.Feature.prototype.init=
function(){throw Error("Abstract method!");};a.pkp.classes.features.Feature.prototype.addElement=function(a){return!1};a.pkp.classes.features.Feature.prototype.replaceElement=function(a){return!1};a.pkp.classes.features.Feature.prototype.resequenceRows=function(a){return!1};a.pkp.classes.features.Feature.prototype.refreshGrid=function(a){return!1};a.pkp.classes.features.Feature.prototype.replaceElementResponseHandler=function(a){return!1};a.pkp.classes.features.Feature.prototype.callbackWrapper=function(a,
b){return this.gridHandler.callbackWrapper(a,b)};a.pkp.classes.features.Feature.prototype.addFeatureHtml=function(a,b){};a.pkp.classes.features.Feature.prototype.getGridHtmlElement=function(){return this.gridHandler.getHtmlElement()}})(jQuery);(function(a){a.pkp.classes.features.OrderItemsFeature=function(c,b){this.parent(c,b);this.$orderButton_=a(".pkp_linkaction_orderItems",this.getGridHtmlElement());this.$finishControl_=a(".order_finish_controls",this.getGridHtmlElement());0===this.$orderButton_.length&&(this.isOrdering=!0);this.itemsOrder=[]};a.pkp.classes.Helper.inherits(a.pkp.classes.features.OrderItemsFeature,a.pkp.classes.features.Feature);a.pkp.classes.features.OrderItemsFeature.prototype.itemsOrder=null;a.pkp.classes.features.OrderItemsFeature.prototype.isOrdering=
...
function(a,b,d){};a.pkp.classes.features.OrderItemsFeature.prototype.dragStopCallback=function(a,b,d){};a.pkp.classes.features.OrderItemsFeature.prototype.updateOrderCallback=function(a,b,d){};a.pkp.classes.features.OrderItemsFeature.prototype.init=function(){this.addOrderingClassToRows();this.toggleMoveItemRowAction(this.isOrdering);this.getGridHtmlElement().find("div.order_message").hide();this.toggleOrderLink_();this.isOrdering&&this.setupSortablePlugin()};a.pkp.classes.features.OrderItemsFeature.prototype.addFeatureHtml=
function(c,b){var d,e;void 0!==b.orderFinishControls&&(d=a(b.orderFinishControls),c.find("table").last().after(d),d.hide());void 0!==b.orderMessage&&(d=b.orderMessage,e=c.find(".gridRow").filter(function(c,b){return!Boolean(a(this).find("a.pkp_linkaction_moveItem").length)}),e.find("td:first-child").prepend(d));this.updateOrderLinkVisibility_()};a.pkp.classes.features.OrderItemsFeature.prototype.addOrderingClassToRows=function(){this.gridHandler.getRows().filter(function(c,b){return a(this).find("a.pkp_linkaction_moveItem").length}).addClass("orderable")};
a.pkp.classes.features.OrderItemsFeature.prototype.setupSortablePlugin=function(){};a.pkp.classes.features.OrderItemsFeature.prototype.storeRowOrder=function(a,b){};a.pkp.classes.features.OrderItemsFeature.prototype.clickOrderHandler=function(){this.gridHandler.hideAllVisibleRowActions();this.storeOrder(this.gridHandler.getRows());this.toggleState(!0);return!1};a.pkp.classes.features.OrderItemsFeature.prototype.saveOrderHandler=function(){var a;this.gridHandler.updateControlRowsPosition();this.unbindOrderFinishControlsHandlers_();
...
f=this.gridHandler.callbackWrapper(this.dragStartCallback,this),h=this.gridHandler.callbackWrapper(this.dragStopCallback,this),l=this.gridHandler.callbackWrapper(this.updateOrderCallback,this);b={disabled:!e,items:b,activate:f,deactivate:h,update:l,tolerance:"pointer"};"object"===typeof d&&(b=a.extend(!0,b,d));c.sortable(b)};a.pkp.classes.features.OrderItemsFeature.prototype.getRowsDataId=function(c){var b,d=[],e;for(b in this.itemsOrder)e=a("#"+this.itemsOrder[b],c),1>e.length||(e=this.gridHandler.getRowDataId(e),
...
a.pkp.classes.features.OrderItemsFeature.prototype.addElement=function(a){this.addOrderingClassToRows();this.toggleItemsDragMode();return!1};a.pkp.classes.features.OrderItemsFeature.prototype.replaceElement=function(a){this.addOrderingClassToRows();this.toggleItemsDragMode();return!1};a.pkp.classes.features.OrderItemsFeature.prototype.replaceElementResponseHandler=function(a){this.updateOrderLinkVisibility_();this.setupNonOrderableMessage_();return!1};a.pkp.classes.features.OrderItemsFeature.prototype.updateOrderLinkVisibility_=
...
rowsId:h});return b};a.pkp.classes.features.OrderCategoryGridItemsFeature.prototype.toggleCategoryDragMode_=function(c){var b=this.isOrdering;c=this.gridHandler.getCategoryRow(c);c=a("td:first",c);var d=this.getMoveItemClasses();b?c.addClass(d):c.removeClass(d)};a.pkp.classes.features.OrderCategoryGridItemsFeature.prototype.getCategorySequence_=function(c){var b,d,e=[],f;b=0;for(d=c.length;b<d;b++)f=this.gridHandler.getCategoryDataIdByRowId(c[b]),f=this.gridHandler.getCategoryIdPrefix()+f,-1<a.inArray(f,
e)||e.push(f);return e}})(jQuery);(function(a){a.pkp.classes.features.OrderListbuilderItemsFeature=function(a,b){this.parent(a,b)};a.pkp.classes.Helper.inherits(a.pkp.classes.features.OrderListbuilderItemsFeature,a.pkp.classes.features.OrderItemsFeature);a.pkp.classes.features.OrderListbuilderItemsFeature.prototype.addFeatureHtml=function(c,b){var d,e,f,h,l,m;this.parent("addFeatureHtml",c,b);d=this.getSequenceInput_();e=this.gridHandler.getRows();f=0;for(h=e.length;f<h;f++)l=a(e[f]),m=d.clone(),a("td.first_column",l).append(m)};
...
function(a,b){var d=a+1;b.find(".itemSequence").attr("value",d);b.find(".isModified").attr("value",1)};a.pkp.classes.features.OrderListbuilderItemsFeature.prototype.saveOrderHandler=function(){this.parent("saveOrderHandler");this.toggleState(!1);return!1};a.pkp.classes.features.OrderListbuilderItemsFeature.prototype.updateOrderCallback=function(a,b,d){this.parent("updateOrderCallback");a=this.gridHandler.getRows();this.storeOrder(a)};a.pkp.classes.features.OrderListbuilderItemsFeature.prototype.clickOrderHandler=
function(){var c=a("select:visible",this.getGridHtmlElement()),b,d;if(0<c.length)for(b=0,d=c.length;b<d;b++)this.gridHandler.saveRow(a(c[b]).parents(".gridRow"));return this.parent("clickOrderHandler")};a.pkp.classes.features.OrderListbuilderItemsFeature.prototype.addElement=function(a){this.parent("addElement",a);this.formatAndStoreNewRow_(a);return!1};a.pkp.classes.features.OrderListbuilderItemsFeature.prototype.replaceElement=function(a){this.parent("replaceElement",a);this.formatAndStoreNewRow_(a);
...
function(a){a.children().after(this.getSequenceInput_());a=this.gridHandler.getRows();this.storeOrder(a)}})(jQuery);(function(a){a.pkp.classes.features.OrderMultipleListsItemsFeature=function(a,b){this.parent(a,b)};a.pkp.classes.Helper.inherits(a.pkp.classes.features.OrderMultipleListsItemsFeature,a.pkp.classes.features.OrderListbuilderItemsFeature);a.pkp.classes.features.OrderMultipleListsItemsFeature.prototype.addFeatureHtml=function(c,b){var d,e,f,h,l,m,k;this.parent("addFeatureHtml",c,b);d=a('<input type="hidden" name="newRowId[listId]" class="itemList" />');e=this.gridHandler.getRows();f=0;for(h=e.length;f<
h;f++)l=a(e[f]),m=this.gridHandler.getListIdByRow(l),k=d.clone(),k.attr("value",m),a("td.first_column",l).append(k)};a.pkp.classes.features.OrderMultipleListsItemsFeature.prototype.storeRowOrder=function(a,b){var d,e;this.parent("storeRowOrder",a,b);d=b.find(".itemList");e=this.gridHandler.getListIdByRow(b);d.attr("value",e)};a.pkp.classes.features.OrderMultipleListsItemsFeature.prototype.setupSortablePlugin=function(){var a=this.gridHandler.getLists().find("tbody");this.applySortPlgOnElements(a,
...
a.pkp.classes.features.GeneralPagingFeature.prototype.setGridParams=function(c){var b=this.getOptions();b.hasOwnProperty("filter")&&(b=a.parseJSON(b.filter),a.extend(!0,c,b));this.gridHandler.setFetchExtraParams(c)}})(jQuery);(function(a){a.pkp.classes.features.PagingFeature=function(a,b){this.parent(a,b)};a.pkp.classes.Helper.inherits(a.pkp.classes.features.PagingFeature,a.pkp.classes.features.GeneralPagingFeature);a.pkp.classes.features.PagingFeature.prototype.init=function(){this.configPagingLinks_();this.configItemsPerPageElement_()};a.pkp.classes.features.PagingFeature.prototype.addFeatureHtml=function(a,b){a.append(b.pagingMarkup)};a.pkp.classes.features.PagingFeature.prototype.resequenceRows=function(a){a=this.gridHandler.getRows();
var b,d;b=this.getOptions();b=a.length-b.currentItemsPerPage;if(0<b)for(d=0;d<b;d++)this.gridHandler.deleteElement(a.first(),!0);return!1};a.pkp.classes.features.PagingFeature.prototype.refreshGrid=function(a){var b=this.getOptions(),d;a=this.gridHandler.getFetchExtraParams();a[b.pageParamName]=b.currentPage;a[b.itemsPerPageParamName]=b.currentItemsPerPage;b=this.gridHandler.getRows().first();d=this.gridHandler.getRows().last();a.topLimitRowId=0==b.length?0:this.gridHandler.getRowDataId(b);a.bottomLimitRowId=
0==d.length?0:this.gridHandler.getRowDataId(d);this.setGridParams(a);return!1};a.pkp.classes.features.PagingFeature.prototype.replaceElementResponseHandler=function(c){var b,d;d=this.getOptions();void 0!=c.deletedRowReplacement&&(b=c.deletedRowReplacement,this.gridHandler.insertOrReplaceElement(b));void 0!=c.pagingInfo&&(b=c.pagingInfo,this.setOptions(b),this.gridHandler.replacePartialWith(b.pagingMarkup,a("div.gridPaging",this.getGridHtmlElement())),this.init());c.loadLastPage&&this.getGridHtmlElement().trigger("dataChanged");
void 0!=c.newTopRow&&(b=this.gridHandler.getRows(),d.currentItemsPerPage==b.length&&this.gridHandler.deleteElement(b.last(),!0),b=c.newTopRow,this.gridHandler.insertOrReplaceElement(b,!0));return!1};a.pkp.classes.features.PagingFeature.prototype.configPagingLinks_=function(){var c,b,d,e,f,h,l,m;c=this.getOptions();if(b=a("div.gridPaging",this.getGridHtmlElement()))for(m=this.callbackWrapper(function(b,d){h=RegExp("[?&]"+c.pageParamName+"(?:=([^&]*))?","i");l=h.exec(a(d.target).attr("href"));null!=
l&&(c.currentPage=parseInt(l[1],10),this.getGridHtmlElement().trigger("dataChanged"));return!1},this),b=b.find("a").not(".showMoreItems").not(".showLessItems"),d=0,e=b.length;d<e;d++)f=a(b[d]),f.click(m)};a.pkp.classes.features.PagingFeature.prototype.configItemsPerPageElement_=function(){var c,b,d,e,f,h;c=this.getOptions();if(b=a("div.gridPaging",this.getGridHtmlElement()))if(h=this.callbackWrapper(function(b,d){c.currentItemsPerPage=parseInt(a("option",d.target).filter(":selected").attr("value"),
...
this));return!1};a.pkp.classes.features.InfiniteScrollingFeature.prototype.observeScroll_=function(c,b){var d,e;if(this.getOptions().itemsTotal==this.gridHandler.getRows().length||!this.getGridHtmlElement().is(":visible"))return!1;a(c).hasClass("scrollable")?(d=a(c).height(),e=c.scrollHeight):(d=a.pkp.controllers.SiteHandler.prototype.getWindowDimensions(),d=d.height,e=this.getGridHtmlElement().offset().top+this.getGridHtmlElement().height());d+a(c).scrollTop()>=e&&(this.$scrollableElement_.length?
this.$scrollableElement_.unbind("scroll"):this.getGridHtmlElement().trigger("pkpRemoveScrollingObserver",[this.observeScrollCallback_]),this.loadMoreItems_());return!1};a.pkp.classes.features.InfiniteScrollingFeature.prototype.fixGridHeight_=function(){var c=a("div.scrollable",this.getGridHtmlElement()),b,d,e,f;0<c.length&&(e=setInterval(function(){if(c.is(":visible"))for(clearInterval(e),f=c.length,b=0;b<f;b++)d=a(c[b]),d.get(0).scrollHeight>d.height()&&d.css("max-height",d.get(0).scrollHeight-10)},
300))};a.pkp.classes.features.InfiniteScrollingFeature.prototype.addPagingDataToRows_=function(){var a=this.getOptions();this.gridHandler.getRows().filter("tr:not([data-paging])").attr("data-paging",a.currentPage)};a.pkp.classes.features.InfiniteScrollingFeature.prototype.updatePagingDataInAllRows_=function(){var c,b=this.getOptions(),d,e,f=1,h=1;c=this.gridHandler.getRows();c.removeAttr("data-paging");d=0;for(e=c.length;d<e;d++)a(c[d]).attr("data-paging",f),h++,h>b.currentItemsPerPage&&(h=1,f++)};
a.pkp.classes.features.InfiniteScrollingFeature.prototype.addScrollHandler_=function(){var a=this.$scrollableElement_;a.length?a.scroll(this.observeScrollCallback_):this.getGridHtmlElement().trigger("pkpObserveScrolling",[this.observeScrollCallback_])};a.pkp.classes.features.InfiniteScrollingFeature.prototype.toggleLoadingContainer_=function(a){var b=this.getGridHtmlElement().find("div.gridPagingScrolling div.pkp_loading"),d=this.$scrollableElement_,b=b.height();a?(this.getGridHtmlElement().addClass("loading"),
...
c.init_instance_callback=a.pkp.controllers.SiteHandler.prototype.triggerTinyMCEInitialized;c.setup=a.pkp.controllers.SiteHandler.prototype.triggerTinyMCESetup;tinyMCE.init(c)}};a.pkp.controllers.SiteHandler.prototype.triggerTinyMCEInitialized=function(c){a("#"+a.pkp.classes.Helper.escapeJQuerySelector(c.id)).trigger("tinyMCEInitialized",[c])};a.pkp.controllers.SiteHandler.prototype.triggerTinyMCESetup=function(c){var b=a("#"+a.pkp.classes.Helper.escapeJQuerySelector(c.id));b.attr("readonly")&&(c.settings.readonly=
!0);b=b.attr("rows")||10;c.settings.height=(20*b).toString()+"px";c.on("init",function(c){var b=a("#"+c.id),f,h;f=a("#"+c.id).attr("placeholder");""!==f&&(h=a("<span></span>"),h.html(f),h.addClass("mcePlaceholder"),h.attr("id","mcePlaceholder-"+c.id),c.target.getContent().length&&h.hide(),c=a("<div></div>"),c.addClass("mcePlaceholderParent"),b.wrap(c),b.parent().append(h))});c.on("activate",function(c){a("#mcePlaceholder-"+c.id).hide()});c.on("deactivate",function(c){c.target.getContent().length||
a("#mcePlaceholder-"+c.id).show();c.target.dom.addClass(c.target.dom.select("li"),"show")});c.on("BeforeSetContent",function(b){var e=a.pkp.classes.TinyMCEHelper.prototype.getVariableMap("#"+a.pkp.classes.Helper.escapeJQuerySelector(c.id));b.content=b.content.replace(/\{\$([a-zA-Z]+)\}(?![^<]*>)/g,function(b,d,l,m){return void 0!==e[d]?a.pkp.classes.TinyMCEHelper.prototype.getVariableElement(d,e[d],"#"+c.id).html():b})});c.on("SaveContent",function(c){var b=a("<div>"+c.content+"</div>");b.find(".pkpTag").replaceWith(function(){return"{$"+
a(this).attr("data-symbolic")+"}"});c.content=b.html()});c.on("FullscreenStateChanged init",function(c){c=c.target;var b=a(c.editorContainer);c.plugins.fullscreen&&(c.plugins.fullscreen.isFullscreen()?b.find(".mce-toolbar[role='menubar']").show():b.find(".mce-toolbar[role='menubar']").hide())})};a.pkp.controllers.SiteHandler.prototype.getWindowDimensions=function(){return{height:a(window).height(),width:a(window).width()}};a.pkp.controllers.SiteHandler.prototype.redirectToUrl=function(a,b,d){window.location=
d};a.pkp.controllers.SiteHandler.prototype.registerUnsavedFormElement_=function(c,b,d){c=a(d.target.lastElementChild).attr("id");-1==a.inArray(c,this.unsavedFormElements_)&&this.unsavedFormElements_.push(c)};a.pkp.controllers.SiteHandler.prototype.unregisterUnsavedFormElement_=function(c,b,d){c=a(d.target.lastElementChild).attr("id");c=a.inArray(c,this.unsavedFormElements_);-1!==c&&delete this.unsavedFormElements_[c]};a.pkp.controllers.SiteHandler.prototype.unregisterAllFormElements_=function(){this.unsavedFormElements_=
[]};a.pkp.controllers.SiteHandler.prototype.fetchNotificationHandler_=function(c,b,d){void 0!==d?this.showNotification_(d):a.ajax({url:this.options_.fetchNotificationUrl,data:this.options_.requestOptions,success:this.callbackWrapper(this.showNotificationResponseHandler_),dataType:"json",async:!1})};a.pkp.controllers.SiteHandler.prototype.updateHeaderHandler_=function(c,b){a.pkp.classes.Handler.getHandler(a("#navigationUserWrapper")).reload()};a.pkp.controllers.SiteHandler.prototype.callWhenClickOutsideHandler_=
function(a,b,d){void 0!==d.container&&void 0!==d.callback&&(a=d.container.attr("id"),this.outsideClickChecks_[a]=d)};a.pkp.controllers.SiteHandler.prototype.mouseDownHandler_=function(c,b){var d;if(!a.isEmptyObject(this.outsideClickChecks_))for(d in this.outsideClickChecks_)this.processOutsideClickCheck_(this.outsideClickChecks_[d],b);return!0};a.pkp.controllers.SiteHandler.prototype.processOutsideClickCheck_=function(a,b){if("click"!==b.type&&"mousedown"!==b.type&&"mouseup"!==b.type)throw Error("Can not check outside click with the passed event: "+
b.type+".");var d=a.container;return d.is(":hidden")?!1:0===d.has(b.target).length?(delete this.outsideClickChecks_[d.attr("id")],a.callback(),!0):!1};a.pkp.controllers.SiteHandler.prototype.pageUnloadHandler_=function(c,b){var d,e,f;d=a.pkp.classes.Handler.getHandler(a("body"));e=0;for(f in d.unsavedFormElements_)f&&e++;if(0<e)return a.pkp.locale.form_dataHasChanged};a.pkp.controllers.SiteHandler.prototype.isFormUnsaved=function(a){return null!==this.unsavedFormElements_&&void 0!==this.unsavedFormElements_[a]?
!0:!1};a.pkp.controllers.SiteHandler.prototype.showNotificationResponseHandler_=function(a,b){this.showNotification_(b)};a.pkp.controllers.SiteHandler.prototype.showNotification_=function(a){var b,d;a=this.handleJson(a);if(!1!==a&&a.content.general)for(b in a=a.content.general,a)for(d in a[b])new PNotify(a[b][d])};a.pkp.controllers.SiteHandler.prototype.openModal_=function(a,b,d,e){this.getHtmlElement().addClass("modal_is_visible")};a.pkp.controllers.SiteHandler.prototype.closeModal_=function(a,b,
d,e){a=this.getHtmlElement();a.find(".pkp_modal.is_visible").length||a.removeClass("modal_is_visible")};a.pkp.controllers.SiteHandler.prototype.registerScrollingObserver_=function(c,b,d,e){a(document).scroll(e);return!1};a.pkp.controllers.SiteHandler.prototype.unregisterScrollingObserver_=function(c,b,d,e){a(document).unbind("scroll",e);return!1}})(jQuery);(function(a){a.pkp.controllers.UrlInDivHandler=function(a,b){this.parent(a,b);this.sourceUrl_=b.sourceUrl;this.reload();b.refreshOn&&this.bindGlobal(b.refreshOn,this.reload)};a.pkp.classes.Helper.inherits(a.pkp.controllers.UrlInDivHandler,a.pkp.classes.Handler);a.pkp.controllers.UrlInDivHandler.sourceUrl_=null;a.pkp.controllers.UrlInDivHandler.prototype.reload=function(){a.get(this.sourceUrl_,this.callbackWrapper(this.handleLoadedContent_),"json")};a.pkp.controllers.UrlInDivHandler.prototype.getSourceUrl=
function(){return this.sourceUrl_};a.pkp.controllers.UrlInDivHandler.prototype.setSourceUrl=function(a){this.sourceUrl_=a};a.pkp.controllers.UrlInDivHandler.prototype.handleLoadedContent_=function(a,b){var d=this.handleJson(b);!0===d.status?void 0===d.content?this.getHtmlElement().hide():(/msie/.test(navigator.userAgent.toLowerCase())?this.html(d.content):(this.getHtmlElement().hide(),this.html(d.content),this.getHtmlElement().fadeIn(400)),this.trigger("urlInDivLoaded",[this.getHtmlElement().attr("id")])):
...
function(c,b,d){!0===d.status?this.getHtmlElement().parent().trigger("notifyUser",[d]):a.pkp.classes.notification.NotificationHelper.redirectNotifyUserEvent(this,d)};a.pkp.controllers.PageHandler.prototype.redirectDataChangedEventHandler_=function(c,b,d){c=a("a",b.target);var e=a.pkp.classes.Handler.getHandler(c).getUrl();c=a(".pkp_controllers_grid",this.getHtmlElement()).filter(function(){var c=0;a(this).find("a").each(function(){a(this).attr("href")==e&&c++});return 0<c});0<c.length&&c.each(function(){a(this).trigger("dataChanged",
[d])})}})(jQuery);(function(a){a.pkp.controllers.TabHandler=function(c,b){var d,e,f;this.parent(c,b);this.bind("tabsbeforeactivate",this.tabsBeforeActivate);this.bind("tabsactivate",this.tabsActivate);this.bind("tabscreate",this.tabsCreate);this.bind("tabsbeforeload",this.tabsBeforeLoad);this.bind("tabsload",this.tabsLoad);this.bind("containerReloadRequested",this.tabsReloadRequested);this.bind("addTab",this.addTab);b.emptyLastTab&&(this.emptyLastTab_=b.emptyLastTab);d=document.location.toString();if(d.match("#"))for(d=
d.split("#")[1],e=c.find("li a"),f=0;f<e.length;f++)d==e[f].getAttribute("name")&&(b.selected=f);c.tabs({ajaxOptions:{cache:!1,dataFilter:this.callbackWrapper(this.dataFilter)},disabled:b.disabled,active:b.selected});c.children(".ui-tabs-nav").find("li > a").focus(function(c){a(this).click()})};a.pkp.classes.Helper.inherits(a.pkp.controllers.TabHandler,a.pkp.classes.Handler);a.pkp.controllers.TabHandler.prototype.$currentTab_=null;a.pkp.controllers.TabHandler.prototype.currentTabIndex_=0;a.pkp.controllers.TabHandler.prototype.tabsBeforeActivate=
function(c,b,d){var e=!1;this.$currentTab_.find("form").each(function(c){if(a.pkp.classes.Handler.getHandler(a("#"+a(this).attr("id"))).formChangesTracked)return e=!0,!1});this.$currentTab_.find(".hasDatepicker").datepicker("hide");if(e)if(confirm(a.pkp.locale.form_dataHasChanged))this.trigger("unregisterAllForms");else return!1;this.emptyLastTab_&&(a(window).one("error",function(a,c,b){return!1}),this.$currentTab_&&(this.unbindPartial(this.$currentTab_),this.$currentTab_.empty()));return!0};a.pkp.controllers.TabHandler.prototype.tabsCreate=
function(c,b,d){this.currentTabIndex_=d.tab.index();this.$currentTab_=d.panel.jquery?d.panel:a(d.panel);return!0};a.pkp.controllers.TabHandler.prototype.tabsActivate=function(c,b,d){this.currentTabIndex_=d.newTab.index();this.$currentTab_=d.newPanel.jquery?d.newPanel:a(d.newPanel);return!0};a.pkp.controllers.TabHandler.prototype.tabsLoad=function(a,b,d){return!0};a.pkp.controllers.TabHandler.prototype.tabsBeforeLoad=function(c,b,d){this.unbindPartial(a("#"+d.tab.attr("aria-controls")));d.ajaxSettings.cache=
...
1;b=a("<a/>").text(d.title).attr("href",d.url);d=a("<a/>").addClass("close").text(a.pkp.locale.common_close).attr("href","#");b=a("<li/>").append(b).append(d);d.click(function(){var c=a(this).closest("li"),b=a("#"+c.attr("aria-controls")),d,m;m=!1;b.find("form").each(function(){if(a.pkp.classes.Handler.getHandler(a(this)).formChangesTracked&&!confirm(a.pkp.locale.form_dataHasChanged))return m=!0,!1});m||(b.find("form").each(function(){var c=a.pkp.classes.Handler.getHandler(a(this));c&&c.unregisterForm()}),
...
this.callbackWrapper(this.handleError));this.pluploader.bind("FileUploaded",this.callbackWrapper(this.uploadComplete));this.pluploader.bind("QueueChanged",this.callbackWrapper(this.refreshUploader));e=a("#"+d.browse_button,this.getHtmlElement());e.click(function(a){return!1});this.pluploader.refresh();f=this;setTimeout(function(){f.getHtmlElement().find(".moxie-shim input").focus(function(a){e.addClass("in_focus")}).blur(function(a){e.removeClass("in_focus")})},100)};a.pkp.classes.Helper.inherits(a.pkp.controllers.UploaderHandler,
a.pkp.classes.Handler);a.pkp.controllers.UploaderHandler.prototype.startUpload=function(a,b,d){1<b.files.length&&b.removeFile(b.files[0]);this.updateStatus("uploading");b.start()};a.pkp.controllers.UploaderHandler.prototype.updateProgress=function(a,b,d){this.$progress.html(d.percent);this.$progressBar.css("width",d.percent+"%")};a.pkp.controllers.UploaderHandler.prototype.uploadComplete=function(c,b,d,e){c=a.parseJSON(e.response);b=d.name;c.status?("undefined"!==typeof c.uploadedFile&&(b=c.uploadedFile.name||
...
function(a,b,d){b.refresh()};a.pkp.controllers.UploaderHandler.prototype.updateStatus=function(a){this.getHtmlElement().removeClass("loading waiting uploading error complete").addClass(a)};a.pkp.controllers.UploaderHandler.DEFAULT_PROPERTIES_={runtimes:"html5,flash,silverlight,html4",max_file_size:a.pkp.cons.UPLOAD_MAX_FILESIZE,multi_selection:!1,file_data_name:"uploadedFile",multipart:!0,headers:{browser_user_agent:navigator.userAgent},browse_button:"pkpUploaderButton",drop_element:"pkpUploaderDropZone"}})(jQuery);(function(a){a.pkp.controllers.AutocompleteHandler=function(c,b){var d;this.parent(c,b);this.sourceUrl_=b.sourceUrl;b.sourceUrl=void 0;this.jLabelText_=b.jLabelText;this.disableSync_=b.disableSync;d={};d.source=this.callbackWrapper(this.fetchAutocomplete);d.appendTo="#"+c.attr("id");d=a.extend({},this.self("DEFAULT_PROPERTIES_"),d,b);this.textInput=c.find(":text");this.disableSync_||this.textInput.keyup(this.callbackWrapper(this.synchronizeFields_));this.textInput.autocomplete(d);this.textInput.attr("title",
...
a.pkp.classes.Handler);a.pkp.controllers.form.FormHandler.prototype.disableControlsOnSubmit=!1;a.pkp.controllers.form.FormHandler.prototype.trackFormChanges=!0;a.pkp.controllers.form.FormHandler.prototype.callerSubmitHandler_=null;a.pkp.controllers.form.FormHandler.prototype.cancelRedirectUrl_=null;a.pkp.controllers.form.FormHandler.prototype.formChangesTracked=!1;a.pkp.controllers.form.FormHandler.prototype.enableDisablePairs_=null;a.pkp.controllers.form.FormHandler.prototype.showErrors=function(c,
b,d){"undefined"!==typeof tinyMCE&&tinyMCE.EditorManager.triggerSave();var e=a.extend(!0,{},c);setTimeout(this.callbackWrapper(function(){e.defaultShowErrors();e=null}),250);c.checkForm()?this.trigger("formValid"):(this.trigger("formInvalid"),this.enableFormControls())};a.pkp.controllers.form.FormHandler.prototype.formChange=function(a,b){this.trackFormChanges&&!this.formChangesTracked&&(this.formChangesTracked=!0,this.trigger("formChanged"))};a.pkp.controllers.form.FormHandler.prototype.disableFormControls=
function(){this.disableControlsOnSubmit&&this.getHtmlElement().find(":submit").attr("disabled","disabled").addClass("ui-state-disabled");return!0};a.pkp.controllers.form.FormHandler.prototype.enableFormControls=function(){this.getHtmlElement().find(":submit").removeAttr("disabled").removeClass("ui-state-disabled");return!0};a.pkp.controllers.form.FormHandler.prototype.cancelForm=function(a,b){this.unregisterForm();this.trigger("formCanceled");return!1};a.pkp.controllers.form.FormHandler.prototype.unregisterForm=
function(){this.formChangesTracked=!1;this.trigger("unregisterChangedForm")};a.pkp.controllers.form.FormHandler.prototype.setupEnableDisablePairs=function(){var c=this.getHtmlElement(),b;for(b in this.enableDisablePairs_)a(c).find("[id^='"+b+"']").bind("click updatePair",this.callbackWrapper(this.toggleDependentElement_));return!0};a.pkp.controllers.form.FormHandler.prototype.submitFormWithoutValidation=function(a){a.settings.submitHandler=null;this.disableFormControls();this.getHtmlElement().submit();
this.formChangesTracked=!1};a.pkp.controllers.form.FormHandler.prototype.hideSpinner=function(){this.getHtmlElement().find(".formButtons .pkp_spinner").removeClass("is_visible")};a.pkp.controllers.form.FormHandler.prototype.toggleEditableControl=function(c,b){b.preventDefault();var d=a(c).parents('[data-pkp-editable="true"]');d.length&&d.toggleClass("isEditing")};a.pkp.controllers.form.FormHandler.prototype.submitHandler_=function(c,b){var d=!1;a(b).find(".formWidget").each(function(){var c=new a.Event("formSubmitRequested");
d||(a(this).trigger(c),d=c.isDefaultPrevented())});d||(this.showSpinner_(),this.trigger("unregisterChangedForm"),null!==this.callerSubmitHandler_?(this.formChangesTracked=!1,this.callbackWrapper(this.callerSubmitHandler_).call(c,b)):this.submitFormWithoutValidation(c))};a.pkp.controllers.form.FormHandler.prototype.pushTinyMCEChanges_=function(a,b){"undefined"!==typeof tinyMCE&&tinyMCE.EditorManager.triggerSave();return!0};a.pkp.controllers.form.FormHandler.prototype.toggleDependentElement_=function(c,
b){var d,e;d=this.getHtmlElement();e=a(c).attr("id");d=a(d).find("[id^='"+this.enableDisablePairs_[e]+"']");a(c).is(":checked")?a(d).prop("disabled",!1):a(d).prop("disabled",!0);return!0};a.pkp.controllers.form.FormHandler.prototype.tinyMCEInitHandler_=function(c,b,d){var e=d.id;d.on("blur",this.callbackWrapper(function(c){c.save();c=this.getHtmlElement();var b=a("#"+a.pkp.classes.Helper.escapeJQuerySelector(e),c);c.validate().element(b)}))};a.pkp.controllers.form.FormHandler.prototype.containerCloseHandler=
...
null;a.pkp.controllers.form.DropdownHandler.prototype.defaultKey_=null;a.pkp.controllers.form.DropdownHandler.prototype.currentKey_=null;a.pkp.controllers.form.DropdownHandler.prototype.getOptionsUrl_=null;a.pkp.controllers.form.DropdownHandler.prototype.selectOptionHandler_=function(c,b){this.trigger(this.eventName_,[a(c).val()])};a.pkp.controllers.form.DropdownHandler.prototype.loadOptions_=function(){a.get(this.getOptionsUrl_,this.callbackWrapper(this.setOptionList_),"json")};a.pkp.controllers.form.DropdownHandler.prototype.setOptionList_=
function(c,b){var d=this.handleJson(b),e=this.getHtmlElement().find("select"),f,h;for(f in d.content){h=a("<option/>");h.attr("value",f);if(this.defaultKey_==f||this.currentKey_==f)h.attr("selected","selected"),this.trigger(this.eventName_,[f]);h.text(d.content[f]);e.append(h)}this.trigger("dropDownOptionSet")};a.pkp.controllers.form.DropdownHandler.prototype.containerReloadHandler_=function(a,b){var d=this.getHtmlElement().find("select");this.currentKey_=d.find("option:selected").attr("value");d.find('option[value!="0"]').remove();
this.loadOptions_()}})(jQuery);(function(a){a.pkp.controllers.form.AjaxFormHandler=function(a,b){b.submitHandler=this.submitForm;this.parent(a,b);this.bind("refreshForm",this.refreshFormHandler_);this.publishEvent("containerReloadRequested")};a.pkp.classes.Helper.inherits(a.pkp.controllers.form.AjaxFormHandler,a.pkp.controllers.form.FormHandler);a.pkp.controllers.form.AjaxFormHandler.prototype.disableControlsOnSubmit=!0;a.pkp.controllers.form.AjaxFormHandler.prototype.submitForm=function(c,b){var d=this.getHtmlElement();this.disableFormControls();
a.post(d.attr("action"),d.serialize(),this.callbackWrapper(this.handleResponse),"json")};a.pkp.controllers.form.AjaxFormHandler.prototype.refreshFormHandler_=function(a,b,d){d&&this.replaceWith(d)};a.pkp.controllers.form.AjaxFormHandler.prototype.handleResponse=function(c,b){var d,e;e=this.handleJson(b);if(!1!==e)if(""===e.content)d=new a.Event("formSubmitted"),a(this.getHtmlElement()).find(".formWidget").trigger(d),this.trigger("formSubmitted"),this.publishChangeEvents(),this.disableControlsOnSubmit&&
this.enableFormControls();else{if(void 0!==e.reloadContainer)return this.trigger("dataChanged"),this.trigger("containerReloadRequested",[e]),e.status;this.replaceWith(e.content)}else this.enableFormControls();this.trigger("notifyUser",[this.getHtmlElement()]);this.hideSpinner();return e.status}})(jQuery);(function(a){a.pkp.controllers.form.ClientFormHandler=function(a,b){b.submitHandler=this.submitForm;this.parent(a,b)};a.pkp.classes.Helper.inherits(a.pkp.controllers.form.ClientFormHandler,a.pkp.controllers.form.FormHandler);a.pkp.controllers.form.ClientFormHandler.prototype.submitForm=function(c,b){var d;d=this.getHtmlElement().serializeArray();d.push({name:"clientSubmit",value:!0});this.trigger("formSubmitted",[a.param(d)])}})(jQuery);(function(a){a.pkp.controllers.form.ToggleFormHandler=function(a){this.parent(a,{trackFormChanges:!1});a.change(this.callbackWrapper(this.toggleHandler_))};a.pkp.classes.Helper.inherits(a.pkp.controllers.form.ToggleFormHandler,a.pkp.controllers.form.ClientFormHandler);a.pkp.controllers.form.ToggleFormHandler.prototype.toggleHandler_=function(){this.getHtmlElement().submit();return!0}})(jQuery);(function(a){a.pkp.controllers.form.FileUploadFormHandler=function(a,b){this.parent(a,b);if(void 0===b.readOnly||null===b.readOnly)void 0!==b.resetUploader&&(this.resetUploader_=b.resetUploader),void 0!==b.$preview&&b.$preview.length&&(this.$preview=b.$preview,this.bind("fileDeleted",this.callbackWrapper(this.fileDeleted))),this.attachUploader_(b.$uploader,b.uploaderOptions),this.uploaderSetup(b.$uploader)};a.pkp.classes.Helper.inherits(a.pkp.controllers.form.FileUploadFormHandler,a.pkp.controllers.form.AjaxFormHandler);
...
function(c){c.addClass("saveRowResponsePlaceholder");c=this.buildParamsFromInputs_(c.find(":input"));c.modify=!0;this.disableControls();a.ajax({url:this.getFetchRowUrl(),data:c,success:this.callbackWrapper(this.saveRowResponseHandler_,null),dataType:"json",async:!1})};a.pkp.controllers.listbuilder.ListbuilderHandler.prototype.getEmptyElement=function(a){return this.getHtmlElement().find(".empty")};a.pkp.controllers.listbuilder.ListbuilderHandler.prototype.addItemHandler_=function(c,b){this.availableOptions_&&
setTimeout(this.callbackWrapper(function(){this.closeEdits();this.disableControls();a.get(this.getFetchRowUrl(),{modify:!0},this.callbackWrapper(this.appendRowResponseHandler_,null),"json")}),0);return!1};a.pkp.controllers.listbuilder.ListbuilderHandler.prototype.deleteItemHandler_=function(c,b){this.closeEdits();var d=a(c),e=d.closest(".gridRow"),d=d.closest(".pkp_controllers_listbuilder").find(".deletions"),f=e.find('input[name="rowId"]').val();void 0!==f&&(d.val(d.val()+" "+f),this.getHtmlElement().trigger("formChange"));
this.deleteElement(e);this.availableOptions_=!0;return!1};a.pkp.controllers.listbuilder.ListbuilderHandler.prototype.appendRowResponseHandler_=function(c,b){var d=this.handleJson(b);!1!==d&&(d=a(d.content),this.getHtmlElement().find(".empty").hide().before(d),this.attachContentHandlers_(d),d.addClass("gridRowEdit"),d.find(":input").not('[type="hidden"]').first().focus(),this.sourceType_==a.pkp.cons.LISTBUILDER_SOURCE_TYPE_SELECT?(this.disableControls(),a.get(this.fetchOptionsUrl_,{},this.callbackWrapper(this.fetchOptionsResponseHandler_,
null),"json")):this.enableControls(),this.callFeaturesHook("addElement",d));return!1};a.pkp.controllers.listbuilder.ListbuilderHandler.prototype.fetchOptionsResponseHandler_=function(c,b){var d=this.handleJson(b),e=this.getHtmlElement(),f=[],h,l,m,k,u,t,n,q,s,v;if(!1!==d)for(e.find(".gridCellDisplay :input").each(function(c,b){f[c]=a(b).val()}),e=e.find(".gridRowEdit:visible .selectMenu:input"),h=0,l=e.length;h<l;h++){m=a(e[h]);k=m.parents(".gridCellContainer");u=0;m.children().empty();t=null;for(t in d.content[h])if(t!=
a.pkp.cons.LISTBUILDER_OPTGROUP_LABEL)if("object"==typeof d.content[h][t]){if(void 0!==d.content[h][a.pkp.cons.LISTBUILDER_OPTGROUP_LABEL]&&"object"==typeof d.content[h][a.pkp.cons.LISTBUILDER_OPTGROUP_LABEL]&&(q=d.content[h][a.pkp.cons.LISTBUILDER_OPTGROUP_LABEL][t])){s=a("<optgroup></optgroup>");s.attr("label",q);m.append(s);q=null;v=0;for(q in d.content[h][t])if(n=this.populatePulldown_(s,f,d.content[h][t][q],q))u++,v++;0===v&&s.remove()}}else(n=this.populatePulldown_(m,f,d.content[h][t],t))&&
u++;m=n;1===u&&m&&(m.attr("selected","selected"),this.availableOptions_=!1);0===u&&(k.find(".gridCellDisplay").show(),k.find(".gridCellEdit").hide())}this.enableControls();return!1};a.pkp.controllers.listbuilder.ListbuilderHandler.prototype.populatePulldown_=function(c,b,d,e){var f=c.parents(".gridCellContainer").find(".gridCellDisplay :input").val(),h=!1,l;if(e!=f)for(l=0;l<b.length;l++)b[l]==e&&(h=!0);if(h)return!1;b=a("<option/>");b.attr("value",e);b.text(d);e==f&&b.attr("selected","selected");
c.append(b);return b};a.pkp.controllers.listbuilder.ListbuilderHandler.prototype.editItemHandler_=function(c,b){this.closeEdits();this.editItemCallingContext_=c;setTimeout(this.callbackWrapper(function(){var c=a(this.editItemCallingContext_).closest(".gridRow");c.addClass("gridRowEdit");c.find(":input").not('[type="hidden"]').first().focus();this.sourceType_==a.pkp.cons.LISTBUILDER_SOURCE_TYPE_SELECT&&(this.disableControls(),a.get(this.fetchOptionsUrl_,{},this.callbackWrapper(this.fetchOptionsResponseHandler_,
...
!1):!0};a.pkp.controllers.listbuilder.ListbuilderHandler.prototype.inputBlurHandler_=function(c,b){a(c).closest(".gridRow").addClass("editingRowPlaceholder");setTimeout(this.callbackWrapper(function(){var c=a(".editingRowPlaceholder"),b=!1;c.find(":input").each(function(a,c){c===document.activeElement&&(b=!0)});c.removeClass("editingRowPlaceholder");b||this.closeEdits()}),0);return!0};a.pkp.controllers.listbuilder.ListbuilderHandler.prototype.saveRowResponseHandler_=function(c,b){var d=this.handleJson(b),
e;!1!==d&&(d=a(d.content),e=this.getHtmlElement().find(".saveRowResponsePlaceholder").attr("id"),this.getHtmlElement().find(".saveRowResponsePlaceholder").replaceWith(d),d.attr("id",e),this.attachContentHandlers_(d),this.callFeaturesHook("replaceElement",d));this.getHtmlElement().trigger("formChange");this.enableControls()};a.pkp.controllers.listbuilder.ListbuilderHandler.prototype.saveResponseHandler_=function(a,b){};a.pkp.controllers.listbuilder.ListbuilderHandler.prototype.attachContentHandlers_=
function(a){a.find(".gridCellDisplay").click(this.callbackWrapper(this.editItemHandler_));a.find(":input").keypress(this.callbackWrapper(this.inputKeystrokeHandler_)).blur(this.callbackWrapper(this.inputBlurHandler_));a.find(".pkp_linkaction_delete").click(this.callbackWrapper(this.deleteItemHandler_))};a.pkp.controllers.listbuilder.ListbuilderHandler.prototype.formSubmitHandler_=function(a,b){this.save();this.getHtmlElement().find(".gridRow :input").attr("disabled","disabled");return!0};a.pkp.controllers.listbuilder.ListbuilderHandler.prototype.formSubmittedHandler_=
...
function(a,b){var d=this,e=this.getHtmlElement(),f=e.find("form").first(),h;if(1==f.length&&(h={closePermitted:!0},f.trigger("containerClose",[h]),!h.closePermitted))return!1;e.removeClass("is_visible");this.trigger("pkpModalClose");setTimeout(function(){d.unbindPartial(e);e.empty();d.remove();"function"===typeof d.options.closeCallback&&d.options.closeCallback.call()},300);return!1};a.pkp.controllers.modal.ModalHandler.prototype.handleWrapperEvents=function(c,b){"click"==b.type&&c==b.target?a.pkp.classes.Handler.getHandler(a(c)).modalClose():
...
null;a.pkp.controllers.modals.editorDecision.form.EditorDecisionFormHandler.revisionsEmail_=null;a.pkp.controllers.modals.editorDecision.form.EditorDecisionFormHandler.resubmitEmail_=null;a.pkp.controllers.modals.editorDecision.form.EditorDecisionFormHandler.prototype.importPeerReviews=function(c,b){a.getJSON(this.peerReviewUrl_,this.callbackWrapper(this.insertPeerReviews));return!1};a.pkp.controllers.modals.editorDecision.form.EditorDecisionFormHandler.prototype.insertPeerReviews=function(c,b){var d=
this.handleJson(b),e=this.getHtmlElement(),e=a('textarea[id^="personalMessage"]',e),f=tinyMCE.get(e.attr("id")),h=f.getContent();!1!==d&&(h=e.val(),f.setContent(h+d.content+"<br>"));this.trigger("notifyUser",[this.getHtmlElement()])};a.pkp.controllers.modals.editorDecision.form.EditorDecisionFormHandler.prototype.toggleEmailDisplay=function(){var c=a("#sendReviews-emailContent"),b=this.getHtmlElement(),d=!1,e=!1;a("#skipEmail-send, #skipEmail-skip",b).each(function(){"skipEmail-send"===a(this).attr("id")&&
a(this).prop("checked")?d=!0:"skipEmail-skip"===a(this).attr("id")&&a(this).prop("checked")&&(d=!1)});b=a("#skipDiscussion-send, #skipDiscussion-skip",b);b.length&&b.each(function(){"skipDiscussion-send"===a(this).attr("id")&&a(this).prop("checked")?e=!0:"skipDiscussion-skip"===a(this).attr("id")&&a(this).prop("checked")&&(e=!1)});d||e?c.fadeIn():c.fadeOut()};a.pkp.controllers.modals.editorDecision.form.EditorDecisionFormHandler.prototype.toggleDecisionEmail=function(){var c="",b=a("#skipEmail-send").prop("checked"),
d=a("#sendReviews-emailContent"),e=a('textarea[id^="personalMessage"]').attr("id"),f=this;a('input[name="decision"]').each(function(){"decisionRevisions"===a(this).attr("id")&&a(this).prop("checked")?c=f.revisionsEmail_:"decisionResubmit"===a(this).attr("id")&&a(this).prop("checked")&&(c=f.resubmitEmail_)});tinyMCE.get(e).setContent(c);b&&d.hide().fadeIn()};a.pkp.controllers.modals.editorDecision.form.EditorDecisionFormHandler.prototype.setStep=function(c){var b=a('#promoteForm-step1, .promoteForm-step-btn[data-step="files"]'),
...
function(){this.getProgressIndicator().css("opacity",0)};a.pkp.controllers.wizard.WizardHandler.prototype.continueRequest=function(c,b){var d=new a.Event("wizardAdvanceRequested");this.getCurrentTab().children().first().trigger(d);d.isDefaultPrevented()||this.advanceOrClose_();return!1};a.pkp.controllers.wizard.WizardHandler.prototype.formValid=function(a,b){this.enableContinueButton()};a.pkp.controllers.wizard.WizardHandler.prototype.formInvalid=function(a,b){this.disableContinueButton()};a.pkp.controllers.wizard.WizardHandler.prototype.formSubmitted=
function(a,b){this.advanceOrClose_()};a.pkp.controllers.wizard.WizardHandler.prototype.cancelRequest=function(c,b){this.checkForm_(!1);var d=new a.Event("wizardCancelRequested");this.getCurrentTab().children().first().trigger(d);d.isDefaultPrevented()||this.trigger("wizardCancel");return!1};a.pkp.controllers.wizard.WizardHandler.prototype.wizardCancelRequested=function(a,b){return this.checkForm_(!0)?!1:!0};a.pkp.controllers.wizard.WizardHandler.prototype.wizardAdvanceRequested=function(a,b){var d=
this.getForm_();d&&(d.submit()&&(this.disableContinueButton(),this.showProgressIndicator_()),b.preventDefault())};a.pkp.controllers.wizard.WizardHandler.prototype.wizardAdvance=function(a,b){var d=this.getCurrentStep(),e=this.getNumberOfSteps()-1,f=d+1,h;if(f>e)throw Error("Trying to set an invalid wizard step!");h=this.getHtmlElement();h.tabs("enable",f);h.tabs("option","active",f);this.enforceLinear_&&h.tabs("disable",d);d=this.getContinueButton();f===e&&d.text(this.getFinishButtonText());this.hideProgressIndicator_();
...
this.handleJson(a.parseJSON(e.response));this.getHtmlElement();!1!==c&&(this.trigger("fileUploaded",c.uploadedFile),""!==c.content&&this.replaceWith(c.content));this.getHtmlElement().valid()};a.pkp.controllers.wizard.fileUpload.form.FileUploadFormHandler.prototype.handleRemovedFiles=function(a,b,d){this.trigger("filesRemoved",[b,d])};a.pkp.controllers.wizard.fileUpload.form.FileUploadFormHandler.prototype.submitForm=function(a,b){this.trigger("formSubmitted")};a.pkp.controllers.wizard.fileUpload.form.FileUploadFormHandler.prototype.revisedFileChange=
function(a,b){this.$revisedFileSelector_.val()?(this.$genreSelector.val(this.fileGenres_[this.$revisedFileSelector_.val()]),this.$genreSelector.attr("disabled","disabled")):this.$genreSelector.removeAttr("disabled");this.setUploaderVisibility_();return!1};a.pkp.controllers.wizard.fileUpload.form.FileUploadFormHandler.prototype.genreChange=function(a,b){this.setUploaderVisibility_()};a.pkp.controllers.wizard.fileUpload.form.FileUploadFormHandler.prototype.attachUploader_=function(a,b){a.pkpHandler("$.pkp.controllers.UploaderHandler",
...
function(a,b){var d=this.getHtmlElement();0<parseInt(d.find("#revisedFileId").val(),10)&&(d.submit(),b.preventDefault())};a.pkp.controllers.wizard.fileUpload.form.RevisionConfirmationHandler.prototype.handleResponse=function(a,b){!0===b.status&&this.trigger("fileUploaded",b.uploadedFile);return this.parent("handleResponse",a,b)}})(jQuery);(function(a){a.pkp.controllers.grid.filter=a.pkp.controllers.grid.filter||{form:{}};a.pkp.controllers.grid.filter.form.FilterFormHandler=function(c,b){this.parent(c,b);if(!0===b.noMoreTemplates||!0===b.filterTemplates)this.disableFormControls(),a(b.pulldownSelector).change(this.callbackWrapper(this.selectOptionHandler_)),b.filterTemplates&&this.bind("pkpRemoveHandler",this.removeHandler_);this.editFilterUrlTemplate_=b.editFilterUrlTemplate};a.pkp.classes.Helper.inherits(a.pkp.controllers.grid.filter.form.FilterFormHandler,
a.pkp.controllers.form.AjaxFormHandler);a.pkp.controllers.grid.filter.form.FilterFormHandler.prototype.editFilterUrlTemplate_=null;a.pkp.controllers.grid.filter.form.FilterFormHandler.prototype.selectOptionHandler_=function(c,b){a(c).hide();a.get(this.editFilterUrlTemplate_.replace("DUMMY_FILTER_TEMPLATE_ID",a(c).val()),this.callbackWrapper(this.getFilterForm_),"json")};a.pkp.controllers.grid.filter.form.FilterFormHandler.prototype.removeHandler_=function(a,b){this.unbind("pkpRemoveHandler",this.removeHandler_)};
a.pkp.controllers.grid.filter.form.FilterFormHandler.prototype.getFilterForm_=function(a,b){var d=this.handleJson(b);this.remove();this.replaceWith(d.content)}})(jQuery);(function(a){a.pkp.controllers.grid.navigationMenus=a.pkp.controllers.grid.navigationMenus||{form:{}};a.pkp.controllers.grid.navigationMenus.form.NavigationMenuFormHandler=function(a,b){this.okButton_=b.okButton;this.warningModalTitle_=b.warningModalTitle;this.submenuWarning_=b.submenuWarning;this.itemTypeConditionalWarnings_=b.itemTypeConditionalWarnings;a.on("click",".btnConditionalDisplay",this.callbackWrapper(this.showConditionalDisplayWarning));a.on("click",".btnSubmenuWarning",this.callbackWrapper(this.showSubmenuWarning));
...
c);a(this.getHtmlElement()).find(":checkbox").change()};a.pkp.controllers.grid.settings.metadata.MetadataGridHandler.prototype.checkboxHandler_=function(c,b){var d=a(c);d.is(":checked");var e=a(this.getHtmlElement());d.prop("name");this.getRows().each(function(){var c=a(this).prop("id").split("-").pop(),b=e.find(":checkbox[name="+c+"EnabledWorkflow]"),d=e.find(":checkbox[name="+c+"EnabledSubmission]"),c=e.find(":checkbox[name="+c+"Required]");(d.prop("checked")||c.prop("checked"))&&b.prop("checked",
!0);b.prop("readonly",d.prop("checked")||c.prop("checked"));c.prop("checked")&&d.prop("checked",!0);d.prop("readonly",c.prop("checked"))});return!1}})(jQuery);(function(a){a.pkp.controllers.tab=a.pkp.controllers.tab||{settings:{form:{}}};a.pkp.controllers.tab.settings.form.FileViewFormHandler=function(a,b){this.parent(a,b);this.fetchFileUrl_=b.fetchFileUrl;this.bind("dataChanged",this.refreshForm_)};a.pkp.classes.Helper.inherits(a.pkp.controllers.tab.settings.form.FileViewFormHandler,a.pkp.controllers.form.AjaxFormHandler);a.pkp.controllers.tab.settings.form.FileViewFormHandler.prototype.fetchFileUrl_=null;a.pkp.controllers.tab.settings.form.FileViewFormHandler.prototype.refreshForm_=
...
null;a.pkp.controllers.tab.settings.permissions.form.PermissionSettingsFormHandler.prototype.licenseURLSelectChange=function(a){a=this.getHtmlElement();var b=a.find("#licenseURLSelect");a.find('input[id^="licenseURL-"]').val(b.val())};a.pkp.controllers.tab.settings.permissions.form.PermissionSettingsFormHandler.prototype.licenseURLOtherChange=function(a){this.getHtmlElement().find("#licenseURLSelect").val("")};a.pkp.controllers.tab.settings.permissions.form.PermissionSettingsFormHandler.prototype.copyrightHolderRadioSelect=
function(c){var b=this.getHtmlElement();c=a(c);b=b.find('input[id^="copyrightHolderOther-"]');"other"===c.val()?b.removeAttr("disabled"):b.attr("disabled","disabled")};a.pkp.controllers.tab.settings.permissions.form.PermissionSettingsFormHandler.prototype.resetPermissionsHandler=function(c){confirm(this.resetPermissionsConfirmText)&&a.post(this.resetPermissionsUrl,{},function(){a("body").trigger("notifyUser")})}})(jQuery);(function(a){a.pkp.controllers.tab.settings.paymentMethod=a.pkp.controllers.tab.settings.paymentMethod||{};a.pkp.controllers.tab.settings.paymentMethod.PaymentMethodHandler=function(a,b){this.parent(a,b);this.paymentMethodFormUrlTemplate_=b.paymentMethodFormUrlTemplate;this.bind("selectPaymentMethod",this.selectPaymentMethodHandler)};a.pkp.classes.Helper.inherits(a.pkp.controllers.tab.settings.paymentMethod.PaymentMethodHandler,a.pkp.classes.Handler);a.pkp.controllers.tab.settings.paymentMethod.PaymentMethodHandler.prototype.paymentMethodFormUrlTemplate_=
...
function(c){c?a('[id^="allow"]').attr("checked","checked"):a('[id^="allow"]').removeAttr("checked")}})(jQuery);(function(a){a.pkp.controllers.tab.workflow=a.pkp.controllers.tab.workflow||{};a.pkp.controllers.tab.workflow.WorkflowTabHandler=function(a,b){var d,e,f,h;this.parent(a,b);if(d=document.location.toString().match("workflow/([^/]+)/"))for(d=d[1],h=a.find("li a"),f=0;f<h.length;f++)e=RegExp(d),h[f].getAttribute("class").match(e)&&(b.selected=f)};a.pkp.classes.Helper.inherits(a.pkp.controllers.tab.workflow.WorkflowTabHandler,a.pkp.controllers.TabHandler)})(jQuery);jQuery.pkp.controllers.informationCenter=jQuery.pkp.controllers.informationCenter||{};
...
function(c,b){var d,e={};d=a(this.timeFilterWrapperSelector_,this.getHtmlElement()).serializeArray();a.each(d,function(a,c){e[c.name]=c.value});a(".pkp_loading",this.getHtmlElement()).show();d=a("option:selected",this.$metricTypeSelectElement_);void 0!==d[0]&&void 0!==d[0].value&&(e.metricType=d[0].value);d=a("option:selected",this.$reportTemplateSelectElement_);void 0!==d[0]&&void 0!==d[0].value&&(e.reportTemplate=d[0].value);e.refreshForm=!0;a.get(this.fetchFormUrl_,e,this.callbackWrapper(this.handleResponse,
null),"json");return!1};a.pkp.controllers.statistics.ReportGeneratorFormHandler.prototype.updateFileTypeSelectHandler_=function(c,b){var d,e;d=a(c);d=a("option:selected",d);if(1==d.length)for(e in d=d[0].value,this.fileAssocTypes_)if(this.fileAssocTypes_[e]==d)return this.$fileTypeSelectElement_.removeAttr("disabled"),!1;this.$fileTypeSelectElement_.attr("disabled","disabled");return!1};a.pkp.controllers.statistics.ReportGeneratorFormHandler.prototype.fetchRegionHandler_=function(c,b){var d;this.$regionSelectElement_.empty();
d=a(c);d=a("option:selected",d);1==d.length&&(d=d[0].label,a.get(this.fetchRegionsUrl_,{countryId:d},this.callbackWrapper(this.updateRegionSelectCallback_,null),"json"));return!1};a.pkp.controllers.statistics.ReportGeneratorFormHandler.prototype.updateRegionSelectCallback_=function(c,b){var d,e,f,h;d=this.$regionSelectElement_;d.empty();e=this.handleJson(b);if(!1!==e)for(f=e.content,h=0,e=f.length;h<e;h++)d.append(a("<option />").val(f[h].id).text(f[h].name));return!1};a.pkp.controllers.statistics.ReportGeneratorFormHandler.prototype.currentTimeElementsClickHandler_=
function(a,b){this.dateRangeElementsWrapper_.hide();return!0};a.pkp.controllers.statistics.ReportGeneratorFormHandler.prototype.rangeTimeElementsClickHandler_=function(c,b){var d=a(this.startDayElementSelector_).add(this.endDayElementSelector_);this.dateRangeElementsWrapper_.show();"#"+a(c).attr("id")==this.rangeByDaySelector_&&d.show();"#"+a(c).attr("id")==this.rangeByMonthSelector_&&d.hide();return!0};a.pkp.controllers.statistics.ReportGeneratorFormHandler.prototype.aggregationOptionsChangeHandler_=
function(c,b){var d,e;e=a(this.columnsSelector_);d=a(c);e=e.find('option[value="'+d.attr("value")+'"]');d.is(":checked")?e.attr("selected","selected"):e.removeAttr("selected");return!1};a.pkp.controllers.statistics.ReportGeneratorFormHandler.prototype.addOptionalColumnsClass_=function(){var c,b,d,e;d=a(this.columnsSelector_);e=a(this.aggregationOptionsSelector_);b=a("#orderByFormArea select",this.getHtmlElement());d=d.add(b);b=this.optionalColumns_;for(c in b)d.find('option[value="'+c+'"]').addClass("optionalColumn"),
...
function(c,b){b.target.id==this.authorsGridContainer_&&a("#"+this.chaptersGridContainer_).find(".pkp_controllers_grid").trigger("dataChanged")}})(jQuery);(function(a){a.pkp.pages.workflow=a.pkp.pages.workflow||{};a.pkp.pages.workflow.WorkflowHandler=function(a,b){this.parent(a,b);this.bind("stageParticipantsChanged",this.handleStageParticipantsChanged_);this.bind("dataChanged",this.dataChangedHandler_)};a.pkp.classes.Helper.inherits(a.pkp.pages.workflow.WorkflowHandler,a.pkp.classes.Handler);a.pkp.pages.workflow.WorkflowHandler.prototype.handleStageParticipantsChanged_=function(c,b){var d,e,f,h,l=this.getHtmlElement().find(".editorDecisionActions"),
m=this.getHtmlElement().find("#submissionProgressBarDiv");this.getHtmlElement().find("#stageTabs").find("li").each(function(c){if(a(this).hasClass("ui-state-active")){e=a(this).find("a").attr("class");if(d=e.match(/stageId(\d)/))f=d[1],c=a.pkp.classes.Handler.getHandler(m),h=c.getSourceUrl(),c.setSourceUrl(h.replace(/stageId=\d/,"stageId="+f));return!1}});l.add(m).each(function(){a.pkp.classes.Handler.getHandler(a(this)).reload()})};a.pkp.pages.workflow.WorkflowHandler.prototype.dataChangedHandler_=
...
function(c){c=this.getHtmlElement().find("#reviewerSelectGridContainer").find('input[name="reviewerId"]:checked');var b=c.val(),d;b&&(d=a.trim(c.parent().next().children("span").text()),a("#reviewerId").val(b),a('[id^="selectedReviewerName"]',this.getHtmlElement()).html(d),a("#searchGridAndButton").hide(),a("#regularReviewerForm").show(),a('[name^="personalMessage"]').val().replace('<span class="" data-symbolic="reviewerName" contenteditable="false" data-mce-selected="1">{$reviewerName}</span>',d),
a("iframe[id^='personalMessage']").contents().find('[data-symbolic="reviewerName"]').each(function(){a(this).html(d);a(this).attr("class","");a(this).removeAttr("contenteditable")}))};a.pkp.controllers.grid.users.reviewer.AdvancedReviewerSearchHandler.prototype.handleRefresh_=function(a,b,d){d&&this.replaceWith(d)}})(jQuery);(function(a){a.pkp.controllers.grid.users.reviewer.form=a.pkp.controllers.grid.users.reviewer.form||{};a.pkp.controllers.grid.users.reviewer.form.EditReviewFormHandler=function(a,b){this.parent(a,b);a.change(this.callbackWrapper(this.handleFormChange));this.bind("urlInDivLoaded",this.handleFileListLoad_)};a.pkp.classes.Helper.inherits(a.pkp.controllers.grid.users.reviewer.form.EditReviewFormHandler,a.pkp.controllers.form.UserFormHandler);a.pkp.controllers.grid.users.reviewer.form.EditReviewFormHandler.prototype.handleFormChange=
...
function(a,b,d){this.getHtmlElement().change()}})(jQuery);(function(a){a.pkp.controllers.grid.users.reviewer.form.AddReviewerFormHandler=function(c,b){this.parent(c,b);b.templateUrl&&(this.templateUrl_=b.templateUrl);c.find("#templateLocale").change(this.callbackWrapper(this.selectLocaleHandler_));c.find(".template").change(this.callbackWrapper(this.selectTemplateHandler_));a('[name="firstName"]').keyup(this.callbackWrapper(this.addReviewerNameToMailEditor));a('[name="lastName"]').keyup(this.callbackWrapper(this.addReviewerNameToMailEditor))};a.pkp.classes.Helper.inherits(a.pkp.controllers.grid.users.reviewer.form.AddReviewerFormHandler,
a.pkp.controllers.grid.users.reviewer.form.EditReviewFormHandler);a.pkp.controllers.grid.users.reviewer.form.AddReviewerFormHandler.prototype.templateUrl_=null;a.pkp.controllers.grid.users.reviewer.form.AddReviewerFormHandler.prototype.showWarning=function(){this.parent("showWarning");this.getHtmlElement().find("#reviewerFormFooter").trigger("expandFileList")};a.pkp.controllers.grid.users.reviewer.form.AddReviewerFormHandler.prototype.selectTemplateHandler_=function(c,b){var d=this.getHtmlElement(),
e="#template_"+a("#templateLocale").val(),d=d.find(e+", #templateLocale").serialize();a.post(this.templateUrl_,d,this.callbackWrapper(this.updateTemplate),"json")};a.pkp.controllers.grid.users.reviewer.form.AddReviewerFormHandler.prototype.selectLocaleHandler_=function(c,b){var d=c.value;a(".template").hide();a("#template_"+d).removeClass("pkp_helpers_display_none").show();this.selectTemplateHandler_(c,b)};a.pkp.controllers.grid.users.reviewer.form.AddReviewerFormHandler.prototype.updateTemplate=
function(a,b){var d=this.getHtmlElement(),e=this.handleJson(b),f=b.content,d=d.find('textarea[name="personalMessage"]'),h=tinyMCE.EditorManager.get(d.attr("id"));d.attr("data-variables",JSON.stringify(f.variables));h.setContent(f.body);this.addReviewerNameToMailEditor();return e.status};a.pkp.controllers.grid.users.reviewer.form.AddReviewerFormHandler.prototype.addReviewerNameToMailEditor=function(){var c=a('[id^="selectedReviewerName"]').html();a('[name^="personalMessage"]').val().replace('<span class="" data-symbolic="reviewerName" contenteditable="false" data-mce-selected="1">{$reviewerName}</span>',
c);a("iframe[id^='personalMessage']").contents().find('[data-symbolic="reviewerName"]').each(function(){a(this).html(c);a(this).attr("class","");a(this).removeAttr("contenteditable")})}})(jQuery);(function(a){a.pkp.controllers.grid.users.stageParticipant=a.pkp.controllers.grid.users.stageParticipant||{};a.pkp.controllers.grid.users.stageParticipant.StageParticipantGridHandler=function(c,b){this.parent(c,b);this.bind("dataChanged",function(){this.refreshGridHandler();a("#submissionEditorDecisionsDiv,#copyeditingEditorDecisionsDiv,[id^=reviewDecisionsDiv").each(function(){a.pkp.classes.Handler.getHandler(a(this)).reload()})})};a.pkp.classes.Helper.inherits(a.pkp.controllers.grid.users.stageParticipant.StageParticipantGridHandler,
a.pkp.controllers.grid.CategoryGridHandler)})(jQuery);(function(a){a.pkp.controllers.grid.users.stageParticipant.form=a.pkp.controllers.grid.users.stageParticipant.form||{};a.pkp.controllers.grid.users.stageParticipant.form.StageParticipantNotifyHandler=function(c,b){this.parent(c,b);b.templateUrl&&(this.templateUrl_=b.templateUrl);b.possibleRecommendOnlyUserGroupIds&&(this.possibleRecommendOnlyUserGroupIds_=b.possibleRecommendOnlyUserGroupIds);b.recommendOnlyUserGroupIds&&(this.recommendOnlyUserGroupIds_=b.recommendOnlyUserGroupIds);a("input[name='userGroupId'], input[name='userIdSelected']",
c).change(this.callbackWrapper(this.updateRecommendOnly));c.find("#template").change(this.callbackWrapper(this.selectTemplateHandler_))};a.pkp.classes.Helper.inherits(a.pkp.controllers.grid.users.stageParticipant.form.StageParticipantNotifyHandler,a.pkp.controllers.form.AjaxFormHandler);a.pkp.controllers.grid.users.stageParticipant.form.StageParticipantNotifyHandler.prototype.templateUrl_=null;a.pkp.controllers.grid.users.stageParticipant.form.StageParticipantNotifyHandler.prototype.selectTemplateHandler_=
function(c,b){var d=this.getHtmlElement();a.post(this.templateUrl_,d.find("#template").serialize(),this.callbackWrapper(this.updateTemplate),"json")};a.pkp.controllers.grid.users.stageParticipant.form.StageParticipantNotifyHandler.prototype.updateTemplate=function(a,b){var d=this.getHtmlElement(),e=this.handleJson(b),f=b.content,d=d.find('textarea[name="message"]'),h=tinyMCE.EditorManager.get(d.attr("id"));f.variables&&d.attr("data-variables",JSON.stringify(f.variables));h.setContent(f.body);return e.status};
a.pkp.controllers.grid.users.stageParticipant.form.StageParticipantNotifyHandler.prototype.updateRecommendOnly=function(c,b){var d=this.getHtmlElement(),e=d.find("input[name='userGroupId']"),f=d.find("input[id^='recommendOnly']"),d=d.find(".recommendOnlyWrapper"),h=e.val();if("userGroupId"==a(c).prop("name"))f.attr("disabled","disabled"),f.removeAttr("checked"),d.hide();else if("userIdSelected"==a(c).prop("name")&&!d.is(":visible"))for(e=0;e<this.possibleRecommendOnlyUserGroupIds_.length;e++)if(this.possibleRecommendOnlyUserGroupIds_[e]==
h){f.removeAttr("disabled");d.show();for(e=0;e<this.recommendOnlyUserGroupIds_.length;e++)if(this.recommendOnlyUserGroupIds_[e]==h){f.prop("checked",!0);break}break}};a.pkp.controllers.grid.users.stageParticipant.form.StageParticipantNotifyHandler.prototype.handleResponse=function(c,b){a.pkp.classes.Handler.getHandler(a("#queriesGrid .pkp_controllers_grid")).trigger("dataChanged");return this.parent("handleResponse",c,b)}})(jQuery);(function(a){a.pkp.controllers.grid.users.stageParticipant.form.AddParticipantFormHandler=function(c,b){this.parent(c,b);a("select[name^='filterUserGroupId']",c).change(this.callbackWrapper(this.addUserGroupId));a("input[name='userId']").click(function(){var c=a("input[name='userId']:checked").val();a("input[name='userIdSelected']").val(c).trigger("change")});this.addUserGroupId()};a.pkp.classes.Helper.inherits(a.pkp.controllers.grid.users.stageParticipant.form.AddParticipantFormHandler,a.pkp.controllers.form.ClientFormHandler);
...
function(a,b){var d=this.handleJson(b),e=this.getHtmlElement(),f=e.find("li a"),h={},l=/galley(\d+)/,m,k,u;for(k=0;k<f.length;k++)u=f[k].getAttribute("id"),u=l.exec(u),null!==u&&(h[u[1]]=k);for(m in d.galleys)h.hasOwnProperty(m)||(f=this.tabContentUrl_+"&galleyId="+encodeURIComponent(m),f=f.replace(/[$]/g,"$$$$"),e.tabs("add",f,d.galleys[m]),e.find("li a").filter(":last").attr("id","galley"+m));for(m in h)d.galleys.hasOwnProperty(m)?e.find("li a").filter('[id="galley'+m+'"]').html(d.galleys[m]):e.tabs("remove",
h[m])};a.pkp.controllers.tab.issueEntry.IssueEntryTabHandler.prototype.addGalleysGridRowActionHandlers_=function(){var c=a('[id^="galleysGridContainer"]',this.getHtmlElement());c.length&&(c=a('a[id*="galleyTab"]',c),c.click(this.callbackWrapper(this.galleysGridLinkClickHandler_)))};a.pkp.controllers.tab.issueEntry.IssueEntryTabHandler.prototype.galleysGridLinkClickHandler_=function(c,b){var d=a('[id^="galleysGridContainer"]',this.getHtmlElement()).children("div"),d=a.pkp.classes.Handler.getHandler(d),
e=d.getParentRow(a(c)),d=d.getRowDataId(e);this.getHtmlElement().tabs({active:this.getTabPositionByGalleyId_(d,this.getHtmlElement())})};a.pkp.controllers.tab.issueEntry.IssueEntryTabHandler.prototype.getTabPositionByGalleyId_=function(c,b){var d=a("#galley"+c,b).parent("li");return d.length?b.find("li").index(d):null}})(jQuery);(function(a){a.pkp.controllers.tab.issueEntry.form=a.pkp.controllers.tab.issueEntry.form||{};a.pkp.controllers.tab.issueEntry.form.IssueEntryPublicationMetadataFormHandler=function(c,b){this.parent(c,b);a("#paymentReceivedButton",c).click(this.callbackWrapper(this.paymentReceivedHandler));a("#waivePaymentButton",c).click(this.callbackWrapper(this.waivePaymentHandler));b.arePermissionsAttached&&c.find("#attachPermissions").prop("checked",!0);a("#issueId",c).change(this.callbackWrapper(this.checkAttachMetadata));
...
function(a,b){var d=this.getHtmlElement();d.find('input[name="waivePublicationFee"]').val("1");d.find('input[name="markAsPaid"]').val("1");d.submit()};a.pkp.controllers.tab.issueEntry.form.IssueEntryPublicationMetadataFormHandler.prototype.waivePaymentHandler=function(a,b){var d=this.getHtmlElement();d.find('input[name="waivePublicationFee"]').val("1");d.submit()};a.pkp.controllers.tab.issueEntry.form.IssueEntryPublicationMetadataFormHandler.prototype.checkAttachMetadata=function(){this.getHtmlElement().find("#attachPermissions").prop("checked",
...
return this}})(jQuery);(function(a){a.pkp.classes.linkAction.OpenWindowPrintReviewsRequest=function(a,b){this.parent(a,b)};a.pkp.classes.Helper.inherits(a.pkp.classes.linkAction.OpenWindowPrintReviewsRequest,a.pkp.classes.linkAction.LinkActionRequest);a.pkp.classes.linkAction.OpenWindowPrintReviewsRequest.prototype.activate=function(a,b){var d=this.getOptions();window.open(d.url);return this.parent("activate",a,b)};a.pkp.classes.linkAction.OpenWindowPrintReviewsRequest.prototype.shouldDebounce=function(){return!1}})(jQuery);
