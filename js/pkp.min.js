...
a("#"+a.pkp.classes.Helper.escapeJQuerySelector(b.id));c.attr("readonly")&&(b.settings.readonly=!0);c.attr("wordCount")&&0<c.attr("wordCount")&&(b.settings.plugins+=",pkpwordcount",b.settings.statusbar=!0);c.attr("dir")&&(b.settings.directionality=c.attr("dir"));c=c.attr("rows")||10;b.settings.height=(20*c).toString()+"px";b.on("init",function(d){var e=a("#"+d.id);var f=a("#"+d.id).attr("placeholder");if(""!==f){var k=a("<span></span>");k.html(f);k.addClass("mcePlaceholder");k.attr("id","mcePlaceholder-"+
d.id);d.target.getContent().length&&k.hide();d=a("<div></div>");d.addClass("mcePlaceholderParent");e.wrap(d);e.parent().append(k)}});b.on("activate",function(d){a("#mcePlaceholder-"+d.id).hide()});b.on("deactivate",function(d){d.target.getContent().length||a("#mcePlaceholder-"+d.id).show();d.target.dom.addClass(d.target.dom.select("li"),"show")});b.on("BeforeSetContent",function(d){var e=a.pkp.classes.TinyMCEHelper.prototype.getVariableMap("#"+a.pkp.classes.Helper.escapeJQuerySelector(b.id));d.content=
d.content.replace(/\{\$([a-zA-Z]+)\}(?![^<]*>)/g,function(f,k,g,n){return void 0!==e[k]?a.pkp.classes.TinyMCEHelper.prototype.getVariableElement(k,e[k],"#"+b.id).html():f})});b.on("SaveContent",function(d){var e=a("<div>"+d.content+"</div>");e.find(".pkpTag").replaceWith(function(){return"{$"+a(this).attr("data-symbolic")+"}"});d.content=e.html()});b.on("FullscreenStateChanged init",function(d){d=d.target;var e=a(d.editorContainer);d.plugins.fullscreen&&(d.plugins.fullscreen.isFullscreen()?e.find(".mce-toolbar[role='menubar']").show():
e.find(".mce-toolbar[role='menubar']").hide())})};a.pkp.controllers.SiteHandler.prototype.getWindowDimensions=function(){return{height:a(window).height(),width:a(window).width()}};a.pkp.controllers.SiteHandler.prototype.redirectToUrl=function(b,c,d){window.location=d};a.pkp.controllers.SiteHandler.prototype.registerUnsavedFormElement_=function(b,c,d){b=a(d.target.lastElementChild).attr("id");-1==a.inArray(b,this.unsavedFormElements_)&&this.unsavedFormElements_.push(b)};a.pkp.controllers.SiteHandler.prototype.unregisterUnsavedFormElement_=
...
this.options.title+"</div>"):b.append('<div class="header"></div>');this.options.canClose&&b.append('<a href="#" class="close pkpModalCloseButton"><span :aria-hidden="true">\u00d7</span><span class="pkp_screen_reader">'+this.options.closeButtonText+"</span></a>");b.append('<div class="content"></div>');b.attr("role","dialog").attr("aria-label",this.options.title);return b};a.pkp.controllers.modal.ModalHandler.prototype.modalOpen=function(b){a("body").append(b);setTimeout(function(){b.addClass("is_visible")},
10);setTimeout(function(){b.focus()},300);b.trigger("pkpModalOpen",[b])};a.pkp.controllers.modal.ModalHandler.prototype.modalClose=function(b,c){var d=this,e=this.getHtmlElement();b=e.find("form").first();if(1==b.length&&(c={closePermitted:!0},b.trigger("containerClose",[c]),!c.closePermitted))return!1;e.removeClass("is_visible");this.trigger("pkpModalClose");setTimeout(function(){var f=d.options.closeCleanVueInstances,k;if(f.length)for(k=0;k<f.length;k++){var g=f[k];"undefined"!==typeof pkp.registry._instances[g]&&
(g=pkp.registry._instances[g],g.$destroy())}d.unbindPartial(e);e.empty();d.remove();"function"===typeof d.options.closeCallback&&d.options.closeCallback.call()},300);return!1};a.pkp.controllers.modal.ModalHandler.prototype.handleWrapperEvents=function(b,c){"click"==c.type&&b==c.target?a.pkp.classes.Handler.getHandler(a(b)).modalClose():"keyup"==c.type&&27==c.which&&a.pkp.classes.Handler.getHandler(a(b)).modalClose()};a.pkp.controllers.modal.ModalHandler.prototype.redirectNotifyUserEventHandler_=function(b,
