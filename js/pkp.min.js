...
this.dateRangeElementsWrapper_.hide();this.fetchArticlesUrl_=b.fetchArticlesUrl;this.$articleSelectElement_=a(b.articleSelectSelector,this.getHtmlElement());1==this.$articleSelectElement_.length&&(d=a(b.issueSelectSelector,this.getHtmlElement()),d.change(this.callbackWrapper(this.fetchArticleInfoHandler_)));this.fileAssocTypes_=b.fileAssocTypes;this.$fileTypeSelectElement_=a(b.fileTypeSelectSelector,this.getHtmlElement());d=a(b.objectTypeSelectSelector,this.getHtmlElement());1==this.$fileTypeSelectElement_.length&&
(this.$fileTypeSelectElement_.attr("disabled","true"),d.change(this.callbackWrapper(this.updateFileTypeSelectHandler_)));d.change();this.fetchRegionsUrl_=b.fetchRegionsUrl;this.$regionSelectElement_=a(b.regionSelectSelector,this.getHtmlElement());1==this.$regionSelectElement_.length&&(d=a(b.countrySelectSelector,this.getHtmlElement()),d.change(this.callbackWrapper(this.fetchRegionHandler_)))};a.pkp.classes.Helper.inherits(a.pkp.statistics.ReportGeneratorFormHandler,a.pkp.controllers.form.AjaxFormHandler);
a.pkp.statistics.ReportGeneratorFormHandler.prototype.fetchFormUrl_=null;a.pkp.statistics.ReportGeneratorFormHandler.prototype.fetchArticlesUrl_=null;a.pkp.statistics.ReportGeneratorFormHandler.prototype.$metricTypeSelectElement_={};a.pkp.statistics.ReportGeneratorFormHandler.prototype.$reportTemplateSelectElement_={};a.pkp.statistics.ReportGeneratorFormHandler.prototype.$articleSelectElement_={};a.pkp.statistics.ReportGeneratorFormHandler.prototype.$regionSelectElement_={};a.pkp.statistics.ReportGeneratorFormHandler.prototype.fetchRegionsUrl_=
null;a.pkp.statistics.ReportGeneratorFormHandler.prototype.$fileAssocTypes_={};a.pkp.statistics.ReportGeneratorFormHandler.prototype.rangeByDaySelector_=null;a.pkp.statistics.ReportGeneratorFormHandler.prototype.rangeByMonthSelector_=null;a.pkp.statistics.ReportGeneratorFormHandler.prototype.startDayElementSelector_=null;a.pkp.statistics.ReportGeneratorFormHandler.prototype.endDayElementSelector_=null;a.pkp.statistics.ReportGeneratorFormHandler.prototype.timeFilterWrapperSelector_=null;a.pkp.statistics.ReportGeneratorFormHandler.prototype.columnsSelector_=
...
function(c){var b,c=a(c),c=a("option:selected",c);if(1==c.length)for(b in c=c[0].value,this.fileAssocTypes_)if(this.fileAssocTypes_[b]==c)return this.$fileTypeSelectElement_.attr("disabled","false"),!1;this.$fileTypeSelectElement_.attr("disabled","true");return!1};a.pkp.statistics.ReportGeneratorFormHandler.prototype.fetchRegionHandler_=function(c){this.$regionSelectElement_.empty();c=a(c);c=a("option:selected",c);1==c.length&&(c=c[0].label,a.get(this.fetchRegionsUrl_,{countryId:c},this.callbackWrapper(this.updateRegionSelectCallback_,
null),"json"));return!1};a.pkp.statistics.ReportGeneratorFormHandler.prototype.updateRegionSelectCallback_=function(c,b){var d,e,f,g;d=this.$regionSelectElement_;d.empty();e=this.handleJson(b);if(!1!==e){f=e.content;g=0;for(e=f.length;g<e;g++)d.append(a("<option />").val(f[g].id).text(f[g].name))}return!1};a.pkp.statistics.ReportGeneratorFormHandler.prototype.currentTimeElementsClickHandler_=function(){this.dateRangeElementsWrapper_.hide()};a.pkp.statistics.ReportGeneratorFormHandler.prototype.rangeTimeElementsClickHandler_=
function(c){var b=a(this.startDayElementSelector_).add(this.endDayElementSelector_);this.dateRangeElementsWrapper_.show();"#"+a(c).attr("id")==this.rangeByDaySelector_&&b.show();"#"+a(c).attr("id")==this.rangeByMonthSelector_&&b.hide()};a.pkp.statistics.ReportGeneratorFormHandler.prototype.aggregationOptionsChangeHandler_=function(c){var b;b=a(this.columnsSelector_);c=a(c);b=b.find('option[value="'+c.attr("value")+'"]');c.attr("checked")?b.attr("selected","selected"):b.removeAttr("selected");return!1}})(jQuery);(function(a){a.pkp.plugins.generic.lucene=a.pkp.plugins.generic.lucene||{};a.pkp.plugins.generic.lucene.LuceneAutocompleteHandler=function(a,b){b.minLength=1;b.searchForm=b.searchForm||"searchForm";this.searchForm_=b.searchForm;this.parent(a,b)};a.pkp.classes.Helper.inherits(a.pkp.plugins.generic.lucene.LuceneAutocompleteHandler,a.pkp.controllers.AutocompleteHandler);a.pkp.plugins.generic.lucene.LuceneAutocompleteHandler.prototype.searchForm_="";a.pkp.plugins.generic.lucene.LuceneAutocompleteHandler.prototype.fetchAutocomplete=
