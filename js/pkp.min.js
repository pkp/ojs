...
arguments);var a=this.prop.apply(this,arguments);return a&&a.jquery||"string"===typeof a?a:this.attr.apply(this,arguments)};a.fn.ajaxSubmit=function(b){function c(e){function f(a){var b=null;try{a.contentWindow&&(b=a.contentWindow.document)}catch(c){d("cannot get iframe.contentWindow document: "+c)}if(b)return b;try{b=a.contentDocument?a.contentDocument:a.document}catch(e){d("cannot get iframe.contentDocument: "+e),b=a.document}return b}function g(){function b(){try{var a=f(n).readyState;d("state = "+
a);a&&"uninitialized"==a.toLowerCase()&&setTimeout(b,50)}catch(c){d("Server abort: ",c," (",c.name,")"),w(I),G&&clearTimeout(G),G=void 0}}var c=q.attr2("target"),e=q.attr2("action"),B=q.attr("enctype")||q.attr("encoding")||"multipart/form-data";i.setAttribute("target",y);(!m||/post/i.test(m))&&i.setAttribute("method","POST");e!=l.url&&i.setAttribute("action",l.url);!l.skipEncodingOverride&&(!m||/post/i.test(m))&&q.attr({encoding:"multipart/form-data",enctype:"multipart/form-data"});l.timeout&&(G=
setTimeout(function(){E=!0;w(O)},l.timeout));var h=[];try{if(l.extraData)for(var C in l.extraData)l.extraData.hasOwnProperty(C)&&(a.isPlainObject(l.extraData[C])&&l.extraData[C].hasOwnProperty("name")&&l.extraData[C].hasOwnProperty("value")?h.push(a('<input type="hidden" name="'+l.extraData[C].name+'">').val(l.extraData[C].value).appendTo(i)[0]):h.push(a('<input type="hidden" name="'+C+'">').val(l.extraData[C]).appendTo(i)[0]));l.iframeTarget||p.appendTo("body");n.attachEvent?n.attachEvent("onload",
w):n.addEventListener("load",w,!1);setTimeout(b,15);try{i.submit()}catch(z){document.createElement("form").submit.apply(i)}}finally{i.setAttribute("action",e),i.setAttribute("enctype",B),c?i.setAttribute("target",c):q.removeAttr("target"),a(h).remove()}}function w(b){if(!r.aborted&&!P)if(z=f(n),z||(d("cannot access response document"),b=I),b===O&&r)r.abort("timeout"),B.reject(r,"timeout");else if(b==I&&r)r.abort("server abort"),B.reject(r,"error","server abort");else if(z&&z.location.href!=l.iframeSrc||
E){n.detachEvent?n.detachEvent("onload",w):n.removeEventListener("load",w,!1);var b="success",c;try{if(E)throw"timeout";var e="xml"==l.dataType||z.XMLDocument||a.isXMLDoc(z);d("isXml="+e);if(!e&&(window.opera&&(null===z.body||!z.body.innerHTML))&&--T){d("requeing onLoad callback, DOM not available");setTimeout(w,250);return}var g=z.body?z.body:z.documentElement;r.responseText=g?g.innerHTML:null;r.responseXML=z.XMLDocument?z.XMLDocument:z;e&&(l.dataType="xml");r.getResponseHeader=function(a){return{"content-type":l.dataType}[a.toLowerCase()]};
g&&(r.status=Number(g.getAttribute("status"))||r.status,r.statusText=g.getAttribute("statusText")||r.statusText);var h=(l.dataType||"").toLowerCase(),j=/(json|script|text)/.test(h);if(j||l.textarea){var i=z.getElementsByTagName("textarea")[0];if(i)r.responseText=i.value,r.status=Number(i.getAttribute("status"))||r.status,r.statusText=i.getAttribute("statusText")||r.statusText;else if(j){var v=z.getElementsByTagName("pre")[0],m=z.getElementsByTagName("body")[0];v?r.responseText=v.textContent?v.textContent:
v.innerText:m&&(r.responseText=m.textContent?m.textContent:m.innerText)}}else"xml"==h&&(!r.responseXML&&r.responseText)&&(r.responseXML=t(r.responseText));try{var e=r,g=l,q=e.getResponseHeader("content-type")||"",y="xml"===h||!h&&0<=q.indexOf("xml"),x=y?e.responseXML:e.responseText;y&&"parsererror"===x.documentElement.nodeName&&a.error&&a.error("parsererror");g&&g.dataFilter&&(x=g.dataFilter(x,h));"string"===typeof x&&("json"===h||!h&&0<=q.indexOf("json")?x=A(x):("script"===h||!h&&0<=q.indexOf("javascript"))&&
...
[r,l,c]));k&&a.event.trigger("ajaxComplete",[r,l]);k&&!--a.active&&a.event.trigger("ajaxStop");l.complete&&l.complete.call(l.context,r,b);P=!0;l.timeout&&clearTimeout(G);setTimeout(function(){l.iframeTarget?p.attr("src",l.iframeSrc):p.remove();r.responseXML=null},100)}}var i=q[0],v,l,k,y,p,n,r,E,G,B=a.Deferred();B.abort=function(a){r.abort(a)};if(e)for(v=0;v<s.length;v++)e=a(s[v]),h?e.prop("disabled",!1):e.removeAttr("disabled");l=a.extend(!0,{},a.ajaxSettings,b);l.context=l.context||l;y="jqFormIO"+
(new Date).getTime();l.iframeTarget?(p=a(l.iframeTarget),(v=p.attr2("name"))?y=v:p.attr2("name",y)):(p=a('<iframe name="'+y+'" src="'+l.iframeSrc+'" />'),p.css({position:"absolute",top:"-1000px",left:"-1000px"}));n=p[0];r={aborted:0,responseText:null,responseXML:null,status:0,statusText:"n/a",getAllResponseHeaders:function(){},getResponseHeader:function(){},setRequestHeader:function(){},abort:function(b){var c="timeout"===b?"timeout":"aborted";d("aborting upload... "+c);this.aborted=1;try{n.contentWindow.document.execCommand&&
n.contentWindow.document.execCommand("Stop")}catch(e){}p.attr("src",l.iframeSrc);r.error=c;l.error&&l.error.call(l.context,r,c,b);k&&a.event.trigger("ajaxError",[r,l,c]);l.complete&&l.complete.call(l.context,r,c)}};(k=l.global)&&0===a.active++&&a.event.trigger("ajaxStart");k&&a.event.trigger("ajaxSend",[r,l]);if(l.beforeSend&&!1===l.beforeSend.call(l.context,r,l))return l.global&&a.active--,B.reject(),B;if(r.aborted)return B.reject(),B;if(e=i.clk)if((v=e.name)&&!e.disabled)l.extraData=l.extraData||
{},l.extraData[v]=e.value,"image"==e.type&&(l.extraData[v+".x"]=i.clk_x,l.extraData[v+".y"]=i.clk_y);var O=1,I=2,e=a("meta[name=csrf-token]").attr("content");if((v=a("meta[name=csrf-param]").attr("content"))&&e)l.extraData=l.extraData||{},l.extraData[v]=e;l.forceSync?g():setTimeout(g,10);var C,z,T=50,P,t=a.parseXML||function(a,b){window.ActiveXObject?(b=new ActiveXObject("Microsoft.XMLDOM"),b.async="false",b.loadXML(a)):b=(new DOMParser).parseFromString(a,"text/xml");return b&&b.documentElement&&
"parsererror"!=b.documentElement.nodeName?b:null},A=a.parseJSON||function(a){return window.eval("("+a+")")};return B}if(!this.length)return d("ajaxSubmit: skipping submit process - no element selected"),this;var m,k,q=this;"function"==typeof b?b={success:b}:void 0===b&&(b={});m=b.type||this.attr2("method");k=b.url||this.attr2("action");(k=(k="string"===typeof k?a.trim(k):"")||window.location.href||"")&&(k=(k.match(/^([^#]+)/)||[])[1]);b=a.extend(!0,{url:k,success:a.ajaxSettings.success,type:m||a.ajaxSettings.type,
iframeSrc:/^https/i.test(window.location.href||"")?"javascript:false":"about:blank"},b);k={};this.trigger("form-pre-serialize",[this,b,k]);if(k.veto)return d("ajaxSubmit: submit vetoed via form-pre-serialize trigger"),this;if(b.beforeSerialize&&!1===b.beforeSerialize(this,b))return d("ajaxSubmit: submit aborted via beforeSerialize callback"),this;var p=b.traditional;void 0===p&&(p=a.ajaxSettings.traditional);var s=[],n,t=this.formToArray(b.semantic,s);b.data&&(b.extraData=b.data,n=a.param(b.data,
p));if(b.beforeSubmit&&!1===b.beforeSubmit(t,this,b))return d("ajaxSubmit: submit aborted via beforeSubmit callback"),this;this.trigger("form-submit-validate",[t,this,b,k]);if(k.veto)return d("ajaxSubmit: submit vetoed via form-submit-validate trigger"),this;k=a.param(t,p);n&&(k=k?k+"&"+n:n);"GET"==b.type.toUpperCase()?(b.url+=(0<=b.url.indexOf("?")?"&":"?")+k,b.data=null):b.data=k;var u=[];b.resetForm&&u.push(function(){q.resetForm()});b.clearForm&&u.push(function(){q.clearForm(b.includeHidden)});
if(!b.dataType&&b.target){var g=b.success||function(){};u.push(function(c){var d=b.replaceTarget?"replaceWith":"html";a(b.target)[d](c).each(g,arguments)})}else b.success&&u.push(b.success);b.success=function(a,c,d){for(var e=b.context||this,f=0,g=u.length;f<g;f++)u[f].apply(e,[a,c,d||q,q])};if(b.error){var D=b.error;b.error=function(a,c,d){D.apply(b.context||this,[a,c,d,q])}}if(b.complete){var w=b.complete;b.complete=function(a,c){w.apply(b.context||this,[a,c,q])}}n=0<a("input[type=file]:enabled",
this).filter(function(){return""!==a(this).val()}).length;k="multipart/form-data"==q.attr("enctype")||"multipart/form-data"==q.attr("encoding");p=e&&f;d("fileAPI :"+p);var v;if(!1!==b.iframe&&(b.iframe||(n||k)&&!p))b.closeKeepAlive?a.get(b.closeKeepAlive,function(){v=c(t)}):v=c(t);else if((n||k)&&p){var l=new FormData;for(k=0;k<t.length;k++)l.append(t[k].name,t[k].value);if(b.extraData){k=a.param(b.extraData,b.traditional).split("&");p=k.length;n=[];var y,E;for(y=0;y<p;y++)k[y]=k[y].replace(/\+/g,
" "),E=k[y].split("="),n.push([decodeURIComponent(E[0]),decodeURIComponent(E[1])]);for(k=0;k<n.length;k++)n[k]&&l.append(n[k][0],n[k][1])}b.data=null;n=a.extend(!0,{},a.ajaxSettings,b,{contentType:!1,processData:!1,cache:!1,type:m||"POST"});b.uploadProgress&&(n.xhr=function(){var c=a.ajaxSettings.xhr();c.upload&&c.upload.addEventListener("progress",function(a){var c=0,d=a.loaded||a.position,e=a.total;a.lengthComputable&&(c=Math.ceil(100*(d/e)));b.uploadProgress(a,d,e,c)},!1);return c});n.data=null;
var A=n.beforeSend;n.beforeSend=function(a,c){c.data=b.formData?b.formData:l;A&&A.call(this,a,c)};v=a.ajax(n)}else v=a.ajax(b);q.removeData("jqxhr").data("jqxhr",v);for(n=0;n<s.length;n++)s[n]=null;this.trigger("form-submit-notify",[this,b]);return this};a.fn.ajaxForm=function(e){e=e||{};e.delegation=e.delegation&&a.isFunction(a.fn.on);if(!e.delegation&&0===this.length){var f=this.selector,h=this.context;if(!a.isReady&&f)return d("DOM not ready, queuing ajaxForm"),a(function(){a(f,h).ajaxForm(e)}),
...
c){var d=[];if(0===this.length)return d;var f=this[0],h=this.attr("id"),p=b?f.getElementsByTagName("*"):f.elements;p&&!/MSIE [678]/.test(navigator.userAgent)&&(p=a(p).get());h&&(h=a(':input[form="'+h+'"]').get(),h.length&&(p=(p||[]).concat(h)));if(!p||!p.length)return d;var s,n,t,u,g;s=0;for(g=p.length;s<g;s++)if(u=p[s],(h=u.name)&&!u.disabled)if(b&&f.clk&&"image"==u.type)f.clk==u&&(d.push({name:h,value:a(u).val(),type:u.type}),d.push({name:h+".x",value:f.clk_x},{name:h+".y",value:f.clk_y}));else if((t=
a.fieldValue(u,!0))&&t.constructor==Array){c&&c.push(u);n=0;for(u=t.length;n<u;n++)d.push({name:h,value:t[n]})}else if(e&&"file"==u.type)if(c&&c.push(u),t=u.files,t.length)for(n=0;n<t.length;n++)d.push({name:h,value:t[n],type:u.type});else d.push({name:h,value:"",type:u.type});else null!==t&&"undefined"!=typeof t&&(c&&c.push(u),d.push({name:h,value:t,type:u.type,required:u.required}));if(!b&&f.clk&&(p=a(f.clk),s=p[0],(h=s.name)&&!s.disabled&&"image"==s.type))d.push({name:h,value:p.val()}),d.push({name:h+
...
else b=a('<li class="selectBox-optgroup" />'),b.text(a(this).attr("label")),c.append(b),c=e(a(this),c)});return c};switch(c){case "inline":return d=a('<ul class="selectBox-options" />'),d=e(b,d),d.find("A").bind("mouseover.selectBox",function(){s(b,a(this).parent())}).bind("mouseout.selectBox",function(){n(b,a(this).parent())}).bind("mousedown.selectBox",function(a){a.preventDefault();b.selectBox("control").hasClass("selectBox-active")||b.selectBox("control").focus()}).bind("mouseup.selectBox",function(c){q();
...
c.screenY===d.data("selectBox-down-at-y")||(d.removeData("selectBox-down-at-x").removeData("selectBox-down-at-y"),p(b,a(this).parent()),q())}).bind("mouseover.selectBox",function(){s(b,a(this).parent())}).bind("mouseout.selectBox",function(){n(b,a(this).parent())});var f=b.attr("class")||"";if(""!==f){var f=f.split(" "),g;for(g in f)d.addClass(f[g]+"-selectBox-dropdown-menu")}D(d);return d}},j=function(b){return("selectBox-label "+(a(b).find("OPTION:selected").attr("class")||"")).replace(/\s+$/,"")},
i=function(b){return a(b).find("OPTION:selected").text()||"\u00a0"},m=function(b){var b=a(b),c=b.data("selectBox-control");c&&c.find(".selectBox-label").attr("class",j(b)).text(i(b))},k=function(b){var b=a(b),c=b.data("selectBox-control"),d=b.data("selectBox-settings"),e=c.data("selectBox-options");if(c.hasClass("selectBox-disabled"))return!1;q();var f=isNaN(c.css("borderBottomWidth"))?0:parseInt(c.css("borderBottomWidth"));e.width(c.innerWidth()).css({top:c.offset().top+c.outerHeight()-f,left:c.offset().left});
...
var g=0,h=[];b.attr("multiple")?e.find(".selectBox-selected A").each(function(){h[g++]=a(this).attr("rel")}):h=c.find("A").attr("rel");e.data("selectBox-last-selected",c);b.val()!==h&&(b.val(h),m(b),b.trigger("change"));return!0},s=function(b,c){b=a(b);c=a(c);b.data("selectBox-control").data("selectBox-options").find(".selectBox-hover").removeClass("selectBox-hover");c.addClass("selectBox-hover")},n=function(b,c){b=a(b);a(c);b.data("selectBox-control").data("selectBox-options").find(".selectBox-hover").removeClass("selectBox-hover")},
...
"inline",d=h(b,f),e.data("selectBox-options",d),f){case "inline":e.append(d);break;case "dropdown":m(b),a("BODY").append(d)}});break;case "value":if(void 0===c)return a(this).val();a(this).each(function(){var b,d=c;b=a(this);b.val(d);d=b.val();null===d&&(d=b.children().first().val(),b.val(d));var e=b.data("selectBox-control");if(e){var f=b.data("selectBox-settings"),e=e.data("selectBox-options");m(b);e.find(".selectBox-selected").removeClass("selectBox-selected");e.find("A").each(function(){if("object"===
...
g.some=g.any=function(a,b,c){for(var b=w(b,c),c=!x(a)&&g.keys(a),d=(c||a).length,e=0;e<d;e++){var f=c?c[e]:e;if(b(a[f],f,a))return!0}return!1};g.contains=g.includes=g.include=function(a,b,c,d){x(a)||(a=g.values(a));if("number"!=typeof c||d)c=0;return 0<=g.indexOf(a,b,c)};g.invoke=function(a,b){var c=m.call(arguments,2),d=g.isFunction(b);return g.map(a,function(a){var e=d?b:a[b];return null==e?e:e.apply(a,c)})};g.pluck=function(a,b){return g.map(a,g.property(b))};g.where=function(a,b){return g.filter(a,
...
d){if(c>d||void 0===c)return 1;if(c<d||void 0===d)return-1}return a.index-b.index}),"value")};var H=function(a){return function(b,c,d){var e={},c=w(c,d);g.each(b,function(d,f){var g=c(d,f,b);a(e,d,g)});return e}};g.groupBy=H(function(a,b,c){g.has(a,c)?a[c].push(b):a[c]=[b]});g.indexBy=H(function(a,b,c){a[c]=b});g.countBy=H(function(a,b,c){g.has(a,c)?a[c]++:a[c]=1});g.toArray=function(a){return!a?[]:g.isArray(a)?m.call(a):x(a)?g.map(a,g.identity):g.values(a)};g.size=function(a){return null==a?0:x(a)?
a.length:g.keys(a).length};g.partition=function(a,b,c){var b=w(b,c),d=[],e=[];g.each(a,function(a,c,f){(b(a,c,f)?d:e).push(a)});return[d,e]};g.first=g.head=g.take=function(a,b,c){return null==a?void 0:null==b||c?a[0]:g.initial(a,a.length-b)};g.initial=function(a,b,c){return m.call(a,0,Math.max(0,a.length-(null==b||c?1:b)))};g.last=function(a,b,c){return null==a?void 0:null==b||c?a[a.length-1]:g.rest(a,Math.max(0,a.length-b))};g.rest=g.tail=g.drop=function(a,b,c){return m.call(a,null==b||c?1:b)};g.compact=
function(a){return g.filter(a,g.identity)};var F=function(a,b,c,d){for(var e=[],f=0,d=d||0,h=A(a);d<h;d++){var i=a[d];if(x(i)&&(g.isArray(i)||g.isArguments(i))){b||(i=F(i,b,c));var j=0,k=i.length;for(e.length+=k;j<k;)e[f++]=i[j++]}else c||(e[f++]=i)}return e};g.flatten=function(a,b){return F(a,b,!1)};g.without=function(a){return g.difference(a,m.call(arguments,1))};g.uniq=g.unique=function(a,b,c,d){g.isBoolean(b)||(d=c,c=b,b=!1);null!=c&&(c=w(c,d));for(var d=[],e=[],f=0,h=A(a);f<h;f++){var i=a[f],
...
c||1,b=Math.max(Math.ceil((b-a)/c),0),d=Array(b),e=0;e<b;e++,a+=c)d[e]=a;return d};var M=function(a,b,c,d,e){if(!(d instanceof b))return a.apply(c,e);b=l(a.prototype);a=a.apply(b,e);return g.isObject(a)?a:b};g.bind=function(a,b){if(n&&a.bind===n)return n.apply(a,m.call(arguments,1));if(!g.isFunction(a))throw new TypeError("Bind must be called on a function");var c=m.call(arguments,2),d=function(){return M(a,d,b,this,c.concat(m.call(arguments)))};return d};g.partial=function(a){var b=m.call(arguments,
...
{};return c};g.delay=function(a,b){var c=m.call(arguments,2);return setTimeout(function(){return a.apply(null,c)},b)};g.defer=g.partial(g.delay,g,1);g.throttle=function(a,b,c){var d,e,f,h=null,i=0;c||(c={});var j=function(){i=!1===c.leading?0:g.now();h=null;f=a.apply(d,e);h||(d=e=null)};return function(){var k=g.now();!i&&!1===c.leading&&(i=k);var l=b-(k-i);d=this;e=arguments;0>=l||l>b?(h&&(clearTimeout(h),h=null),i=k,f=a.apply(d,e),h||(d=e=null)):!h&&!1!==c.trailing&&(h=setTimeout(j,l));return f}};
...
this.$linkActionElement.focus();this.$modal_.remove();return this.parent("finish")}})(jQuery);(function(a){a.pkp.classes.notification=a.pkp.classes.notification||{};a.pkp.classes.notification.NotificationHelper=function(){};a.pkp.classes.notification.NotificationHelper.redirectNotifyUserEvent=function(b,c){var d,e,f,h,j,i,m,k,q,p,s;if(void 0!==c.content)b.getHtmlElement().parent().trigger("notifyUser",[c]);else{d=b.getHtmlElement();e=!1;!(b instanceof a.pkp.controllers.SiteHandler)&&0<a(c).parents(".pkp_controllers_grid").length&&(d.parent().trigger("notifyUser"),e=!0);d=a(".pkp_notification",
d);f=[];h=0;for(j=d.length;h<j;h++)if(m=a(d[h]),!(0<m.parents(":hidden").length)){i=m.parents();q=0;for(p=i.length;q<p;q++)if(k=a(i[q]).data("pkp.handler"),k instanceof a.pkp.classes.Handler){s=a(i[q]);break}if(s.has(c[0]).length||s[0]===c[0]){if(0<m.parents(".ui-accordion:first").length&&(i=m.parents(".ui-accordion:first"),!i.has(c[0])))continue;f.push(m)}}if(f.length)for(h=f.length-1;-1<h;h--)f[h].triggerHandler("notifyUser");else e||b.getHtmlElement().parent().trigger("notifyUser")}}})(jQuery);(function(a){a.pkp.classes.features=a.pkp.classes.features||{};a.pkp.classes.features.Feature=function(a,c){this.gridHandler=a;this.options_=c;this.addFeatureHtml(this.getGridHtmlElement(),c)};a.pkp.classes.features.Feature.prototype.gridHandler=null;a.pkp.classes.features.Feature.prototype.options_=null;a.pkp.classes.features.Feature.prototype.setOptions=function(a){this.options_=a};a.pkp.classes.features.Feature.prototype.getOptions=function(){return this.options_};a.pkp.classes.features.Feature.prototype.init=
...
function(a){a.children().after(this.getSequenceInput_());a=this.gridHandler.getRows();this.storeOrder(a)}})(jQuery);(function(a){a.pkp.classes.features.OrderMultipleListsItemsFeature=function(a,c){this.parent(a,c)};a.pkp.classes.Helper.inherits(a.pkp.classes.features.OrderMultipleListsItemsFeature,a.pkp.classes.features.OrderListbuilderItemsFeature);a.pkp.classes.features.OrderMultipleListsItemsFeature.prototype.addFeatureHtml=function(b,c){var d,e,f,h,j,i,m;this.parent("addFeatureHtml",b,c);d=a('<input type="hidden" name="newRowId[listId]" class="itemList" />');e=this.gridHandler.getRows();f=0;for(h=e.length;f<
h;f++)j=a(e[f]),i=this.gridHandler.getListIdByRow(j),m=d.clone(),m.attr("value",i),a("td.first_column",j).append(m)};a.pkp.classes.features.OrderMultipleListsItemsFeature.prototype.storeRowOrder=function(a,c){var d,e;this.parent("storeRowOrder",a,c);d=c.find(".itemList");e=this.gridHandler.getListIdByRow(c);d.attr("value",e)};a.pkp.classes.features.OrderMultipleListsItemsFeature.prototype.setupSortablePlugin=function(){var a=this.gridHandler.getLists().find("tbody");this.applySortPlgOnElements(a,
...
function(){this.getHtmlElement().find(".formButtons .pkp_spinner").removeClass("is_visible")};a.pkp.controllers.form.FormHandler.prototype.toggleEditableControl=function(b,c){c.preventDefault();var d=a(b).parents('[data-pkp-editable="true"]');d.length&&d.toggleClass("isEditing")};a.pkp.controllers.form.FormHandler.prototype.submitHandler_=function(b,c){var d=!1;a(c).find(".formWidget").each(function(){var b=new a.Event("formSubmitRequested");d||(a(this).trigger(b),d=b.isDefaultPrevented())});d||(a(c).find(".datepicker").each(function(){""===
...
null),"json")):this.enableControls(),this.callFeaturesHook("addElement",d));return!1};a.pkp.controllers.listbuilder.ListbuilderHandler.prototype.fetchOptionsResponseHandler_=function(b,c){var d=this.handleJson(c),e=this.getHtmlElement(),f=[],h,j,i,m,k,q,p,s,n,t;if(!1!==d){e.find(".gridCellDisplay :input").each(function(b,c){f[b]=a(c).val()});e=e.find(".gridRowEdit:visible .selectMenu:input");h=0;for(j=e.length;h<j;h++){i=a(e[h]);m=i.parents(".gridCellContainer");k=0;i.children().empty();q=null;for(q in d.content[h])if(q!=
a.pkp.cons.LISTBUILDER_OPTGROUP_LABEL)if("object"==typeof d.content[h][q]){if(void 0!==d.content[h][a.pkp.cons.LISTBUILDER_OPTGROUP_LABEL]&&"object"==typeof d.content[h][a.pkp.cons.LISTBUILDER_OPTGROUP_LABEL]&&(s=d.content[h][a.pkp.cons.LISTBUILDER_OPTGROUP_LABEL][q])){n=a("<optgroup></optgroup>");n.attr("label",s);i.append(n);s=null;t=0;for(s in d.content[h][q])if(p=this.populatePulldown_(n,f,d.content[h][q][s],s))k++,t++;0===t&&n.remove()}}else(p=this.populatePulldown_(i,f,d.content[h][q],q))&&
k++;i=p;1===k&&i&&(i.attr("selected","selected"),this.availableOptions_=!1);0===k&&(m.find(".gridCellDisplay").show(),m.find(".gridCellEdit").hide())}}this.enableControls();return!1};a.pkp.controllers.listbuilder.ListbuilderHandler.prototype.populatePulldown_=function(b,c,d,e){var f=b.parents(".gridCellContainer").find(".gridCellDisplay :input").val(),h=!1,j;if(e!=f)for(j=0;j<c.length;j++)c[j]==e&&(h=!0);if(h)return!1;c=a("<option/>");c.attr("value",e);c.text(d);e==f&&c.attr("selected","selected");
...
function(a,c){var d=this.handleJson(c),e=this.getHtmlElement(),f=e.find("li a"),h={},j=/galley(\d+)/,i,m,k;for(m=0;m<f.length;m++)k=f[m].getAttribute("id"),k=j.exec(k),null!==k&&(h[k[1]]=m);for(i in d.galleys)h.hasOwnProperty(i)||(f=this.tabContentUrl_+"&galleyId="+encodeURIComponent(i),f=f.replace(/[$]/g,"$$$$"),e.tabs("add",f,d.galleys[i]),e.find("li a").filter(":last").attr("id","galley"+i));for(i in h)d.galleys.hasOwnProperty(i)?e.find("li a").filter('[id="galley'+i+'"]').html(d.galleys[i]):e.tabs("remove",
