...
this.bind("pkpRemoveScrollingObserver",this.callbackWrapper(this.unregisterScrollingObserver_));this.outsideClickChecks_={}};a.pkp.classes.Helper.inherits(a.pkp.controllers.SiteHandler,a.pkp.classes.Handler);a.pkp.controllers.SiteHandler.prototype.helpContext_=null;a.pkp.controllers.SiteHandler.prototype.options_=null;a.pkp.controllers.SiteHandler.prototype.outsideClickChecks_=null;a.pkp.controllers.SiteHandler.prototype.unsavedFormElements_=null;a.pkp.controllers.SiteHandler.prototype.triggerTinyMCEInitialized=
function(c){a("#"+c.id).trigger("tinyMCEInitialized",[c])};a.pkp.controllers.SiteHandler.prototype.triggerTinyMCESetup=function(c){var b=a("#"+c.id);b.attr("readonly")&&(c.settings.readonly=!0);b=b.attr("rows")||10;c.settings.height=(20*b).toString()+"px";c.on("init",function(c){var b=a("#"+c.id),f;f=a("#"+c.id).attr("placeholder");""!==f&&(f=a("<span></span>").html(f),f.addClass("mcePlaceholder"),f.attr("id","mcePlaceholder-"+c.id),c.target.getContent().length&&f.hide(),c=a("<div></div>"),c.addClass("mcePlaceholderParent"),
b.wrap(c),b.parent().append(f))});c.on("activate",function(c){a("#mcePlaceholder-"+c.id).hide()});c.on("deactivate",function(c){c.target.getContent().length||a("#mcePlaceholder-"+c.id).show();c.target.dom.addClass(c.target.dom.select("li"),"show")});c.on("BeforeSetContent",function(b){var e=a.pkp.classes.TinyMCEHelper.prototype.getVariableMap("#"+c.id);b.content=b.content.replace(/\{\$([a-zA-Z]+)\}(?![^<]*>)/g,function(c,b){return void 0!==e[b]?a.pkp.classes.TinyMCEHelper.prototype.getVariableElement(b,
e[b]).html():c})});c.on("SaveContent",function(c){var b=a("<div>"+c.content+"</div>");b.find(".pkpTag").replaceWith(function(){return"{$"+a(this).attr("data-symbolic")+"}"});c.content=b.html()});c.on("FullscreenStateChanged init",function(c){var c=c.target,b=a(c.editorContainer);c.plugins.fullscreen&&(c.plugins.fullscreen.isFullscreen()?b.find(".mce-toolbar[role='menubar']").show():b.find(".mce-toolbar[role='menubar']").hide())})};a.pkp.controllers.SiteHandler.prototype.getWindowDimensions=function(){return{height:a(window).height(),
...
showErrors:this.callbackWrapper(this.showErrors)});a("[id^='cancelFormButton-']",c).click(this.callbackWrapper(this.cancelForm));c.find(".showMore, .showLess").bind("click",this.switchViz);d.checkForm()?this.trigger("formValid"):this.trigger("formInvalid");a(".pkpEditableToggle",c).click(this.callbackWrapper(this.toggleEditableControl));this.initializeTinyMCE();a("[id^='submitFormButton']",c).click(this.callbackWrapper(this.pushTinyMCEChanges_));a(":input",c).change(this.callbackWrapper(this.formChange));
this.bind("formChange",this.callbackWrapper(this.formChange));c.click(this.callbackWrapper(this.hideDatepicker_));this.publishEvent("tinyMCEInitialized");this.bind("tinyMCEInitialized",this.tinyMCEInitHandler_);this.bind("containerClose",this.containerCloseHandler)};a.pkp.classes.Helper.inherits(a.pkp.controllers.form.FormHandler,a.pkp.classes.Handler);a.pkp.controllers.form.FormHandler.prototype.disableControlsOnSubmit=!1;a.pkp.controllers.form.FormHandler.prototype.trackFormChanges=!0;a.pkp.controllers.form.FormHandler.prototype.callerSubmitHandler_=
null;a.pkp.controllers.form.FormHandler.prototype.cancelRedirectUrl_=null;a.pkp.controllers.form.FormHandler.prototype.formChangesTracked=!1;a.pkp.controllers.form.FormHandler.prototype.enableDisablePairs_=null;a.pkp.controllers.form.FormHandler.prototype.showErrors=function(c){"undefined"!==typeof tinyMCE&&tinyMCE.EditorManager.triggerSave();var b=a.extend(!0,{},c);setTimeout(this.callbackWrapper(function(){b.defaultShowErrors();b=null}),250);c.checkForm()?this.trigger("formValid"):(this.trigger("formInvalid"),
...
this.getHtmlElement(),b=a("#"+e,c);c.validate().element(b)}))};a.pkp.controllers.form.FormHandler.prototype.containerCloseHandler=function(c,b,d){a(this.getHtmlElement()).find(".hasDatepicker").datepicker("hide");if(this.formChangesTracked)if(confirm(a.pkp.locale.form_dataHasChanged))this.trigger("unregisterAllForms");else return d.closePermitted=!1;"undefined"!==typeof d&&(d.closePermitted=!0);return!0};a.pkp.controllers.form.FormHandler.prototype.onFocusOutValidation_=function(c,b){var d=this.getHtmlElement();
a(b).parents("#"+d.attr("id")).length&&c.element(b);return!0};a.pkp.controllers.form.FormHandler.prototype.hideDatepicker_=function(c,b){var d,e;d=b.originalEvent.target;e=this.getHtmlElement();!a(d).hasClass("hasDatepicker")&&(!a(d).hasClass("ui-datepicker")&&!a(d).hasClass("ui-icon")&&!a(d).hasClass("ui-datepicker-next")&&!a(d).hasClass("ui-datepicker-prev")&&!a(d).parent().parents(".ui-datepicker").length)&&a(e).find(".hasDatepicker").datepicker("hide")};a.pkp.controllers.form.FormHandler.prototype.showSpinner_=
...
e.tabs("enable",d);e.tabs("option","active",d);0===a&&e.tabs("disable",a);d===b&&(a=this.getContinueButton(),a.text(this.getFinishButtonText()),this.enableContinueButton())};a.pkp.controllers.wizard.fileUpload.FileUploadWizardHandler.prototype.tabsLoad=function(c,b,d){var e=this.getHtmlElement(),f=this.getProgressIndicator();if(2===d.tab.index()){e=a("#newFile",e);if(1!==e.length)throw Error('Did not find "new file" button!');e.bind("click",this.callbackWrapper(this.startWizard))}f.hide();return this.parent("tabsLoad",
c,b,d)};a.pkp.controllers.wizard.fileUpload.FileUploadWizardHandler.prototype.formValid=function(a,b){0===this.getCurrentStep()&&0===this.getHtmlElement().find("#uploadConfirmationForm").length&&!this.uploadedFile_||this.parent("formValid",a,b)};a.pkp.controllers.wizard.fileUpload.FileUploadWizardHandler.prototype.wizardCancelRequested=function(c,b){if(this.parent("wizardCancelRequested",c,b))if(this.uploadedFile_)a.post(this.deleteUrl_,this.uploadedFile_,a.pkp.classes.Helper.curry(this.wizardCancelSuccess,
...
d+'-addFile-button-"]').click()},0)}})(jQuery);(function(a){a.pkp.controllers.tab.issueEntry=a.pkp.controllers.tab.issueEntry||{};a.pkp.controllers.tab.issueEntry.IssueEntryTabHandler=function(a,b){b.selectedGalleyId&&(b.selected=this.getTabPositionByGalleyId_(b.selectedGalleyId,a));this.parent(a,b);this.bind("gridRefreshRequested",this.gridRefreshRequested);b.tabsUrl&&(this.tabsUrl_=b.tabsUrl);b.tabContentUrl&&(this.tabContentUrl_=b.tabContentUrl);this.bind("gridInitialized",this.addGalleysGridRowActionHandlers_);this.publishEvent("gridInitialized")};
