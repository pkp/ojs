...
a("#regularReviewerForm").show();var e=a('#reviewerFormFooter [name="personalMessage"]');if(!e.val()){b=a('#reviewerFormFooter input[name="template"]');var f=a('#reviewerFormFooter select[name="template"]');var k=tinyMCE.EditorManager.get(e.attr("id"));e="";if(c.lastRoundReviewerIds.includes(d.id)){e="REVIEW_REQUEST_SUBSEQUENT";var g=c.reviewerMessages[e];k.setContent(g);b.val(e);f.find('[value="REVIEW_REQUEST"]').remove()}else e="REVIEW_REQUEST",g=c.reviewerMessages[e],k.setContent(g),b.val(e),f.find('[value="REVIEW_REQUEST_SUBSEQUENT"]').remove();
