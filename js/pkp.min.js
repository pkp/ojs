...
function(){if("undefined"!==typeof tinyMCE){tinyMCE.PluginManager.load("pkpTags",a.pkp.app.baseUrl+"/plugins/generic/tinymce/plugins/pkpTags/plugin.js");tinyMCE.PluginManager.load("pkpwordcount",a.pkp.app.baseUrl+"/plugins/generic/tinymce/plugins/pkpWordcount/plugin.js");var c;c={width:"100%",resize:"both",entity_encoding:"raw",plugins:"paste,fullscreen,link,lists,code,image,-pkpTags,noneditable",convert_urls:!1,forced_root_block:"p",images_upload_handler:function(c,d,e){var f=new FormData;f.append("file",
c.blob(),c.filename());a.ajax({method:"POST",url:a.pkp.app.publicFileApiUrl,data:f,processData:!1,contentType:!1,headers:{"X-Csrf-Token":a.pkp.currentUser.csrfToken},success:function(a){d(a.url)},error:function(a){e(a.responseJSON.errorMessage)}})},paste_auto_cleanup_on_paste:!0,apply_source_formatting:!1,theme:"modern",toolbar:"copy paste | bold italic underline | link unlink | image | code fullscreen | pkpTags",richToolbar:"copy paste | bold italic underline | bullist numlist | superscript subscript | image | link unlink code fullscreen | pkpTags",
statusbar:!1,content_css:a.pkp.app.baseUrl+"/plugins/generic/tinymce/styles/content.css"};c="undefined"!==typeof a.pkp.plugins.tinymceplugin&&typeof a.pkp.plugins.tinymceplugin.tinymceParams?a.extend({},c,a.pkp.plugins.tinymceplugin.tinymceParams):a.extend({},c);c.init_instance_callback=a.pkp.controllers.SiteHandler.prototype.triggerTinyMCEInitialized;c.setup=a.pkp.controllers.SiteHandler.prototype.triggerTinyMCESetup;tinyMCE.init(c)}};a.pkp.controllers.SiteHandler.prototype.triggerTinyMCEInitialized=
function(c){a("#"+a.pkp.classes.Helper.escapeJQuerySelector(c.id)).trigger("tinyMCEInitialized",[c])};a.pkp.controllers.SiteHandler.prototype.triggerTinyMCESetup=function(c){var b=a("#"+a.pkp.classes.Helper.escapeJQuerySelector(c.id));b.attr("readonly")&&(c.settings.readonly=!0);b.attr("wordCount")&&0<b.attr("wordCount")&&(c.settings.plugins+=",pkpwordcount",c.settings.statusbar=!0);b=b.attr("rows")||10;c.settings.height=(20*b).toString()+"px";c.on("init",function(c){var b=a("#"+c.id),f,h;f=a("#"+
c.id).attr("placeholder");""!==f&&(h=a("<span></span>"),h.html(f),h.addClass("mcePlaceholder"),h.attr("id","mcePlaceholder-"+c.id),c.target.getContent().length&&h.hide(),c=a("<div></div>"),c.addClass("mcePlaceholderParent"),b.wrap(c),b.parent().append(h))});c.on("activate",function(c){a("#mcePlaceholder-"+c.id).hide()});c.on("deactivate",function(c){c.target.getContent().length||a("#mcePlaceholder-"+c.id).show();c.target.dom.addClass(c.target.dom.select("li"),"show")});c.on("BeforeSetContent",function(b){var e=
a.pkp.classes.TinyMCEHelper.prototype.getVariableMap("#"+a.pkp.classes.Helper.escapeJQuerySelector(c.id));b.content=b.content.replace(/\{\$([a-zA-Z]+)\}(?![^<]*>)/g,function(b,d){return void 0!==e[d]?a.pkp.classes.TinyMCEHelper.prototype.getVariableElement(d,e[d],"#"+c.id).html():b})});c.on("SaveContent",function(c){var b=a("<div>"+c.content+"</div>");b.find(".pkpTag").replaceWith(function(){return"{$"+a(this).attr("data-symbolic")+"}"});c.content=b.html()});c.on("FullscreenStateChanged init",function(c){var c=
