...
{modalId:this.uniqueModalId});setTimeout(function(){d.modalClose()},1500)}}})(jQuery);(function(a){a.pkp.controllers.modal.ConfirmationModalHandler=function(b,c){this.dialogProps={title:c.title,message:c.dialogText,actions:[],closeLegacyHandler:this.callbackWrapper(this.modalClose)};c.okButton&&this.dialogProps.actions.push({label:c.okButton,callback:this.callbackWrapper(this.modalConfirm)});c.cancelButton&&this.dialogProps.actions.push({label:c.cancelButton,isWarnable:!0,callback:this.callbackWrapper(this.modalClose)});this.parent(b,c);this.callback_=c.callback||null;this.callbackArgs_=
c.callbackArgs||null;b.find(".pkpModalConfirmButton").on("click",this.callbackWrapper(this.modalConfirm))};a.pkp.classes.Helper.inherits(a.pkp.controllers.modal.ConfirmationModalHandler,a.pkp.controllers.modal.ModalHandler);a.pkp.controllers.modal.ConfirmationModalHandler.prototype.callback_=null;a.pkp.controllers.modal.ConfirmationModalHandler.prototype.callbackArgs_=null;a.pkp.controllers.modal.ConfirmationModalHandler.prototype.checkOptions=function(b){return this.parent("checkOptions",b)?"string"===
typeof b.okButton&&(!1===b.cancelButton||"string"===typeof b.cancelButton)&&"string"===typeof b.dialogText:!1};a.pkp.controllers.modal.ConfirmationModalHandler.prototype.modalOpen=function(b){this.parent("modalOpen",b);pkp.eventBus.$emit("open-dialog-vue",{dialogProps:this.dialogProps})};a.pkp.controllers.modal.ConfirmationModalHandler.prototype.modalConfirm=function(b,c){this.modalClose(b);this.callback_&&this.callback_.call(null,this.callbackArgs_)}})(jQuery);(function(a){a.pkp.controllers.modal.RedirectConfirmationModalHandler=function(b,c){this.parent(b,c);this.remoteUrl_=c.remoteUrl};a.pkp.classes.Helper.inherits(a.pkp.controllers.modal.RedirectConfirmationModalHandler,a.pkp.controllers.modal.ConfirmationModalHandler);a.pkp.controllers.modal.RedirectConfirmationModalHandler.prototype.remoteUrl_=null;a.pkp.controllers.modal.RedirectConfirmationModalHandler.prototype.checkOptions=function(b){return this.parent("checkOptions",b)?"string"===typeof b.cancelButton&&
