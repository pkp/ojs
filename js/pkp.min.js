...
c,d){b=a.pkp.classes.TinyMCEHelper.prototype.getVariableTypesMap(b);return void 0!=b[c]&&(b=b[c],b==a.pkp.cons.INSERT_TAG_VARIABLE_TYPE_PLAIN_TEXT)?a("<div/>").append(a("<span/>").text(d)):a("<div/>").append(a("<span/>").addClass("pkpTag mceNonEditable").attr("data-symbolic",c).text(d))}})(jQuery);(function(a){a.pkp.classes.linkAction=a.pkp.classes.linkAction||{};a.pkp.classes.linkAction.LinkActionRequest=function(a,c){this.$linkActionElement=a;this.options=c;a.is("a")&&c.url&&a.attr("href",c.url)};a.pkp.classes.linkAction.LinkActionRequest.prototype.$linkActionElement=null;a.pkp.classes.linkAction.LinkActionRequest.prototype.options=null;a.pkp.classes.linkAction.LinkActionRequest.prototype.activate=function(){this.getLinkActionElement().trigger("actionStart");return!1};a.pkp.classes.linkAction.LinkActionRequest.prototype.finish=
...
return this.parent("finish")}})(jQuery);(function(a){a.pkp.classes.notification=a.pkp.classes.notification||{};a.pkp.classes.notification.NotificationHelper=function(){};a.pkp.classes.notification.NotificationHelper.redirectNotifyUserEvent=function(b,c){var d,e,f,h,j,i,n,k,q,p,s;if(void 0!==c.content)b.getHtmlElement().parent().trigger("notifyUser",[c]);else{d=b.getHtmlElement();e=!1;!(b instanceof a.pkp.controllers.SiteHandler)&&0<a(c).parents(".pkp_controllers_grid").length&&(d.parent().trigger("notifyUser"),e=!0);d=a(".pkp_notification",
...
!0:!1};a.pkp.controllers.SiteHandler.prototype.showNotificationResponseHandler_=function(a,c){this.showNotification_(c)};a.pkp.controllers.SiteHandler.prototype.showNotification_=function(a){var c,d,a=this.handleJson(a);if(!1!==a&&a.content.general)for(c in a=a.content.general,a)for(d in a[c])new PNotify(a[c][d])};a.pkp.controllers.SiteHandler.prototype.openModal_=function(){this.getHtmlElement().addClass("modal_is_visible")};a.pkp.controllers.SiteHandler.prototype.closeModal_=function(){var a=this.getHtmlElement();
a.find(".pkp_modal.is_visible").length||a.removeClass("modal_is_visible")};a.pkp.controllers.SiteHandler.prototype.registerScrollingObserver_=function(b,c,d,e){a(document).scroll(e);return!1};a.pkp.controllers.SiteHandler.prototype.unregisterScrollingObserver_=function(b,c,d,e){a(document).unbind("scroll",e);return!1}})(jQuery);(function(a){a.pkp.controllers.UrlInDivHandler=function(a,c){this.parent(a,c);this.sourceUrl_=c.sourceUrl;this.reload()};a.pkp.classes.Helper.inherits(a.pkp.controllers.UrlInDivHandler,a.pkp.classes.Handler);a.pkp.controllers.UrlInDivHandler.sourceUrl_=null;a.pkp.controllers.UrlInDivHandler.prototype.reload=function(){a.get(this.sourceUrl_,this.callbackWrapper(this.handleLoadedContent_),"json")};a.pkp.controllers.UrlInDivHandler.prototype.getSourceUrl=function(){return this.sourceUrl_};a.pkp.controllers.UrlInDivHandler.prototype.setSourceUrl=
function(a){this.sourceUrl_=a};a.pkp.controllers.UrlInDivHandler.prototype.handleLoadedContent_=function(a,c){var d=this.handleJson(c);!0===d.status?void 0===d.content?this.getHtmlElement().hide():(/msie/.test(navigator.userAgent.toLowerCase())?this.html(d.content):(this.getHtmlElement().hide(),this.html(d.content),this.getHtmlElement().fadeIn(400)),this.trigger("urlInDivLoaded",[this.getHtmlElement().attr("id")])):alert(d.content);return!1}})(jQuery);(function(a){a.pkp.controllers.ExtrasOnDemandHandler=function(b,c){this.parent(b,c);a(".toggleExtras",b).click(this.callbackWrapper(this.toggleExtras))};a.pkp.classes.Helper.inherits(a.pkp.controllers.ExtrasOnDemandHandler,a.pkp.classes.Handler);a.pkp.controllers.ExtrasOnDemandHandler.prototype.toggleExtras=function(a,c){var d=this.getHtmlElement(),e;c.preventDefault();d.toggleClass("active");d.hasClass("active")&&(e=d.closest(".scrollable"),0<e.size()&&this.scrollToMakeVisible_(d,e))};a.pkp.controllers.ExtrasOnDemandHandler.prototype.scrollToMakeVisible_=
...
d.split("#")[1];e=b.find("li a");for(f=0;f<e.length;f++)d==e[f].getAttribute("name")&&(c.selected=f)}b.tabs({ajaxOptions:{cache:!1,dataFilter:this.callbackWrapper(this.dataFilter)},disabled:c.disabled,active:c.selected});b.children(".ui-tabs-nav").find("li > a").focus(function(){a(this).click()})};a.pkp.classes.Helper.inherits(a.pkp.controllers.TabHandler,a.pkp.classes.Handler);a.pkp.controllers.TabHandler.prototype.$currentTab_=null;a.pkp.controllers.TabHandler.prototype.currentTabIndex_=0;a.pkp.controllers.TabHandler.prototype.tabsBeforeActivate=
function(){var b=!1;this.$currentTab_.find("form").each(function(){if(a.pkp.classes.Handler.getHandler(a("#"+a(this).attr("id"))).formChangesTracked)return b=!0,!1});this.$currentTab_.find(".hasDatepicker").datepicker("hide");if(b)if(confirm(a.pkp.locale.form_dataHasChanged))this.trigger("unregisterAllForms");else return!1;this.emptyLastTab_&&(a(window).one("error",function(){return!1}),this.$currentTab_&&(this.unbindPartial(this.$currentTab_),this.$currentTab_.empty()));return!0};a.pkp.controllers.TabHandler.prototype.tabsCreate=
...
!1;d.ajaxSettings.dataFilter=this.callbackWrapper(this.dataFilter)};a.pkp.controllers.TabHandler.prototype.dataFilter=function(b,c){var d=this.handleJson(a.parseJSON(c));return!1===d?"":d.content};a.pkp.controllers.TabHandler.prototype.tabsReloadRequested=function(b,c,d){this.getHtmlElement();var e=this;a.get(d.tabsUrl,function(b){b=a.parseJSON(b);e.replaceWith(b.content)})};a.pkp.controllers.TabHandler.prototype.addTab=function(b,c,d){var e=this.getHtmlElement(),b=e.children("ul").children("li").length+
1,c=a("<a/>").text(d.title).attr("href",d.url),d=a("<a/>").addClass("close").text(a.pkp.locale.common_close).attr("href","#"),c=a("<li/>").append(c).append(d);d.click(function(){var b=a(this).closest("li"),c=a("#"+b.attr("aria-controls")),d,i;i=!1;c.find("form").each(function(){if(a.pkp.classes.Handler.getHandler(a(this)).formChangesTracked&&!confirm(a.pkp.locale.form_dataHasChanged))return i=!0,!1});i||(c.find("form").each(function(){var b=a.pkp.classes.Handler.getHandler(a(this));b&&b.unregisterForm()}),
d=b.eq(0).index(),e.tabs("option","active")==d&&e.tabs("option","active",d-1),b.remove(),c.remove(),e.tabs("refresh"))});e.children("ul").append(c);e.tabs("refresh");e.tabs("option","active",b-1)};a.pkp.controllers.TabHandler.prototype.getCurrentTab=function(){return this.$currentTab_};a.pkp.controllers.TabHandler.prototype.getCurrentTabIndex=function(){return this.currentTabIndex_}})(jQuery);(function(a){a.pkp.controllers.MenuHandler=function(b,c){this.parent(b,c);var d=this;setTimeout(function(){d.callbackWrapper(d.setDropdownAlignment())},1);a(window).resize(this.callbackWrapper(this.onResize));this.getHtmlElement().on("focus mouseenter",'[aria-haspopup="true"]',function(b){a(b.currentTarget).attr("aria-expanded","true")});this.getHtmlElement().on("blur mouseleave",'[aria-haspopup="true"]',function(b){a(b.currentTarget).attr("aria-expanded","false")});this.getHtmlElement().find('[aria-haspopup="true"] > a').on("touchstart",
function(b){!1!=a(this).parent().attr("aria-expanded")&&(a(this).focus(),b.preventDefault())})};a.pkp.classes.Helper.inherits(a.pkp.controllers.MenuHandler,a.pkp.classes.Handler);a.pkp.controllers.MenuHandler.prototype.setDropdownAlignment=function(){a(this);var b=Math.max(document.documentElement.clientWidth,window.innerWidth||0),c=Math.max(document.documentElement.clientHeight,window.innerHeight||0);this.getHtmlElement().find('[aria-haspopup="true"]').each(function(){var d=a(this),e=d.children("ul"),
f,h,j,i;d.offset().left+e.outerWidth()>b?d.addClass("align_right"):d.removeClass("align_right");e.attr("style","");f=d.offset().top;h=0;d.hasClass("submenuOpensBelow")&&(h=f+d.outerHeight());j=f+e.outerHeight();j>c&&(j-=c,i=f-j,i<h&&(j=0<h?h:-Math.abs(j)-i,e.css("overflow-y","scroll"),e.css("bottom",-Math.abs(c-f-d.outerHeight())+"px")),e.css("top",j+"px"))})};a.pkp.controllers.MenuHandler.prototype.onResize=function(){clearTimeout(this.resize_check);this.resize_check=setTimeout(this.callbackWrapper(this.setDropdownAlignment),
1E3)}})(jQuery);(function(a){a.pkp.controllers.UploaderHandler=function(b,c){this.parent(b,c);if(!b.is("div"))throw Error("An uploader widget controller can only be attached to a div!");var d,e,f;d={url:c.uploadUrl,flash_swf_url:c.baseUrl+"/lib/pkp/lib/vendor/moxiecode/plupload/js/Moxie.swf",silverlight_xap_url:c.baseUrl+"/lib/pkp/lib/vendor/moxiecode/plupload/js/Moxie.xap"};typeof c.filters&&(d.filters=c.filters);typeof c.resize&&(d.resize=c.resize);typeof c.browse_button&&(d.browse_button=c.browse_button);typeof c.multipart_params&&
...
function(a){this.sourceUrl_=a};a.pkp.controllers.AutocompleteHandler.prototype.textInputBlurHandler_=function(){""===this.hiddenInput_.val()&&this.textInput.val("")};a.pkp.controllers.AutocompleteHandler.prototype.synchronizeFields_=function(){this.hiddenInput_.val(String(this.textInput.val()))}})(jQuery);(function(a){a.pkp.controllers.RangeSliderHandler=function(b,c){this.parent(b,c);if(!c.min||!c.max)throw Error('The "min" and "max"settings are required in a RangeSliderHandler');this.slider_=b.find(".pkp_controllers_rangeSlider_slider");this.labelMin_=b.find(".pkp_controllers_rangeSlider_sliderValueMin");this.labelMax_=b.find(".pkp_controllers_rangeSlider_sliderValueMax");var d={};d.min=c.min;d.max=c.max;d.values="undefined"===typeof c.values?[c.min,c.max]:c.values;d=a.extend({},this.self("DEFAULT_PROPERTIES_"),
d);this.slider_.slider(d);this.bind("slide",this.sliderAdjusted);"undefined"!==typeof c.toggleable&&c.toggleable&&(this.toggleCheckbox_=this.getHtmlElement().find(".toggle input"),this.toggleCheckbox_.on("change",this.callbackWrapper(this.toggleField)))};a.pkp.classes.Helper.inherits(a.pkp.controllers.RangeSliderHandler,a.pkp.classes.Handler);a.pkp.controllers.RangeSliderHandler.slider_=null;a.pkp.controllers.RangeSliderHandler.labelMin_=null;a.pkp.controllers.RangeSliderHandler.labelMax_=null;a.pkp.controllers.RangeSliderHandler.toggleCheckbox_=
null;a.pkp.controllers.RangeSliderHandler.DEFAULT_PROPERTIES_={range:!0};a.pkp.controllers.RangeSliderHandler.prototype.sliderAdjusted=function(b,c,d){this.labelMin_.html(d.values[0]);this.labelMax_.html(d.values[1]);a(b).children(".pkp_controllers_rangeSlider_minInput").val(d.values[0]);a(b).children(".pkp_controllers_rangeSlider_maxInput").val(d.values[1])};a.pkp.controllers.RangeSliderHandler.prototype.toggleField=function(){this.getHtmlElement().toggleClass("is_enabled")}})(jQuery);(function(a){a.pkp.controllers.RevealMoreHandler=function(b,c){this.parent(b,c);b.outerHeight()>c.height&&(b.addClass("isHidden").css("max-height",c.height+"px"),a(".revealMoreButton",b).click(this.callbackWrapper(this.revealMore)))};a.pkp.classes.Helper.inherits(a.pkp.controllers.RevealMoreHandler,a.pkp.classes.Handler);a.pkp.controllers.RevealMoreHandler.prototype.revealMore=function(a,c){this.getHtmlElement().removeClass("isHidden").css("max-height","auto");c.preventDefault();c.stopPropagation()}})(jQuery);(function(a){a.pkp.controllers.NotificationHandler=function(a,c){this.parent(a,c);this.options_=c;this.bind("notifyUser",this.fetchNotificationHandler_);this.getHtmlElement().hide();this.getHtmlElement().triggerHandler("notifyUser")};a.pkp.classes.Helper.inherits(a.pkp.controllers.NotificationHandler,a.pkp.classes.Handler);a.pkp.controllers.NotificationHandler.prototype.options_=null;a.pkp.controllers.NotificationHandler.prototype.trivialTimer_=null;a.pkp.controllers.NotificationHandler.prototype.fetchNotificationHandler_=
function(){var b={};b.requestOptions=this.options_.requestOptions;a.ajax({type:"POST",url:this.options_.fetchNotificationUrl,data:b,success:this.callbackWrapper(this.showNotificationResponseHandler_),dataType:"json",async:!1})};a.pkp.controllers.NotificationHandler.prototype.showNotificationResponseHandler_=function(b,c){clearTimeout(this.trivialTimer_);var d=this.getHtmlElement(),e=this.handleJson(c),f,h,j;if(!1!==e)if(e.content.inPlace){f=this.concatenateNotifications_(e.content.inPlace);h=this.removeAlreadyShownNotifications_(e);
this.unbindPartial(d);d.html(f);d.show();e=this.getTrivialNotifications_(e.content.inPlace);if(!this.visibleWithoutScrolling_()&&h)for(j in d.parent().trigger("notifyUser",[h]),e)d=e[j],d=a("#pkp_notification_"+d,this.getHtmlElement()),this.unbindPartial(d),d.remove();0===d.children().length?d.hide():this.addTimerToNotifications(e)}else this.unbindPartial(this.getHtmlElement()),this.getHtmlElement().empty(),this.getHtmlElement().hide()};a.pkp.controllers.NotificationHandler.prototype.visibleWithoutScrolling_=
function(){var b=this.getHtmlElement(),c=b.offset().top+this.getHtmlElement().height()/2,d=a(window).scrollTop(),e=d+a(window).height(),f=b.parents(".ui-dialog-content");return 0<f.length&&(b=f.offset().top,f=b+f.height(),c<b||c>f)?!1:c<d||c>e?!1:!0};a.pkp.controllers.NotificationHandler.prototype.removeAlreadyShownNotifications_=function(b){var c=!0,d,e,f;for(d in b.content.inPlace)for(e in b.content.inPlace[d])f=a("#pkp_notification_"+e),0<f.length?(delete b.content.inPlace[d][e],delete b.content.general[d][e]):
c=!1;return c?!1:b};a.pkp.controllers.NotificationHandler.prototype.concatenateNotifications_=function(a){var c="",d,e;for(d in a)for(e in a[d])c+=a[d][e];return c};a.pkp.controllers.NotificationHandler.prototype.getTrivialNotifications_=function(a){var c=[],d,e;for(d in a)if(1==d)for(e in a[d])c.push(e);return c};a.pkp.controllers.NotificationHandler.prototype.addTimerToNotifications=function(b){var c=function(){this.unbindPartial(a(this));a(this).remove()};b.length&&(this.trivialTimer_=setTimeout(function(){var d,
e;for(d in b)e=a("#pkp_notification_"+b[d]),e.fadeOut(400,c())},6E3))}})(jQuery);(function(a){a.pkp.controllers.HelpPanelHandler=function(b,c){this.parent(b,{});a("body").click(function(c){a(c.target).hasClass("requestHelpPanel")&&(c.preventDefault(),c=a(c.target),c=a.extend({},c.data(),{caller:c}),b.trigger("pkp.HelpPanel.Open",c))});b.find(".pkpCloseHelpPanel").click(function(a){a.preventDefault();b.trigger("pkp.HelpPanel.Close")});b.find(".pkpHomeHelpPanel").click(function(a){a.preventDefault();b.trigger("pkp.HelpPanel.Home")});b.find(".pkpPreviousHelpPanel").click(this.callbackWrapper(function(){this.loadHelpContent_(this.previousTopic_,
...
function(a,c){var d=this.getHtmlElement();0<parseInt(d.find("#revisedFileId").val(),10)&&(d.submit(),c.preventDefault())};a.pkp.controllers.wizard.fileUpload.form.RevisionConfirmationHandler.prototype.handleResponse=function(a,c){!0===c.status&&this.trigger("fileUploaded",c.uploadedFile);return this.parent("handleResponse",a,c)}})(jQuery);(function(a){a.pkp.controllers.grid.filter=a.pkp.controllers.grid.filter||{form:{}};a.pkp.controllers.grid.filter.form.FilterFormHandler=function(b,c){this.parent(b,c);if(!0===c.noMoreTemplates||!0===c.filterTemplates)this.disableFormControls(),a(c.pulldownSelector).change(this.callbackWrapper(this.selectOptionHandler_)),c.filterTemplates&&this.bind("pkpRemoveHandler",this.removeHandler_);this.editFilterUrlTemplate_=c.editFilterUrlTemplate};a.pkp.classes.Helper.inherits(a.pkp.controllers.grid.filter.form.FilterFormHandler,
a.pkp.controllers.form.AjaxFormHandler);a.pkp.controllers.grid.filter.form.FilterFormHandler.prototype.editFilterUrlTemplate_=null;a.pkp.controllers.grid.filter.form.FilterFormHandler.prototype.selectOptionHandler_=function(b){a(b).hide();a.get(this.editFilterUrlTemplate_.replace("DUMMY_FILTER_TEMPLATE_ID",a(b).val()),this.callbackWrapper(this.getFilterForm_),"json")};a.pkp.controllers.grid.filter.form.FilterFormHandler.prototype.removeHandler_=function(){this.unbind("pkpRemoveHandler",this.removeHandler_)};
a.pkp.controllers.grid.filter.form.FilterFormHandler.prototype.getFilterForm_=function(a,c){var d=this.handleJson(c);this.remove();this.replaceWith(d.content)}})(jQuery);(function(a){a.pkp.controllers.grid.representations=a.pkp.controllers.grid.representations||{form:{}};a.pkp.controllers.grid.representations.form.RepresentationFormHandler=function(b,c){this.parent(b,c);(this.remoteRepresentation_=c.remoteRepresentation)?(a("#remotelyHostedContent").prop("checked",!0),a("#remote").show(20)):(a("#remotelyHostedContent").prop("checked",!1),a("#remote").hide(20));a("#remotelyHostedContent").change(this.callbackWrapper(this.toggleRemote_))};a.pkp.classes.Helper.inherits(a.pkp.controllers.grid.representations.form.RepresentationFormHandler,
...
function(b){var c=this.getHtmlElement(),d=c.find("#userGroupStageContainer"),e=a(this.stagesSelector_,c).filter("input"),f,h=null;e.removeAttr("disabled");if(void 0!=this.roleForbiddenStages_[b])for(f=0;f<this.roleForbiddenStages_[b].length;f++)h=this.roleForbiddenStages_[b][f],e.filter('input[value="'+h+'"]').attr("disabled","disabled");0==c.find("input[id^='assignedStages-']:enabled").length?(d.hide("slow"),a("#showTitle").attr("disabled","disabled")):(d.show("slow"),a("#showTitle").removeAttr("disabled"))}})(jQuery);(function(a){a.pkp.controllers.grid.settings.metadata=a.pkp.controllers.grid.settings.metadata||{};a.pkp.controllers.grid.settings.metadata.MetadataGridHandler=function(a,c){a.find(":checkbox").change(this.callbackWrapper(this.checkboxHandler_));this.parent(a,c)};a.pkp.classes.Helper.inherits(a.pkp.controllers.grid.settings.metadata.MetadataGridHandler,a.pkp.controllers.grid.GridHandler);a.pkp.controllers.grid.settings.metadata.MetadataGridHandler.prototype.initialize=function(b){this.parent("initialize",
...
a.pkp.controllers.grid.CategoryGridHandler)})(jQuery);(function(a){a.pkp.controllers.grid.users.stageParticipant.form=a.pkp.controllers.grid.users.stageParticipant.form||{};a.pkp.controllers.grid.users.stageParticipant.form.StageParticipantNotifyHandler=function(a,c){this.parent(a,c);c.templateUrl&&(this.templateUrl_=c.templateUrl);a.find("#template").change(this.callbackWrapper(this.selectTemplateHandler_))};a.pkp.classes.Helper.inherits(a.pkp.controllers.grid.users.stageParticipant.form.StageParticipantNotifyHandler,a.pkp.controllers.form.AjaxFormHandler);
...
e=this.handleJson(c),f=c.content,d=d.find('textarea[name="message"]'),h=tinyMCE.EditorManager.get(d.attr("id"));d.attr("data-variables",JSON.stringify(f.variables));h.setContent(f.body);return e.status};a.pkp.controllers.grid.users.stageParticipant.form.StageParticipantNotifyHandler.prototype.handleResponse=function(b,c){a.pkp.classes.Handler.getHandler(a("#queriesGrid .pkp_controllers_grid")).trigger("dataChanged");return this.parent("handleResponse",b,c)}})(jQuery);(function(a){a.pkp.controllers.grid.users.stageParticipant.form.AddParticipantFormHandler=function(b,c){this.parent(b,c);a("select[name^='filterUserGroupId']",b).change(this.callbackWrapper(this.addUserGroupId));this.addUserGroupId()};a.pkp.classes.Helper.inherits(a.pkp.controllers.grid.users.stageParticipant.form.AddParticipantFormHandler,a.pkp.controllers.form.ClientFormHandler);a.pkp.controllers.grid.users.stageParticipant.form.AddParticipantFormHandler.prototype.addUserGroupId=function(){var b=
this.getHtmlElement().find("select[name^='filterUserGroupId']").val();a("input[name='userGroupId']").val(b)}})(jQuery);(function(a){a.pkp.pages.reviewer=a.pkp.pages.reviewer||{};a.pkp.pages.reviewer.ReviewerTabHandler=function(a,c){this.parent(a,c);this.reviewStep_=c.reviewStep;this.bind("setStep",this.setStepHandler);this.getHtmlElement().tabs("option","disabled",this.getDisabledSteps(this.reviewStep_))};a.pkp.classes.Helper.inherits(a.pkp.pages.reviewer.ReviewerTabHandler,a.pkp.controllers.TabHandler);a.pkp.pages.reviewer.ReviewerTabHandler.prototype.reviewStep_=null;a.pkp.pages.reviewer.ReviewerTabHandler.prototype.setStepHandler=
...
function(a,c){var d=this.handleJson(c),e=this.getHtmlElement(),f=e.find("li a"),h={},j=/galley(\d+)/,i,n,k;for(n=0;n<f.length;n++)k=f[n].getAttribute("id"),k=j.exec(k),null!==k&&(h[k[1]]=n);for(i in d.galleys)h.hasOwnProperty(i)||(f=this.tabContentUrl_+"&galleyId="+encodeURIComponent(i),f=f.replace(/[$]/g,"$$$$"),e.tabs("add",f,d.galleys[i]),e.find("li a").filter(":last").attr("id","galley"+i));for(i in h)d.galleys.hasOwnProperty(i)?e.find("li a").filter('[id="galley'+i+'"]').html(d.galleys[i]):e.tabs("remove",
