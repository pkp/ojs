...
function(c){a(c.currentTarget).parent().parent().find("span").toggle()};a.pkp.classes.Handler.prototype.initializeTinyMCE=function(){if("undefined"!==typeof tinyMCE){var c=this.getHtmlElement().attr("id");a("#"+c).find(".richContent").each(function(){var c=a(this).attr("id"),d=a("<div></div>"),e=a("<div></div>"),f=tinyMCE.EditorManager.settings;a(this).hasClass("extendedRichContent")&&(f.toolbar=f.richToolbar);tinyMCE.EditorManager.createEditor(c,f).render();if(a(this).hasClass("localizable")||a(this).hasClass("flag"))if(d.addClass("mceLocalizationIcon localizable"),
d.attr("id","mceLocalizationIcon-"+c),a(this).wrap(e),a(this).parent().append(d),a(this).hasClass("localizable"))d.addClass("mceGlobe");else if(a(this).hasClass("flag")&&(c=a(this).attr("class").split(" "),c.length))for(e=0;e<c.length;e++)if(c[e].match(/^flag_[a-z]{2}_[A-Z]{2}$/)){d.addClass(c[e]);break}})}};a.pkp.classes.Handler.prototype.triggerPublicEvent_=function(c,b){this.getHtmlElement().parent().trigger(c,b);this.eventBridge_&&a('[id^="'+this.eventBridge_+'"]').trigger(c,b)};a.pkp.classes.Handler.checkContext_=
function(c){if(!(c instanceof a.pkp.classes.Handler))throw Error("Trying to call handler method in non-handler context!");}})(jQuery);(function(a){a.pkp.classes.TinyMCEHelper=function(){throw Error("Trying to instantiate the TinyMCEHelper singleton!");};a.pkp.classes.TinyMCEHelper.prototype.getVariableMap=function(c){c=a(c).attr("data-variables");return void 0!==c?a.parseJSON(decodeURIComponent(c)):[]};a.pkp.classes.TinyMCEHelper.prototype.getVariableElement=function(c,b){return a("<div/>").append(a("<span/>").addClass("pkpTag mceNonEditable").attr("data-symbolic",c).text(b))}})(jQuery);(function(a){a.pkp.classes.linkAction=a.pkp.classes.linkAction||{};a.pkp.classes.linkAction.LinkActionRequest=function(a,b){this.$linkActionElement=a;this.options=b;a.is("a")&&b.url&&a.attr("href",b.url)};a.pkp.classes.linkAction.LinkActionRequest.prototype.$linkActionElement=null;a.pkp.classes.linkAction.LinkActionRequest.prototype.options=null;a.pkp.classes.linkAction.LinkActionRequest.prototype.activate=function(){this.getLinkActionElement().trigger("actionStart");return!1};a.pkp.classes.linkAction.LinkActionRequest.prototype.finish=
...
(d=a(b.orderFinishControls),c.find("table").last().after(d),d.hide());this.updateOrderLinkVisibility_()};a.pkp.classes.features.OrderItemsFeature.prototype.addOrderingClassToRows=function(){this.gridHandler.getRows().addClass("orderable")};a.pkp.classes.features.OrderItemsFeature.prototype.setupSortablePlugin=function(){};a.pkp.classes.features.OrderItemsFeature.prototype.storeRowOrder=function(){};a.pkp.classes.features.OrderItemsFeature.prototype.clickOrderHandler=function(){this.gridHandler.hideAllVisibleRowActions();
this.storeOrder(this.gridHandler.getRows());this.toggleState(!0);return!1};a.pkp.classes.features.OrderItemsFeature.prototype.saveOrderHandler=function(){var a;this.gridHandler.updateControlRowsPosition();this.unbindOrderFinishControlsHandlers_();a=this.gridHandler.getRows();this.storeOrder(a);return!1};a.pkp.classes.features.OrderItemsFeature.prototype.cancelOrderHandler=function(){this.gridHandler.resequenceRows(this.itemsOrder);this.toggleState(!1);return!1};a.pkp.classes.features.OrderItemsFeature.prototype.toggleState=
function(a){this.isOrdering=a;this.toggleGridLinkActions_();this.toggleOrderLink_();this.toggleFinishControl_();this.toggleItemsDragMode();this.setupSortablePlugin()};a.pkp.classes.features.OrderItemsFeature.prototype.storeOrder=function(c){var b,d,e,f;this.itemsOrder=[];b=0;for(d=c.length;b<d;b++)e=a(c[b]),f=e.attr("id"),this.itemsOrder.push(f),this.storeRowOrder(b,e)};a.pkp.classes.features.OrderItemsFeature.prototype.toggleItemsDragMode=function(){var a=this.isOrdering,b=this.gridHandler.getRows().filter(".orderable"),
d=this.getMoveItemClasses();a?b.addClass(d):b.removeClass(d);this.toggleMoveItemRowAction(a)};a.pkp.classes.features.OrderItemsFeature.prototype.applySortPlgOnElements=function(c,b,d){var e=this.isOrdering,f=this.gridHandler.callbackWrapper(this.dragStartCallback,this),g=this.gridHandler.callbackWrapper(this.dragStopCallback,this),h=this.gridHandler.callbackWrapper(this.updateOrderCallback,this),b={disabled:!e,items:b,activate:f,deactivate:g,update:h,tolerance:"pointer"};"object"===typeof d&&(b=a.extend(!0,
...
function(){this.updateOrderLinkVisibility_();return!1};a.pkp.classes.features.OrderItemsFeature.prototype.updateOrderLinkVisibility_=function(){var c=a(".pkp_linkaction_orderItems",this.getGridHtmlElement());1>=this.gridHandler.getRows().length?c.hide():c.show()};a.pkp.classes.features.OrderItemsFeature.prototype.toggleGridLinkActions_=function(){var c=this.isOrdering,b=a(".pkp_controllers_linkAction",this.getGridHtmlElement()).not(this.getMoveItemRowActionSelector()).not(this.getOrderButton()).not(this.getFinishControl().find("*"));
this.gridHandler.changeLinkActionsState(!c,b)};a.pkp.classes.features.OrderItemsFeature.prototype.toggleOrderLink_=function(){if(this.isOrdering)this.$orderButton_.unbind("click"),this.$orderButton_.attr("disabled","disabled");else{var a=this.gridHandler.callbackWrapper(this.clickOrderHandler,this);this.$orderButton_.click(a);this.$orderButton_.removeAttr("disabled")}};a.pkp.classes.features.OrderItemsFeature.prototype.toggleFinishControl_=function(){this.isOrdering?(this.bindOrderFinishControlsHandlers_(),
this.getFinishControl().slideDown(300)):(this.unbindOrderFinishControlsHandlers_(),this.getFinishControl().slideUp(300))};a.pkp.classes.features.OrderItemsFeature.prototype.bindOrderFinishControlsHandlers_=function(){var a=this.getSaveOrderButton(),b=this.getCancelOrderButton(),d=this.gridHandler.callbackWrapper(this.cancelOrderHandler,this),e=this.gridHandler.callbackWrapper(this.saveOrderHandler,this);a.click(e);b.click(d)};a.pkp.classes.features.OrderItemsFeature.prototype.unbindOrderFinishControlsHandlers_=
...
this.closeOpenedRowControls_();return!1};a.pkp.classes.features.GridCategoryAccordionFeature.prototype.accordionRowClickHandler_=function(c){var b=a(c),d,e;b.hide();d=b.parents(".category_grid_body:first");c=this.gridHandler.getRowsInCategory(d);0===c.length&&(c=this.gridHandler.getCategoryEmptyPlaceholder(d));e=b.parent();b.hasClass(this.getExpandClass())?(d=a("."+this.getCollapseClass(),e),d.show(),c.show()):(b=a("."+this.getExpandClass(),e),b.show(),c.hide(),this.closeOpenedRowControls_(d));this.updateGridActions_();
return!1};a.pkp.classes.features.GridCategoryAccordionFeature.prototype.updateGridActions_=function(){var c,b,d,e,f;this.getGridHtmlElement().is(":visible")&&(c=this.getGridHtmlElement(),b="."+this.getExpandClass()+", ."+this.getCollapseClass(),b=a(b,c).filter(":visible"),d=a("."+this.getExpandClass(),c).filter(":visible"),c=a("."+this.getCollapseClass(),c).filter(":visible"),e=a(".grid_header_bar .collapse_all"),f=a(".grid_header_bar .expand_all"),b.length==d.length&&e.is(":visible")?e.click():b.length==
c.length&&f.is(":visible")&&f.click())};a.pkp.classes.features.GridCategoryAccordionFeature.prototype.closeOpenedRowControls_=function(c){void 0==c&&(c=this.gridHandler.getHtmlElement());a(".row_controls :visible",c).closest("tr").prev().find(".row_actions > a:first").click()}})(jQuery);(function(a){a.pkp.classes.features.GeneralPagingFeature=function(a,b){b.defaultItemsPerPage=parseInt(b.defaultItemsPerPage,10);b.currentItemsPerPage=parseInt(b.currentItemsPerPage,10);b.itemsTotal=b.itemsTotal?parseInt(b.itemsTotal,10):0;b.currentPage=parseInt(b.currentPage,10);this.parent(a,b)};a.pkp.classes.Helper.inherits(a.pkp.classes.features.GeneralPagingFeature,a.pkp.classes.features.Feature);a.pkp.classes.features.GeneralPagingFeature.prototype.getOptions=function(){return this.parent("getOptions")};
...
this.bind("pkpRemoveScrollingObserver",this.callbackWrapper(this.unregisterScrollingObserver_));this.outsideClickChecks_={}};a.pkp.classes.Helper.inherits(a.pkp.controllers.SiteHandler,a.pkp.classes.Handler);a.pkp.controllers.SiteHandler.prototype.options_=null;a.pkp.controllers.SiteHandler.prototype.outsideClickChecks_=null;a.pkp.controllers.SiteHandler.prototype.unsavedFormElements_=null;a.pkp.controllers.SiteHandler.prototype.triggerTinyMCEInitialized=function(c){a("#"+c.id).trigger("tinyMCEInitialized",
[c])};a.pkp.controllers.SiteHandler.prototype.triggerTinyMCESetup=function(c){var b=a("#"+c.id);b.attr("readonly")&&(c.settings.readonly=!0);b=b.attr("rows")||10;c.settings.height=(20*b).toString()+"px";c.on("init",function(c){var b=a("#"+c.id),f;f=a("#"+c.id).attr("placeholder");""!==f&&(f=a("<span></span>").html(f),f.addClass("mcePlaceholder"),f.attr("id","mcePlaceholder-"+c.id),c.target.getContent().length&&f.hide(),c=a("<div></div>"),c.addClass("mcePlaceholderParent"),b.wrap(c),b.parent().append(f))});
c.on("activate",function(c){a("#mcePlaceholder-"+c.id).hide()});c.on("deactivate",function(c){c.target.getContent().length||a("#mcePlaceholder-"+c.id).show();c.target.dom.addClass(c.target.dom.select("li"),"show")});c.on("BeforeSetContent",function(b){var e=a.pkp.classes.TinyMCEHelper.prototype.getVariableMap("#"+c.id);b.content=b.content.replace(/\{\$([a-zA-Z]+)\}(?![^<]*>)/g,function(c,b){return void 0!==e[b]?a.pkp.classes.TinyMCEHelper.prototype.getVariableElement(b,e[b]).html():c})});c.on("SaveContent",
function(c){var b=a("<div>"+c.content+"</div>");b.find(".pkpTag").replaceWith(function(){return"{$"+a(this).attr("data-symbolic")+"}"});c.content=b.html()});c.on("FullscreenStateChanged init",function(c){var c=c.target,b=a(c.editorContainer);c.plugins.fullscreen&&(c.plugins.fullscreen.isFullscreen()?b.find(".mce-toolbar[role='menubar']").show():b.find(".mce-toolbar[role='menubar']").hide())})};a.pkp.controllers.SiteHandler.prototype.getWindowDimensions=function(){return{height:a(window).height(),
width:a(window).width()}};a.pkp.controllers.SiteHandler.prototype.redirectToUrl=function(a,b,d){window.location=d};a.pkp.controllers.SiteHandler.prototype.registerUnsavedFormElement_=function(c,b,d){c=a(d.target.lastElementChild).attr("id");-1==a.inArray(c,this.unsavedFormElements_)&&this.unsavedFormElements_.push(c)};a.pkp.controllers.SiteHandler.prototype.unregisterUnsavedFormElement_=function(c,b,d){c=a(d.target.lastElementChild).attr("id");c=a.inArray(c,this.unsavedFormElements_);-1!==c&&delete this.unsavedFormElements_[c]};
a.pkp.controllers.SiteHandler.prototype.unregisterAllFormElements_=function(){this.unsavedFormElements_=[]};a.pkp.controllers.SiteHandler.prototype.fetchNotificationHandler_=function(c,b,d){void 0!==d?this.showNotification_(d):a.ajax({url:this.options_.fetchNotificationUrl,data:this.options_.requestOptions,success:this.callbackWrapper(this.showNotificationResponseHandler_),dataType:"json",async:!1})};a.pkp.controllers.SiteHandler.prototype.updateHeaderHandler_=function(){a.pkp.classes.Handler.getHandler(a("#navigationUserWrapper")).reload()};
a.pkp.controllers.SiteHandler.prototype.callWhenClickOutsideHandler_=function(a,b,d){void 0!==d.container&&void 0!==d.callback&&(a=d.container.attr("id"),this.outsideClickChecks_[a]=d)};a.pkp.controllers.SiteHandler.prototype.mouseDownHandler_=function(c,b){var d;if(!a.isEmptyObject(this.outsideClickChecks_))for(d in this.outsideClickChecks_)this.processOutsideClickCheck_(this.outsideClickChecks_[d],b);return!0};a.pkp.controllers.SiteHandler.prototype.processOutsideClickCheck_=function(a,b){if("click"!==
b.type&&"mousedown"!==b.type&&"mouseup"!==b.type)throw Error("Can not check outside click with the passed event: "+b.type+".");var d=a.container;return d.is(":hidden")||void 0!==a.skipWhenVisibleModals&&a.skipWhenVisibleModals&&0<this.getHtmlElement().find("div.ui-dialog").length?!1:0===d.has(b.target).length?(delete this.outsideClickChecks_[d.attr("id")],a.callback(),!0):!1};a.pkp.controllers.SiteHandler.prototype.pageUnloadHandler_=function(){var c,b,d;c=a.pkp.classes.Handler.getHandler(a("body"));
b=0;for(d in c.unsavedFormElements_)d&&b++;if(0<b)return a.pkp.locale.form_dataHasChanged};a.pkp.controllers.SiteHandler.prototype.isFormUnsaved=function(a){return null!==this.unsavedFormElements_&&void 0!==this.unsavedFormElements_[a]?!0:!1};a.pkp.controllers.SiteHandler.prototype.showNotificationResponseHandler_=function(a,b){this.showNotification_(b)};a.pkp.controllers.SiteHandler.prototype.showNotification_=function(a){var b,d,a=this.handleJson(a);if(!1!==a&&a.content.general)for(b in a=a.content.general,
...
"#"),b=a("<li/>").append(b).append(d);d.click(function(){var c=a(this).closest("li"),b=a("#"+c.attr("aria-controls")),d,j;j=!1;b.find("form").each(function(){if(a.pkp.classes.Handler.getHandler(a(this)).formChangesTracked&&!confirm(a.pkp.locale.form_dataHasChanged))return j=!0,!1});j||(b.find("form").each(function(){var c=a.pkp.classes.Handler.getHandler(a(this));c&&c.unregisterForm()}),d=c.eq(0).index(),e.tabs("option","active")==d&&e.tabs("option","active",d-1),c.remove(),b.remove(),e.tabs("refresh"))});
e.children("ul").append(b);e.tabs("refresh");e.tabs("option","active",c-1)};a.pkp.controllers.TabHandler.prototype.getCurrentTab=function(){return this.$currentTab_};a.pkp.controllers.TabHandler.prototype.getCurrentTabIndex=function(){return this.currentTabIndex_}})(jQuery);(function(a){a.pkp.controllers.MenuHandler=function(c,b){this.parent(c,b);this.$links_=this.getHtmlElement().find("a");this.$parents_=this.getHtmlElement().find(".has_submenu");var d=this;setTimeout(function(){d.callbackWrapper(d.setDropdownAlignment())},1);a(window).resize(this.callbackWrapper(this.onResize));this.$parents_.children("a").on("touchstart",function(c){a(this).parent().hasClass("in_focus")||(a(this).focus(),c.preventDefault())});this.$links_.bind("focus",this.onFocus);this.$links_.bind("blur",
this.onBlur)};a.pkp.classes.Helper.inherits(a.pkp.controllers.MenuHandler,a.pkp.classes.Handler);a.pkp.controllers.MenuHandler.prototype.onFocus=function(c){c=a(c.target).parents("li");c.length&&c.addClass("in_focus")};a.pkp.controllers.MenuHandler.prototype.onBlur=function(c){c=a(c.target).parents("li");c.length&&c.removeClass("in_focus")};a.pkp.controllers.MenuHandler.prototype.setDropdownAlignment=function(){a(this);var c=Math.max(document.documentElement.clientWidth,window.innerWidth||0),b=Math.max(document.documentElement.clientHeight,
window.innerHeight||0);this.$parents_.each(function(){var d=a(this),e=d.children("ul"),f,g,h,j;d.offset().left+e.outerWidth()>c?d.addClass("align_right"):d.removeClass("align_right");e.attr("style","");f=d.offset().top;g=0;d.hasClass("submenu_opens_below")&&(g=f+d.outerHeight());h=f+e.outerHeight();h>b&&(h-=b,j=f-h,j<g&&(h=0<g?g:-Math.abs(h)-j,e.css("overflow-y","scroll"),e.css("bottom",-Math.abs(b-f-d.outerHeight())+"px")),e.css("top",h+"px"))})};a.pkp.controllers.MenuHandler.prototype.onResize=
function(){clearTimeout(this.resize_check);this.resize_check=setTimeout(this.callbackWrapper(this.setDropdownAlignment),1E3)}})(jQuery);(function(a){a.pkp.controllers.UploaderHandler=function(c,b){this.parent(c,b);if(!c.is("div"))throw Error("An uploader widget controller can only be attached to a div!");var d={url:b.uploadUrl,flash_swf_url:b.baseUrl+"/lib/pkp/lib/vendor/moxiecode/plupload/js/Moxie.swf",silverlight_xap_url:b.baseUrl+"/lib/pkp/lib/vendor/moxiecode/plupload/js/Moxie.xap"};typeof b.filters&&(d.filters=b.filters);typeof b.resize&&(d.resize=b.resize);d=a.extend({},this.self("DEFAULT_PROPERTIES_"),d);this.pluploader=new plupload.Uploader(d);
this.pluploader.init();this.updateStatus("waiting");this.$progress=c.find(".pkpUploaderProgress .percentage");this.$progressBar=c.find(".pkpUploaderProgressBar");this.$fileName=c.find(".pkpUploaderFilename");this.pluploader.bind("FilesAdded",this.callbackWrapper(this.startUpload));this.pluploader.bind("UploadProgress",this.callbackWrapper(this.updateProgress));this.pluploader.bind("Error",this.callbackWrapper(this.handleError));this.pluploader.bind("FileUploaded",this.callbackWrapper(this.uploadComplete));
this.pluploader.bind("QueueChanged",this.callbackWrapper(this.refreshUploader))};a.pkp.classes.Helper.inherits(a.pkp.controllers.UploaderHandler,a.pkp.classes.Handler);a.pkp.controllers.UploaderHandler.prototype.startUpload=function(a,b){1<b.files.length&&b.removeFile(b.files[0]);this.updateStatus("uploading");b.start()};a.pkp.controllers.UploaderHandler.prototype.updateProgress=function(a,b,d){this.$progress.html(d.percent);this.$progressBar.css("width",d.percent+"%")};a.pkp.controllers.UploaderHandler.prototype.uploadComplete=
function(c,b,d,e){c=a.parseJSON(e.response);b=d.name;c.status?("undefined"!==typeof c.uploadedFile&&(b=c.uploadedFile.name||c.uploadedFile.fileLabel,d.storedData=c.uploadedFile),this.$fileName.html(b),this.updateStatus("complete"),this.$progress.html("0"),this.$progressBar.css("width",0)):this.showError(c.content)};a.pkp.controllers.UploaderHandler.prototype.handleError=function(a,b,d){this.showError(d.message)};a.pkp.controllers.UploaderHandler.prototype.showError=function(a){this.$progress.html("0");
this.$progressBar.css("width",0);this.updateStatus("error");this.getHtmlElement().find(".pkpUploaderError").html(a)};a.pkp.controllers.UploaderHandler.prototype.refreshUploader=function(a,b){b.refresh()};a.pkp.controllers.UploaderHandler.prototype.updateStatus=function(a){this.getHtmlElement().removeClass("loading waiting uploading error complete").addClass(a)};a.pkp.controllers.UploaderHandler.DEFAULT_PROPERTIES_={runtimes:"html5,flash,silverlight,html4",max_file_size:a.pkp.cons.UPLOAD_MAX_FILESIZE,
multi_selection:!1,file_data_name:"uploadedFile",multipart:!0,headers:{browser_user_agent:navigator.userAgent},browse_button:"pkpUploaderButton",drop_element:"pkpUploaderDropZone"}})(jQuery);(function(a){a.pkp.controllers.AutocompleteHandler=function(c,b){var d;this.parent(c,b);this.sourceUrl_=b.sourceUrl;b.sourceUrl=void 0;this.jLabelText_=b.jLabelText;this.disableSync_=b.disableSync;d={};d.source=this.callbackWrapper(this.fetchAutocomplete);d.appendTo="#"+c.attr("id");d=a.extend({},this.self("DEFAULT_PROPERTIES_"),d,b);this.textInput=c.find(":text");this.disableSync_||this.textInput.keyup(this.callbackWrapper(this.synchronizeFields_));this.textInput.autocomplete(d);this.textInput.attr("title",
...
function(a){var b="",d,e;for(d in a)for(e in a[d])b+=a[d][e];return b};a.pkp.controllers.NotificationHandler.prototype.getTrivialNotifications_=function(a){var b=[],d,e;for(d in a)if(1==d)for(e in a[d])b.push(e);return b};a.pkp.controllers.NotificationHandler.prototype.addTimerToNotifications=function(c){var b=function(){a(this).remove()};c.length&&(this.trivialTimer_=setTimeout(function(){var d,e;for(d in c)e=a("#pkp_notification_"+c[d]),e.fadeOut(400,b())},6E3))}})(jQuery);(function(a){a.pkp.controllers.form=a.pkp.controllers.form||{};a.pkp.controllers.form.FormHandler=function(c,b){var d;this.parent(c,b);if(!c.is("form"))throw Error("A form handler controller can only be bound to an HTML form element!");b.submitHandler&&(this.callerSubmitHandler_=b.submitHandler);a(".datepicker").datepicker({dateFormat:"yy-mm-dd"});b.cancelRedirectUrl&&(this.cancelRedirectUrl_=b.cancelRedirectUrl);"undefined"!==typeof b.trackFormChanges&&(this.trackFormChanges=b.trackFormChanges);
b.disableControlsOnSubmit&&(this.disableControlsOnSubmit=b.disableControlsOnSubmit);b.enableDisablePairs&&(this.enableDisablePairs_=b.enableDisablePairs,this.setupEnableDisablePairs());for(d in this.enableDisablePairs_)c.find("[id^='"+d+"']").trigger("updatePair");d=c.validate({onfocusout:this.callbackWrapper(this.onFocusOutValidation_),errorClass:"error",highlight:function(c,b){a(c).parent().parent().addClass(b)},unhighlight:function(c,b){a(c).parent().parent().removeClass(b)},submitHandler:this.callbackWrapper(this.submitHandler_),
showErrors:this.callbackWrapper(this.showErrors)});a("[id^='cancelFormButton-']",c).click(this.callbackWrapper(this.cancelForm));c.find(".showMore, .showLess").bind("click",this.switchViz);d.checkForm()?this.trigger("formValid"):this.trigger("formInvalid");this.initializeTinyMCE();a("[id^='submitFormButton']",c).click(this.callbackWrapper(this.pushTinyMCEChanges_));a(":input",c).change(this.callbackWrapper(this.formChange));this.bind("formChange",this.callbackWrapper(this.formChange));c.click(this.callbackWrapper(this.hideDatepicker_));
this.publishEvent("tinyMCEInitialized");this.bind("tinyMCEInitialized",this.tinyMCEInitHandler_);this.bind("containerClose",this.containerCloseHandler)};a.pkp.classes.Helper.inherits(a.pkp.controllers.form.FormHandler,a.pkp.classes.Handler);a.pkp.controllers.form.FormHandler.prototype.disableControlsOnSubmit=!1;a.pkp.controllers.form.FormHandler.prototype.trackFormChanges=!0;a.pkp.controllers.form.FormHandler.prototype.callerSubmitHandler_=null;a.pkp.controllers.form.FormHandler.prototype.cancelRedirectUrl_=
null;a.pkp.controllers.form.FormHandler.prototype.formChangesTracked=!1;a.pkp.controllers.form.FormHandler.prototype.enableDisablePairs_=null;a.pkp.controllers.form.FormHandler.prototype.showErrors=function(c){"undefined"!==typeof tinyMCE&&tinyMCE.EditorManager.triggerSave();var b=a.extend(!0,{},c);setTimeout(this.callbackWrapper(function(){b.defaultShowErrors();b=null}),250);c.checkForm()?this.trigger("formValid"):(this.trigger("formInvalid"),this.enableFormControls())};a.pkp.controllers.form.FormHandler.prototype.formChange=
...
"json")};a.pkp.controllers.grid.GridHandler.prototype.deleteElement=function(a,b){var d,e,f;if(1!==a.length)throw Error("There were "+a.length+" rather than 1 element to delete!");a.addClass("gridRowDeleted");d=!1;1==this.getElementsByType(a).length&&(d=!0);a.hasClass("gridRow")&&this.deleteControlsRow_(a);e=this.getEmptyElement(a);f=function(){a.remove();d&&e.fadeIn(500)};void 0!=b&&b?f():a.fadeOut(500,f)};a.pkp.controllers.grid.GridHandler.prototype.initialize=function(c){var b;this.bind("dataChanged",
...
null),"json")}),0);return!1};a.pkp.controllers.listbuilder.ListbuilderHandler.prototype.deleteItemHandler_=function(c){this.closeEdits();var b=a(c),c=b.closest(".gridRow"),b=b.closest(".pkp_controllers_listbuilder").find(".deletions"),d=c.find('input[name="rowId"]').val();void 0!==d&&(b.val(b.val()+" "+d),this.getHtmlElement().trigger("formChange"));this.deleteElement(c);return!1};a.pkp.controllers.listbuilder.ListbuilderHandler.prototype.appendRowResponseHandler_=function(c,b){var d=this.handleJson(b);
...
function(c,b){var d=this.handleJson(b),e=this.getHtmlElement(),f=[],g,h,j,s,i,n,m,q,l,t;if(!1!==d){e.find(".gridCellDisplay :input").each(function(c,b){f[c]=a(b).val()});e=e.find(".gridRowEdit:visible .selectMenu:input");g=0;for(h=e.length;g<h;g++){j=a(e[g]);s=j.parents(".gridCellContainer");i=0;j.children().empty();n=null;for(n in d.content[g])if(n!=a.pkp.cons.LISTBUILDER_OPTGROUP_LABEL)if("object"==typeof d.content[g][n]){if(void 0!==d.content[g][a.pkp.cons.LISTBUILDER_OPTGROUP_LABEL]&&"object"==
typeof d.content[g][a.pkp.cons.LISTBUILDER_OPTGROUP_LABEL]&&(q=d.content[g][a.pkp.cons.LISTBUILDER_OPTGROUP_LABEL][n])){l=a("<optgroup></optgroup>");l.attr("label",q);j.append(l);q=null;t=0;for(q in d.content[g][n])if(m=this.populatePulldown_(l,f,d.content[g][n][q],q))i++,t++;0===t&&l.remove()}}else(m=this.populatePulldown_(j,f,d.content[g][n],n))&&i++;j=m;1===i&&j&&j.attr("selected","selected");0===i&&(s.find(".gridCellDisplay").show(),s.find(".gridCellEdit").hide())}}this.enableControls();return!1};
a.pkp.controllers.listbuilder.ListbuilderHandler.prototype.populatePulldown_=function(c,b,d,e){var f=c.parents(".gridCellContainer").find(".gridCellDisplay :input").val(),g=!1,h;if(e!=f)for(h=0;h<b.length;h++)b[h]==e&&(g=!0);if(g)return!1;b=a("<option/>");b.attr("value",e);b.text(d);e==f&&b.attr("selected","selected");c.append(b);return b};a.pkp.controllers.listbuilder.ListbuilderHandler.prototype.editItemHandler_=function(c){this.closeEdits();this.editItemCallingContext_=c;setTimeout(this.callbackWrapper(function(){var c=
a(this.editItemCallingContext_).closest(".gridRow");c.addClass("gridRowEdit");c.find(":input").not('[type="hidden"]').first().focus();this.sourceType_==a.pkp.cons.LISTBUILDER_SOURCE_TYPE_SELECT&&(this.disableControls(),a.get(this.fetchOptionsUrl_,{},this.callbackWrapper(this.fetchOptionsResponseHandler_,null),"json"))}),0);return!1};a.pkp.controllers.listbuilder.ListbuilderHandler.prototype.buildParamsFromInputs_=function(c){var b={};a.each(c.serializeArray(),function(c,e){var f=e.name,g=e.value;
b[f]=void 0===b[f]?g:a.isArray(b[f])?b[f].concat(g):[b[f],g]});return b};a.pkp.controllers.listbuilder.ListbuilderHandler.prototype.inputKeystrokeHandler_=function(c,b){var d,e,f;return 13==b.which?(d=a(c),e=d.parents(".gridRow"),f=e.find(":input:visible"),d=f.index(d),f.length==d+1?this.saveRow(e):f[d+1].focus(),!1):!0};a.pkp.controllers.listbuilder.ListbuilderHandler.prototype.inputBlurHandler_=function(c){a(c).closest(".gridRow").addClass("editingRowPlaceholder");setTimeout(this.callbackWrapper(function(){var c=
a(".editingRowPlaceholder"),d=!1;c.find(":input").each(function(a,c){c===document.activeElement&&(d=!0)});c.removeClass("editingRowPlaceholder");d||this.closeEdits()}),0);return!0};a.pkp.controllers.listbuilder.ListbuilderHandler.prototype.saveRowResponseHandler_=function(c,b){var d=this.handleJson(b),e;!1!==d&&(d=a(d.content),e=this.getHtmlElement().find(".saveRowResponsePlaceholder").attr("id"),this.getHtmlElement().find(".saveRowResponsePlaceholder").replaceWith(d),d.attr("id",e),this.attachContentHandlers_(d),
...
this.options.closeButtonText+"</span></a>");c.append('<div class="content"></div>');c.attr("role","dialog").attr("aria-label",this.options.title);return c};a.pkp.controllers.modal.ModalHandler.prototype.modalOpen=function(c){a("body").append(c);setTimeout(function(){c.addClass("is_visible")},10);setTimeout(function(){c.focus()},300);c.trigger("pkpModalOpen",[c])};a.pkp.controllers.modal.ModalHandler.prototype.modalClose=function(){var a=this,b=this.getHtmlElement(),d=b.find("form").first();1==d.length&&
d.trigger("containerClose");b.removeClass("is_visible");this.trigger("pkpModalClose");setTimeout(function(){a.getHtmlElement().empty();a.remove()},300);return!1};a.pkp.controllers.modal.ModalHandler.prototype.handleWrapperEvents=function(c,b){"click"==b.type&&c==b.target?a.pkp.classes.Handler.getHandler(a(c)).modalClose():"keyup"==b.type&&27==b.which&&a.pkp.classes.Handler.getHandler(a(c)).modalClose()};a.pkp.controllers.modal.ModalHandler.prototype.redirectNotifyUserEventHandler_=function(c,b,d){a.pkp.classes.notification.NotificationHelper.redirectNotifyUserEvent(this,
...
a.pkp.controllers.wizard.WizardHandler.prototype.$continueButton_=null;a.pkp.controllers.wizard.WizardHandler.prototype.$progressIndicator_=null;a.pkp.controllers.wizard.WizardHandler.prototype.continueButtonText_=null;a.pkp.controllers.wizard.WizardHandler.prototype.finishButtonText_=null;a.pkp.controllers.wizard.WizardHandler.prototype.enforceLinear_=null;a.pkp.controllers.wizard.WizardHandler.prototype.continueRequest=function(){var c=new a.Event("wizardAdvanceRequested");this.getCurrentTab().children().first().trigger(c);
c.isDefaultPrevented()||this.advanceOrClose_();return!1};a.pkp.controllers.wizard.WizardHandler.prototype.formValid=function(){this.enableContinueButton()};a.pkp.controllers.wizard.WizardHandler.prototype.formInvalid=function(){this.disableContinueButton()};a.pkp.controllers.wizard.WizardHandler.prototype.formSubmitted=function(){this.advanceOrClose_()};a.pkp.controllers.wizard.WizardHandler.prototype.cancelRequest=function(){this.checkForm_(!1);var c=new a.Event("wizardCancelRequested");this.getCurrentTab().children().first().trigger(c);
c.isDefaultPrevented()||this.trigger("wizardCancel");return!1};a.pkp.controllers.wizard.WizardHandler.prototype.wizardCancelRequested=function(){return this.checkForm_(!0)?!1:!0};a.pkp.controllers.wizard.WizardHandler.prototype.wizardAdvanceRequested=function(a,b){var d=this.getForm_();d&&(d.submit()&&(this.disableContinueButton(),this.getProgressIndicator().show()),b.preventDefault())};a.pkp.controllers.wizard.WizardHandler.prototype.wizardAdvance=function(){var a=this.getCurrentStep(),b=this.getNumberOfSteps()-
1,d=a+1,e;if(d>b)throw Error("Trying to set an invalid wizard step!");e=this.getHtmlElement();e.tabs("enable",d);e.tabs("option","active",d);this.enforceLinear_&&e.tabs("disable",a);a=this.getContinueButton();d===b&&a.text(this.getFinishButtonText());this.getProgressIndicator().hide();this.enableContinueButton()};a.pkp.controllers.wizard.WizardHandler.prototype.startWizard=function(){var a=this.getHtmlElement(),b,d;0!==this.getCurrentStep()&&(a.tabs("enable",0),a.tabs("option","active",0),b=this.getContinueButton(),
b.text(this.getContinueButtonText()));if(this.enforceLinear_){b=[];for(d=1;d<this.getNumberOfSteps();d++)b.push(d);a.tabs("option","disabled",b)}};a.pkp.controllers.wizard.WizardHandler.prototype.bindWizardEvents=function(){this.bind("wizardCancelRequested",this.wizardCancelRequested);this.bind("wizardAdvanceRequested",this.wizardAdvanceRequested);this.bind("wizardAdvance",this.wizardAdvance)};a.pkp.controllers.wizard.WizardHandler.prototype.getCurrentStep=function(){return this.getCurrentTabIndex()};
a.pkp.controllers.wizard.WizardHandler.prototype.getContinueButton=function(){return this.$continueButton_};a.pkp.controllers.wizard.WizardHandler.prototype.getProgressIndicator=function(){return this.$progressIndicator_};a.pkp.controllers.wizard.WizardHandler.prototype.getContinueButtonText=function(){return this.continueButtonText_};a.pkp.controllers.wizard.WizardHandler.prototype.getFinishButtonText=function(){return this.finishButtonText_};a.pkp.controllers.wizard.WizardHandler.prototype.getNumberOfSteps=
function(){return this.getHtmlElement().find("ul").first().children().length};a.pkp.controllers.wizard.WizardHandler.prototype.getForm_=function(){var c,b,d;d=this.getCurrentTab().children();for(c=0;c<d.length;c++)if(b=a(d[c]),b.is("form"))return b;return null};a.pkp.controllers.wizard.WizardHandler.prototype.advanceOrClose_=function(){var a=this.getCurrentStep(),b=this.getNumberOfSteps()-1;a<b?this.trigger("wizardAdvance"):this.trigger("wizardClose")};a.pkp.controllers.wizard.WizardHandler.prototype.checkForm_=
function(c){var b=this.getForm_();if(null!==b)if(b=a.pkp.classes.Handler.getHandler(a("#"+b.attr("id"))),c){if(b.formChangesTracked)if(confirm(a.pkp.locale.form_dataHasChanged))b.unregisterForm();else return!0}else b.unregisterForm();return!1};a.pkp.controllers.wizard.WizardHandler.prototype.addWizardButtons_=function(c,b){var d=a('<div id="wizardButtons" class="modal-buttons"></div>'),e,f;b.cancelButtonText&&(e=a('<a id="cancelButton" href="#"></a>').text(b.cancelButtonText),d.append(e),e.bind("click",
this.callbackWrapper(this.cancelRequest)));b.continueButtonText&&(e=a('<button id="continueButton" class="pkp_button"></button>').text(b.continueButtonText),d.append(e),f=a('<span class="pkp_spinner"></span>'),d.append(f),e.bind("click",this.callbackWrapper(this.continueRequest)),this.$continueButton_=e,this.$progressIndicator_=f,this.continueButtonText_=b.continueButtonText,this.finishButtonText_=b.finishButtonText?b.finishButtonText:b.continueButtonText);c.after(d)};a.pkp.controllers.wizard.WizardHandler.prototype.disableContinueButton=
...
e.tabs("enable",d);e.tabs("option","active",d);0===a&&e.tabs("disable",a);d===b&&(a=this.getContinueButton(),a.text(this.getFinishButtonText()),this.enableContinueButton())};a.pkp.controllers.wizard.fileUpload.FileUploadWizardHandler.prototype.tabsLoad=function(c,b,d){var e=this.getHtmlElement(),f=this.getProgressIndicator();if(2===d.tab.index()){e=a("#newFile",e);if(1!==e.length)throw Error('Did not find "new file" button!');e.button();e.bind("click",this.callbackWrapper(this.startWizard))}f.hide();
return this.parent("tabsLoad",c,b,d)};a.pkp.controllers.wizard.fileUpload.FileUploadWizardHandler.prototype.formValid=function(a,b){0===this.getCurrentStep()&&0===this.getHtmlElement().find("#uploadConfirmationForm").length&&!this.uploadedFile_||this.parent("formValid",a,b)};a.pkp.controllers.wizard.fileUpload.FileUploadWizardHandler.prototype.wizardCancelRequested=function(c,b){if(this.parent("wizardCancelRequested",c,b))if(this.uploadedFile_)a.post(this.deleteUrl_,this.uploadedFile_,a.pkp.classes.Helper.curry(this.wizardCancelSuccess,
this,c,b),"json"),this.uploadedFile_=null,b.preventDefault();else return!0;return!1};a.pkp.controllers.wizard.fileUpload.FileUploadWizardHandler.prototype.wizardCancelSuccess=function(a,b,d){!1!==this.handleJson(d)&&this.trigger("wizardCancel")};a.pkp.controllers.wizard.fileUpload.FileUploadWizardHandler.prototype.handleFileUploaded=function(a,b,d){this.uploadedFile_=d};a.pkp.controllers.wizard.fileUpload.FileUploadWizardHandler.prototype.handleRemovedFiles=function(c,b,d,e){var f;if("undefined"!==
typeof e&&e.length)for(f in e){if("undefined"===typeof e[f].storedData)break;a.post(this.deleteUrl_,e[f].storedData)}};a.pkp.controllers.wizard.fileUpload.FileUploadWizardHandler.prototype.startWizard=function(){this.uploadedFile_=null;this.parent("startWizard")}})(jQuery);(function(a){a.pkp.controllers.wizard.fileUpload.form=a.pkp.controllers.wizard.fileUpload.form||{};a.pkp.controllers.wizard.fileUpload.form.FileUploadFormHandler=function(a,b){this.parent(a,b);this.hasFileSelector_=b.hasFileSelector;this.hasGenreSelector_=b.hasGenreSelector;b.presetRevisedFileId&&(this.presetRevisedFileId_=b.presetRevisedFileId);this.fileGenres_=b.fileGenres;this.$uploader_=b.$uploader;this.attachUploader_(this.$uploader_,b.uploaderOptions);this.uploaderSetup(b.$uploader);this.$revisedFileSelector_=
...
"json")}};a.pkp.controllers.tab.representations.RepresentationsTabHandler.prototype.updateTabsHandler_=function(a,b){this.trigger("gridRefreshRequested");var d=this.handleJson(b),e=this.getHtmlElement();!1!==d&&e.replaceWith(d.content)}})(jQuery);jQuery.pkp.controllers.informationCenter=jQuery.pkp.controllers.informationCenter||{};
...
function(){var c,b={};c=a(this.timeFilterWrapperSelector_,this.getHtmlElement()).serializeArray();a.each(c,function(a,c){b[c.name]=c.value});c=a("option:selected",this.$metricTypeSelectElement_);void 0!==c[0]&&void 0!==c[0].value&&(b.metricType=c[0].value);c=a("option:selected",this.$reportTemplateSelectElement_);void 0!==c[0]&&void 0!==c[0].value&&(b.reportTemplate=c[0].value);b.refreshForm=!0;a.get(this.fetchFormUrl_,b,this.callbackWrapper(this.handleResponse,null),"json");return!1};a.pkp.controllers.statistics.ReportGeneratorFormHandler.prototype.updateFileTypeSelectHandler_=
function(c){var b,c=a(c),c=a("option:selected",c);if(1==c.length)for(b in c=c[0].value,this.fileAssocTypes_)if(this.fileAssocTypes_[b]==c)return this.$fileTypeSelectElement_.removeAttr("disabled"),!1;this.$fileTypeSelectElement_.attr("disabled","disabled");return!1};a.pkp.controllers.statistics.ReportGeneratorFormHandler.prototype.fetchRegionHandler_=function(c){this.$regionSelectElement_.empty();c=a(c);c=a("option:selected",c);1==c.length&&(c=c[0].label,a.get(this.fetchRegionsUrl_,{countryId:c},
this.callbackWrapper(this.updateRegionSelectCallback_,null),"json"));return!1};a.pkp.controllers.statistics.ReportGeneratorFormHandler.prototype.updateRegionSelectCallback_=function(c,b){var d,e,f,g;d=this.$regionSelectElement_;d.empty();e=this.handleJson(b);if(!1!==e){f=e.content;g=0;for(e=f.length;g<e;g++)d.append(a("<option />").val(f[g].id).text(f[g].name))}return!1};a.pkp.controllers.statistics.ReportGeneratorFormHandler.prototype.currentTimeElementsClickHandler_=function(){this.dateRangeElementsWrapper_.hide();
return!0};a.pkp.controllers.statistics.ReportGeneratorFormHandler.prototype.rangeTimeElementsClickHandler_=function(c){var b=a(this.startDayElementSelector_).add(this.endDayElementSelector_);this.dateRangeElementsWrapper_.show();"#"+a(c).attr("id")==this.rangeByDaySelector_&&b.show();"#"+a(c).attr("id")==this.rangeByMonthSelector_&&b.hide();return!0};a.pkp.controllers.statistics.ReportGeneratorFormHandler.prototype.aggregationOptionsChangeHandler_=function(c){var b;b=a(this.columnsSelector_);c=a(c);
b=b.find('option[value="'+c.attr("value")+'"]');c.attr("checked")?b.attr("selected","selected"):b.removeAttr("selected");return!1};a.pkp.controllers.statistics.ReportGeneratorFormHandler.prototype.addOptionalColumnsClass_=function(){var c,b,d,e;d=a(this.columnsSelector_);e=a(this.aggregationOptionsSelector_);b=a("#orderByFormArea select",this.getHtmlElement());d=d.add(b);b=this.optionalColumns_;for(c in b)d.find('option[value="'+c+'"]').addClass("optionalColumn"),e.filter('input[value="'+c+'"]').parent().addClass("optionalColumn")}})(jQuery);(function(a){a.pkp.controllers.dashboard=a.pkp.controllers.dashboard||{form:{}};a.pkp.controllers.dashboard.form.DashboardTaskFormHandler=function(c,b){this.parent(c,b);this.singleContextSubmissionUrl_=b.singleContextSubmissionUrl;a("#singleContext",c).click(this.callbackWrapper(this.startSingleContextSubmission_));a("#multipleContext",c).change(this.callbackWrapper(this.startMultipleContextSubmission_))};a.pkp.classes.Helper.inherits(a.pkp.controllers.dashboard.form.DashboardTaskFormHandler,a.pkp.controllers.form.FormHandler);
...
function(c,b,d){c=a(b.target,this.getHtmlElement()).children("a");c.length&&c.attr("id").match(/submissionEntry/)&&(c=a('[id^="formatsGridContainer"]',this.getHtmlElement()).children("div"),c.trigger("dataChanged",[d]),c.trigger("notifyUser",[c]))}})(jQuery);(function(a){a.pkp.pages.workflow.SubmissionHeaderHandler=function(a,b){this.parent(a,b);this.bind("gridRefreshRequested",this.refreshWorkflowContent_);this.publishEvent("stageParticipantsChanged");this.participantToggleSelector_=b.participantToggleSelector};a.pkp.classes.Helper.inherits(a.pkp.pages.workflow.SubmissionHeaderHandler,a.pkp.classes.Handler);a.pkp.pages.workflow.SubmissionHeaderHandler.prototype.participantToggleSelector_=null;a.pkp.pages.workflow.SubmissionHeaderHandler.prototype.refreshWorkflowContent_=
function(c,b){a(b.target).attr("id").match(/^stageParticipantGridContainer/)&&(this.trigger("stageParticipantsChanged"),a(this.participantToggleSelector_).click())}})(jQuery);(function(a){a.pkp.pages.workflow.EditorDecisionsHandler=function(c,b){this.parent(c,b);a("a",c).button()};a.pkp.classes.Helper.inherits(a.pkp.pages.workflow.EditorDecisionsHandler,a.pkp.classes.Handler)})(jQuery);(function(a){a.pkp.controllers.grid.users=a.pkp.controllers.grid.users||{reviewer:{form:{}}};a.pkp.controllers.grid.users.reviewer.AdvancedReviewerSearchHandler=function(c,b){this.parent(c,b);c.find(".button").button();a("#selectReviewerButton").click(this.callbackWrapper(this.reviewerSelected));a("#regularReviewerForm").hide();this.bind("refreshForm",this.handleRefresh_)};a.pkp.classes.Helper.inherits(a.pkp.controllers.grid.users.reviewer.AdvancedReviewerSearchHandler,a.pkp.classes.Handler);a.pkp.controllers.grid.users.reviewer.AdvancedReviewerSearchHandler.prototype.reviewerSelected=
...
!1!==e&&""!==e.content&&d.find('textarea[name="personalMessage"]').val(e.content);return e.status}})(jQuery);(function(a){a.pkp.controllers.grid.users.stageParticipant=a.pkp.controllers.grid.users.stageParticipant||{form:{}};a.pkp.controllers.grid.users.stageParticipant.form.StageParticipantNotifyHandler=function(a,b){this.parent(a,b);b.templateUrl&&(this.templateUrl_=b.templateUrl);a.find("#template").change(this.callbackWrapper(this.selectTemplateHandler_))};a.pkp.classes.Helper.inherits(a.pkp.controllers.grid.users.stageParticipant.form.StageParticipantNotifyHandler,a.pkp.controllers.form.AjaxFormHandler);
...
e=this.handleJson(b),f=b.content,d=d.find('textarea[name="message"]'),g=tinyMCE.EditorManager.get(d.attr("id"));d.attr("data-variables",JSON.stringify(f.variables));g.setContent(f.body);return e.status}})(jQuery);(function(a){a.pkp.controllers.grid.users.stageParticipant.form=a.pkp.controllers.grid.users.stageParticipant.form||{};a.pkp.controllers.grid.users.stageParticipant.form.AddParticipantFormHandler=function(c,b){this.parent(c,b);this.fetchUserListUrl_=b.fetchUserListUrl;a("#userGroupId",c).change(this.callbackWrapper(this.updateUserList));this.updateUserList()};a.pkp.classes.Helper.inherits(a.pkp.controllers.grid.users.stageParticipant.form.AddParticipantFormHandler,a.pkp.controllers.grid.users.stageParticipant.form.StageParticipantNotifyHandler);
...
function(a,b){var d=this.handleJson(b),e=this.getHtmlElement(),f=e.find("li a"),g={},h=/galley(\d+)/,j,s,i;for(s=0;s<f.length;s++)i=f[s].getAttribute("id"),i=h.exec(i),null!==i&&(g[i[1]]=s);for(j in d.galleys)g.hasOwnProperty(j)||(f=this.tabContentUrl_+"&galleyId="+encodeURIComponent(j),f=f.replace(/[$]/g,"$$$$"),e.tabs("add",f,d.galleys[j]),e.find("li a").filter(":last").attr("id","galley"+j));for(j in g)d.galleys.hasOwnProperty(j)?e.find("li a").filter('[id="galley'+j+'"]').html(d.galleys[j]):e.tabs("remove",
g[j])};a.pkp.controllers.tab.issueEntry.IssueEntryTabHandler.prototype.addGalleysGridRowActionHandlers_=function(){var c=a('[id^="galleysGridContainer"]',this.getHtmlElement());c.length&&(c=a('a[id*="galleyTab"]',c),c.click(this.callbackWrapper(this.galleysGridLinkClickHandler_)))};a.pkp.controllers.tab.issueEntry.IssueEntryTabHandler.prototype.galleysGridLinkClickHandler_=function(c){var b=a('[id^="galleysGridContainer"]',this.getHtmlElement()).children("div"),b=a.pkp.classes.Handler.getHandler(b),
c=b.getParentRow(a(c)),c=b.getRowDataId(c);this.getHtmlElement().tabs({active:this.getTabPositionByGalleyId_(c,this.getHtmlElement())})};a.pkp.controllers.tab.issueEntry.IssueEntryTabHandler.prototype.getTabPositionByGalleyId_=function(c,b){var d=a("#galley"+c,b).parent("li");return d.length?b.find("li").index(d):null};a.pkp.controllers.tab.issueEntry.IssueEntryTabHandler.prototype.tabsReloadRequested=function(){this.getHtmlElement().trigger("formSubmitted")}})(jQuery);(function(a){a.pkp.controllers.tab.issueEntry.form=a.pkp.controllers.tab.issueEntry.form||{};a.pkp.controllers.tab.issueEntry.form.IssueEntryPublicationMetadataFormHandler=function(c,b){this.parent(c,b);a('input[id^="datePublished"]',c).datepicker({dateFormat:"yy-mm-dd",minDate:"0",autoSize:!0});a("#paymentReceivedButton",c).click(this.callbackWrapper(this.paymentReceivedHandler));a("#waivePaymentButton",c).click(this.callbackWrapper(this.waivePaymentHandler));b.arePermissionsAttached&&c.find("#attachPermissions").prop("checked",
!0);a("#issueId",c).change(this.callbackWrapper(this.checkAttachMetadata));a('input[id^="copyrightHolder-"]',c).keyup(this.callbackWrapper(this.checkAttachMetadata));a('input[id^="copyrightYear-"]',c).keyup(this.callbackWrapper(this.checkAttachMetadata));a('input[id^="licenseURL-"]',c).keyup(this.callbackWrapper(this.checkAttachMetadata))};a.pkp.classes.Helper.inherits(a.pkp.controllers.tab.issueEntry.form.IssueEntryPublicationMetadataFormHandler,a.pkp.controllers.form.AjaxFormHandler);a.pkp.controllers.tab.issueEntry.form.IssueEntryPublicationMetadataFormHandler.prototype.paymentReceivedHandler=
...
!0)}})(jQuery);(function(a){a.pkp.pages.search=a.pkp.pages.search||{};a.pkp.pages.search.SearchFormHandler=function(c,b){0===c.find('input[name="query_input"]').length&&c.find('input[name="query"]');b.submitHandler=this.submitForm;b.trackFormChanges=b.instantSearch;b.transformButtons=!1;this.parent(c,b);!0===b.instantSearch&&a(":input",c).keyup(this.callbackWrapper(this.instantSearch))};a.pkp.classes.Helper.inherits(a.pkp.pages.search.SearchFormHandler,a.pkp.controllers.form.FormHandler);a.pkp.pages.search.SearchFormHandler.instantSearchTimeout=
null;a.pkp.pages.search.SearchFormHandler.prototype.instantSearch=function(){var c;this.formChangesTracked=!1;clearTimeout(this.instantSearchTimeout);this.instantSearchTimeout=setTimeout(this.callbackWrapper(function(){this.hasData_(3)&&(this.setInstantSearch_(!0),c=this.getHtmlElement(),a.post(c.attr("action"),c.serialize(),this.callbackWrapper(this.handleInstantSearchResponse),"html"))}),500)};a.pkp.pages.search.SearchFormHandler.prototype.handleInstantSearchResponse=function(c,b){"<tr>"==b.trim().substr(0,
4)&&a("#results table.listing").html(b)};a.pkp.pages.search.SearchFormHandler.prototype.submitForm=function(c){this.hasData_(1)?(this.setInstantSearch_(!1),this.submitFormWithoutValidation(c)):alert(a.pkp.locale.search_noKeywordError)};a.pkp.pages.search.SearchFormHandler.prototype.hasData_=function(a){var b,d=!1,e,f,g;b=this.getHtmlElement();e="query authors title abstract discipline subject type coverage indexTerms galleyFullText".split(" ");f=0;for(g=e.length;f<g&&!(d=b.find('input[name="'+e[f]+
'"]').val().length,d=d>=a);f++);return d};a.pkp.pages.search.SearchFormHandler.prototype.setInstantSearch_=function(c){var b=a("#instantSearch");0===b.length&&!0===c&&(b=a("<input>").attr({type:"hidden",id:"instantSearch",name:"instantSearch"}).appendTo(this.getHtmlElement()));0<b.length&&b.val(c?"1":"0")}})(jQuery);(function(a){a.pkp.plugins.generic.lucene=a.pkp.plugins.generic.lucene||{};a.pkp.plugins.generic.lucene.LuceneAutocompleteHandler=function(a,b){b.minLength=1;b.searchForm=b.searchForm||"searchForm";this.searchForm_=b.searchForm;this.parent(a,b)};a.pkp.classes.Helper.inherits(a.pkp.plugins.generic.lucene.LuceneAutocompleteHandler,a.pkp.controllers.AutocompleteHandler);a.pkp.plugins.generic.lucene.LuceneAutocompleteHandler.prototype.searchForm_="";a.pkp.plugins.generic.lucene.LuceneAutocompleteHandler.prototype.fetchAutocomplete=
