...
/**
 * @file qrBlock.inc.php
 *
 * Copyright (c) 2003-2011 John Willinsky
 * Distributed under the GNU GPL v2. For full terms see the file docs/COPYING.
 *
 * @class qrBlock
 * @ingroup plugins_blocks_qrBlock
 *
 * @brief Class for "QR" block plugin
 */
...
class qrBlock extends BlockPlugin {
	/**
	...
	function getDisplayName() {
		return Locale::translate('plugins.block.qrBlock.displayName');
	}
	...
	function getDescription() {
		return Locale::translate('plugins.block.qrBlock.description');
	}
