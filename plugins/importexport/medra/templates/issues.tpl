 ...
 *}
{strip}
{assign var="pageTitle" value="plugins.importexport.medra.export.selectIssue"}
{assign var="pageCrumbTitle" value="plugins.importexport.medra.export.selectIssue"}
...
<div id="issues">
	<form action="{plugin_url path="exportIssues"}" method="post" name="issues">
		<table width="100%" class="listing">
			...
			{if $noIssues == "true"}
				<tr>
					<td colspan="5" class="nodata">{translate key="plugins.importexport.medra.export.noIssues"}</td>
				</tr>
				<tr>
