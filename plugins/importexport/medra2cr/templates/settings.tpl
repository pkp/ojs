{**
 * @file plugins/importexport/medra2cr/templates/settings.tpl
 *
 * Copyright (c) 2013-2015 Simon Fraser University Library
 * Copyright (c) 2003-2015 John Willinsky
 * Distributed under the GNU GPL v2. For full terms see the file docs/COPYING.
 *
 * mEDRA2cr plugin settings
 *}
{strip}
...
<div id="medraSettings">
	...
	<div id="description"><b>{translate key="plugins.importexport.medra2cr.settings.form.description"}</b></div>
	...
	<form method="post" action="{plugin_url path="settings"}">
		<table width="100%" class="data">
			<tr valign="top">
				<td width="20%" class="label">{fieldLabel name="registrantName" required="true" key="plugins.importexport.medra2cr.settings.form.registrantName"}</td>
			...
			<tr valign="top">
				<td width="20%" colspan="2" class="label">{fieldLabel name="fromFields" key="plugins.importexport.medra2cr.settings.form.fromFields"}</td>
			</tr>
			<tr valign="top">
				<td width="20%" class="label">{fieldLabel name="fromCompany" required="true" key="plugins.importexport.medra2cr.settings.form.fromCompany"}</td>
				<td width="80%" class="value">
					<input type="text" name="fromCompany" value="{$fromCompany|escape}" size="20" maxlength="30" id="fromCompany" class="textField" />
				</td>
			</tr>
			<tr valign="top">
				<td width="20%" class="label">{fieldLabel name="fromName" required="true" key="plugins.importexport.medra2cr.settings.form.fromName"}</td>
				<td width="80%" class="value">
					<input type="text" name="fromName" value="{$fromName|escape}" size="20" maxlength="50" id="fromName" class="textField" />
				</td>
			</tr>
			<tr valign="top">
				<td width="20%" class="label">{fieldLabel name="fromEmail" required="true" key="plugins.importexport.medra2cr.settings.form.fromEmail"}</td>
				<td width="80%" class="value">
			...
			<tr><td colspan="2">&nbsp;</td></tr>
			<tr valign="top">
				<td width="20%" class="label">{fieldLabel name="publicationCountry" required="true" key="plugins.importexport.medra2cr.settings.form.publicationCountry"}</td>
				<td width="80%" class="value">
			...
			<tr valign="top">
				<td width="20%" class="label">
					...
					<label for="exportIssuesAs">{translate key="plugins.importexport.medra2cr.settings.form.exportIssuesAs"} *</label>
				</td>
				<td width="80%" class="value">
			...
			<tr valign="top">
				<td colspan="2">
					<span class="instruct">{translate key="plugins.importexport.medra2cr.intro"}</span>
				</td>
			</tr>
			<tr><td colspan="2">&nbsp;</td></tr>
			<tr valign="top">
				<td width="20%" class="label">{fieldLabel name="username" key="plugins.importexport.medra2cr.settings.form.username"}</td>
				<td width="80%" class="value">
