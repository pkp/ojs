{**
 * @file plugins/importexport/medra2cr/templates/index.tpl
 *
 ...
 *}
{strip}
{assign var="pageTitle" value="plugins.importexport.medra2cr.displayName"}
...
{translate key="plugins.importexport.medra2cr.settings.description" settingsUrl=$settingsUrl}
<br />
<br />
{translate key="plugins.importexport.medra2cr.intro"}
