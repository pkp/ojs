{**
 * plugins/importexport/vinnipoohPlugin/articleContext.tpl
 *
 ...
 *}
{strip}
{assign var="pageTitle" value="plugins.importexport.vinnipoohPlugin.import.articles"}
{include file="common/header.tpl"}
{/strip}

<p>{translate key="plugins.importexport.vinnipoohPlugin.import.articles.description"}</p>
