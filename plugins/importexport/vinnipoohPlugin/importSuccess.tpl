{**
 * plugins/importexport/vinnipoohPlugin/importSuccess.tpl
 *
 ...
 *}
{strip}
{assign var="pageTitle" value="plugins.importexport.vinnipoohPlugin.import.success"}
{include file="common/header.tpl"}
{/strip}
<div id="importSuccess">
<p>{translate key="plugins.importexport.vinnipoohPlugin.import.success.description"}</p>
