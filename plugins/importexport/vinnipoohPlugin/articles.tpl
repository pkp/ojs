{**
 * plugins/importexport/vinnipoohPlugin/articles.tpl
 *
 ...
 *}
{strip}
{assign var="pageTitle" value="plugins.importexport.vinnipoohPlugin.selectArticle"}
{assign var="pageCrumbTitle" value="plugins.importexport.vinnipoohPlugin.selectArticle"}
