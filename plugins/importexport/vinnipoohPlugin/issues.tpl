{**
 * plugins/importexport/vinnipoohPlugin/issues.tpl
 *
 ...
 *}
{strip}
{assign var="pageTitle" value="plugins.importexport.vinnipoohPlugin.selectIssue"}
{assign var="pageCrumbTitle" value="plugins.importexport.vinnipoohPlugin.selectIssue"}
