...
class DublinCoreMetaPlugin extends GenericPlugin
{
    ...
    public function articleView($hookName, $args)
    {
        ...
        $templateMgr->addHeader('dublinCoreSourceUri', '<meta name="DC.Source.URI" content="' . $request->getDispatcher()->url($request, PKPApplication::ROUTE_PAGE, $journal->getPath(), urlLocaleForPage: '') . '"/>');
