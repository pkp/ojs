...
class DataciteXmlFilter extends \PKP\plugins\importexport\native\filter\NativeExportFilter
{
     ...
     * Create titles node.
     */
    public function createTitlesNode(DOMDocument $doc, Issue $issue, Publication $publication, Galley $galley, SubmissionFile $galleyFile, array $objectLocalePrecedence): DOMNode
    {
        /** @var DataciteExportDeployment */
        $deployment = $this->getDeployment();
        /** @var DataciteExportPlugin */
     ...
     */
    public function createDatesNode(DOMDocument $doc, Issue $issue, Submission $article, Publication $publication, Galley $galley, SubmissionFile $galleyFile, string $publicationDate): DOMNode
    {
        /** @var DataciteExportDeployment */
        $deployment = $this->getDeployment();
        /** @var DataciteExportPlugin */
     ...
     */
    public function createSizesNode(DOMDocument $doc, Issue $issue, Submission $article, Publication $publication, Galley $galley, SubmissionFile $galleyFile): ?DOMNode
    {
        $deployment = $this->getDeployment();
        $sizes = [];
        switch (true) {
