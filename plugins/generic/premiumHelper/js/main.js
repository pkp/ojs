/**
 * Plugin Premium Helper - Analyse de résumé
 * 
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const analysisResults = document.getElementById('premiumHelperResults');
    
    // Vérifier que les éléments nécessaires sont présents
    if (!analyzeBtn || !abstractField || !analysisResults) {
        console.warn('Premium Helper: Certains éléments requis sont manquants dans le DOM');
        return;
    }
