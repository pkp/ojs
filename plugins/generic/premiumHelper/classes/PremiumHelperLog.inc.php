<?php
/**
 * @file classes/PremiumHelperLog.inc.php
 *
 * Copyright (c) 2024 Université de Montréal
 * Distributed under the GNU GPL v3. For full terms see the file docs/COPYING.
 *
 * @class PremiumHelperLog
...
import('plugins.generic.premiumHelper.PremiumHelperPlugin');

class PremiumHelperLog extends DataObject {
    /**
     * Constructeur
     */
