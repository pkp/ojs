<?php
/**
 * @file classes/PremiumHelperLogDAO.inc.php
 *
 * Copyright (c) 2024 Université de Montréal
 * Distributed under the GNU GPL v3. For full terms see the file docs/COPYING.
 *
 * @class PremiumHelperLogDAO
 * @ingroup plugins_generic_premiumHelper
 *
 * @brief Opérations de base de données pour les journaux d'activité du plugin
 */

import('lib.pkp.classes.db.DAO');
import('plugins.generic.premiumHelper.classes.PremiumHelperLog');

class PremiumHelperLogDAO extends DAO {
    /**
     * @copydoc DAO::_getCacheName()
     */
    protected function _getCacheName() {
        return 'premiumHelperLogs';
    }
    ...
    /**
     * Insère un nouvel objet de journal
     * 
     * @param PremiumHelperLog $log
     * @return int ID du journal inséré
     */
