...
{/if}
<tr>
	<td class="label">{fieldLabel name="degree" required="true" key="plugins.generic.thesis.form.degree"}</td>
...
<table class="data">
<tr>
	<td class="label">{fieldLabel name="discipline" key="plugins.generic.thesis.form.discipline"}</td>
