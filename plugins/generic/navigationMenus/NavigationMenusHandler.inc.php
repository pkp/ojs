...
/**
 * @file NavigationMenusHandler.inc.php
 *
 ...
 * @class NavigationMenusHandler
 * Find NavigationMenus content and display it when requested.
 */

import('classes.handler.Handler');

class NavigationMenusHandler extends Handler {
	/** @var NavigationMenusPlugin The NavigationMenus plugin */
	static $plugin;

	/** @var NavigationMenu The NavigationMenu to view */
	...
	/**
	 * Provide the NavigationMenus plugin to the handler.
	...
	/**
	 * Set a NavigationMenu to view.
	 * @param $navigationMenu NavigationMenu
	 */
	static function setPage($navigationMenu) {
