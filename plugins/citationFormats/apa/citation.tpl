...
{if $article->getPubId('doi')}doi:{$article->getPubId('doi')}{else}{translate key="plugins.citationFormats.apa.retrieved" retrievedDate=$smarty.now|date_format:$dateFormatLong url=$articleUrl}{/if}
</div>
