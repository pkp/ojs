...
<table width="100%" class="data">
	...
	<tr valign="top">
		...
		<td class="value">
			...
			<br />
			<input type="submit" name="clearURNs" value="{translate key="plugins.pubIds.urn.manager.settings.clearURNs"}" onclick="return confirm('{translate|escape:"jsparam" key="plugins.pubIds.urn.manager.settings.clearURNs.confirm"}')" class="action"/>
		</td>
	</tr>
</table>
