...
class ReviewAssignmentDAO extends DAO {
	...
	function insertReviewAssignment(&$reviewAssignment) {
		$this->update(
			'INSERT INTO review_assignments
				(article_id, reviewer_id, comments, recommendation, declined, replaced, date_assigned, date_notified, date_confirmed, date_completed, date_acknowledged)
				VALUES
				(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)',
			array(
	...
	/**
	 * Delete an article reviewer.
	 * @param $articleId int
	 * @param $reviewerId int
	 */
	function deleteArticleReviewer($articleId, $reviewerId) {
		return $this->update(
			'DELETE FROM review_assignments WHERE article_id = ? AND reviewer_id = ?',
			array(
				$articleId,
				$reviewerId
			)
	...
	/**
	 * Delete all reviewers for a specified article in a journal.
	 * @param $articleId int
	 */
	function deleteReviewersByArticleId($articleId) {
		return $this->update(
