...
abstract class PubObjectsExportPlugin extends ImportExportPlugin implements HasTaskScheduler
{
    ...
    public const EXPORT_STATUS_IN_PROCESSING = 'inProcessing';
    ...
    public function getStatusNames(): array
    {
        return [
            ...
            PubObjectsExportPlugin::EXPORT_STATUS_IN_PROCESSING => __('plugins.importexport.common.status.inProcessing'),
