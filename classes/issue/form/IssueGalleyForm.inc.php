...
class IssueGalleyForm extends Form {
	...
	function validate() {
		...
		if ($publicGalleyId && (is_numeric($publicGalleyId) || $journalDao->anyPubIdExists($journal->getId(), 'publisher-id', $publicGalleyId, ASSOC_TYPE_ISSUE_GALLEY, $this->getGalleyId()))) {
