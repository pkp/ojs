...
describe('Data suite tests', function() {
	it('Create a submission', function() {
		...
		cy.logout();
		cy.performReview('jjanssen', null, title, 'Revisions Required');
		cy.performReview('amccrae', null, title, 'Revisions Required');
		cy.performReview('agallego', null, title, 'Resubmit for Review');
		cy.findSubmissionAsEditor('dbarnes', null, title);
		cy.recordEditorialDecision('Request Revisions');
	});
});
