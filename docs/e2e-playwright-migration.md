...
| # | Feature | Home | Spec file | Cypress source | Tests | Ext? |
|---|---|---|---|---|---|---|
| 10 | Wizard — validation | lib/pkp | `wizard-validation.spec.js` | `SubmissionWizard.cy.js` tests 4–5 | E: required-field errors block submit; post-fix submit succeeds | — |
| 11 | Wizard — copyright gate | lib/pkp | `wizard-copyright-notice.spec.js` | `SubmissionWizard.cy.js` test 3 | E: notice renders; checkbox gates submit | — |
