...
<tr valign="top">
	...
	<td class="value"><input type="text" class="textField" name="authors[{$authorIndex}][firstName]" id="authors[{$authorIndex}][firstName]" value="{$author.firstName|escape}" size="20" maxlength="40" /></td>
</tr>
<tr valign="top">
	<td class="label">{fieldLabel name="authors[{$authorIndex][middleName]" key="user.middleName"}</td>
	<td class="value"><input type="text" class="textField" name="authors[{$authorIndex}][middleName]" id="authors[{$authorIndex}][middleName]" value="{$author.middleName|escape}" size="20" maxlength="40" /></td>
</tr>
<tr valign="top">
	<td class="label">{fieldLabel name="authors[$authorIndex][lastName]" required="true" key="user.lastName"}</td>
	<td class="value"><input type="text" class="textField" name="authors[{$authorIndex}][lastName]" id="authors[{$authorIndex}][lastName]" value="{$author.lastName|escape}" size="20" maxlength="90" /></td>
</tr>
<tr valign="top">
	<td class="label">{fieldLabel name="authors[$authorIndex][affiliation]" key="user.affiliation"}</td>
	<td class="value"><input type="text" class="textField" name="authors[{$authorIndex}][affiliation]" id="authors[{$authorIndex}][affiliation]" value="{$author.affiliation|escape}" size="30" maxlength="255"/></td>
</tr>
<tr valign="top">
	<td class="label">{fieldLabel name="authors[$authorIndex][email]" required="true" key="user.email"}</td>
	<td class="value"><input type="text" class="textField" name="authors[{$authorIndex}][email]" id="authors[{$authorIndex}][email]" value="{$author.email|escape}" size="30" maxlength="90" /></td>
</tr>
<tr valign="top">
	<td class="label">{fieldLabel name="authors[$authorIndex][biography]" key="user.biography"}</td>
	<td class="value"><textarea name="authors[{$authorIndex}][biography]" class="textArea" id="authors[{$authorIndex}][biography]" rows="5" cols="40">{$author.biography|escape}</textarea></td>
</tr>
{if $smarty.foreach.authors.total > 1}
<tr valign="top">
...
<tr valign="top">
	...
	<td class="value"><input type="text" class="textField" name="authors[0][affiliation]" id="authors[0][affiliation]" size="30" maxlength="255" /></td>
</tr>
<tr valign="top">
...
<tr valign="top">
	...
	<td class="value"><textarea name="authors[0][biography]" class="textArea" id="authors[0][biography]" rows="5" cols="40"></textarea></td>
</tr>
</table>
{/foreach}
...
<tr valign="top">
	...
	<td class="value"><input type="text" class="textField" name="titleAlt1" id="titleAlt1" value="{$titleAlt1|escape}" size="60" maxlength="255" /></td>
</tr>
{/if}
{if $alternateLocale2}
<tr valign="top">
	<td class="label">{fieldLabel name="titleAlt2" key="article.title"} ({$languageToggleLocales.$alternateLocale2})</td>
	<td class="value"><input type="text" class="textField" name="titleAlt2" id="titleAlt2" value="{$titleAlt2|escape}" size="60" maxlength="255" /></td>
</tr>
{/if}

<tr valign="top">
	<td class="label">{fieldLabel name="abstract" key="article.abstract"}</td>
	<td class="value"><textarea name="abstract" id="abstract" class="textArea" rows="15" cols="60">{$abstract|escape}</textarea></td>
</tr>
{if $alternateLocale1}
<tr valign="top">
	<td class="label">{fieldLabel name="abstractAlt1" key="article.abstract"} ({$languageToggleLocales.$alternateLocale1})</td>
	<td class="value"><textarea name="abstractAlt1" class="textArea" id="abstractAlt1" rows="15" cols="60">{$abstractAlt1|escape}</textarea></td>
</tr>
{/if}
{if $alternateLocale2}
<tr valign="top">
	<td class="label">{fieldLabel name="abstractAlt2" key="article.abstract"} ({$languageToggleLocales.$alternateLocale2})</td>
	<td class="value"><textarea name="abstractAlt2" class="textArea" id="abstractAlt2" rows="15" cols="60">{$abstractAlt2|escape}</textarea></td>
</tr>
{/if}
</table>
...
<tr valign="top">
	...
	<td class="value"><input type="text" class="textField" name="discipline" id="discipline" value="{$discipline|escape}" size="40" maxlength="255" /></td>
</tr>
...
<tr valign="top">
	...
	<td class="value"><input type="text" class="textField" name="subjectClass" id="subjectClass" value="{$subjectClass|escape}" size="40" maxlength="255" /></td>
</tr>
<tr valign="top">
...
<tr valign="top">
	...
	<td class="value"><input type="text" class="textField" name="subject" id="subject" value="{$subject|escape}" size="40" maxlength="255" /></td>
</tr>
...
<tr valign="top">
	...
	<td class="value"><input type="text" class="textField" name="coverageGeo" id="coverageGeo" value="{$coverageGeo|escape}" size="40" maxlength="255" /></td>
</tr>
...
<tr valign="top">
	...
	<td class="value"><input type="text" class="textField" name="coverageChron" id="coverageChron" value="{$coverageChron|escape}" size="40" maxlength="255" /></td>
</tr>
...
<tr valign="top">
	...
	<td class="value"><input type="text" class="textField" name="coverageSample" id="coverageSample" value="{$coverageSample|escape}" size="40" maxlength="255" /></td>
</tr>
...
<tr valign="top">
	<td class="value"><input type="text" class="textField" name="type" id="type" value="{$type|escape}" size="40" maxlength="255" /></td>
</tr>
...
<tr valign="top">
	...
	<td class="value"><input type="text" class="textField" name="sponsor" id="sponsor" value="{$sponsor|escape}" size="60" maxlength="255" /></td>
</tr>
</table>
