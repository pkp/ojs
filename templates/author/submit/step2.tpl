...
<tr valign="top">
	...
	<td class="value"><input type="text" name="titleAlt1" value="{$titleAlt1|escape}" size="60" maxlength="255" /></td>
</tr>
{/if}
{if $alternateLocale2}
<tr valign="top">
	<td class="label">{fieldLabel name="titleAlt2" key="article.title"} ({$languageToggleLocales.$alternateLocale2})</td>
	<td class="value"><input type="text" name="titleAlt2" value="{$titleAlt2|escape}" size="60" maxlength="255" /></td>
</tr>
{/if}

<tr valign="top">
	<td class="label">{fieldLabel name="abstract" key="article.abstract"}</td>
	<td class="value"><textarea name="abstract" rows="15" cols="60">{$abstract|escape}</textarea></td>
</tr>
{if $alternateLocale1}
<tr valign="top">
	<td class="label">{fieldLabel name="abstractAlt1" key="article.abstract"} ({$languageToggleLocales.$alternateLocale1})</td>
	<td class="value"><textarea name="abstractAlt1" rows="15" cols="60">{$abstractAlt1|escape}</textarea></td>
</tr>
{/if}
{if $alternateLocale2}
<tr valign="top">
	<td class="label">{fieldLabel name="abstractAlt2" key="article.abstract"} ({$languageToggleLocales.$alternateLocale2})</td>
	<td class="value"><textarea name="abstractAlt2" rows="15" cols="60">{$abstractAlt2|escape}</textarea></td>
</tr>
{/if}
</table>
...
<tr valign="top">
	...
	<td class="value"><input type="text" name="discipline" value="{$discipline|escape}" size="40" maxlength="255" /></td>
</tr>
...
<tr valign="top">
	...
	<td class="value"><input type="text" name="subjectClass" value="{$subjectClass|escape}" size="40" maxlength="255" /></td>
</tr>
<tr valign="top">
...
<tr valign="top">
	...
	<td class="value"><input type="text" name="subject" value="{$subject|escape}" size="40" maxlength="255" /></td>
</tr>
...
<tr valign="top">
	...
	<td class="value"><input type="text" name="coverageGeo" value="{$coverageGeo|escape}" size="40" maxlength="255" /></td>
</tr>
...
<tr valign="top">
	...
	<td class="value"><input type="text" name="coverageChron" value="{$coverageChron|escape}" size="40" maxlength="255" /></td>
</tr>
...
<tr valign="top">
	...
	<td class="value"><input type="text" name="coverageSample" value="{$coverageSample|escape}" size="40" maxlength="255" /></td>
</tr>
...
<tr valign="top">
	<td class="value"><input type="text" name="type" value="{$type|escape}" size="40" maxlength="255" /></td>
</tr>
