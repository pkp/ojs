...
<table class="data">
<tr>
	<td class="label">{fieldLabel required="true" name="title" key="common.title"}</td>
...
<tr>
	...
	<td class="value"><input type="text" name="creator[{$formLocale|escape}]" class="textField" id="creator" value="{$creator[$formLocale]|escape}" size="60" maxlength="255" /></td>
</tr>
<tr>
	<td class="label">{fieldLabel name="subject" key="common.keywords"}</td>
	<td class="value"><input type="text" name="subject[{$formLocale|escape}]" class="textField" id="subject" value="{$subject[$formLocale]|escape}" size="60" maxlength="255" /></td>
</tr>
<tr>
...
<tr>
	...
	<td class="value"><textarea name="description[{$formLocale|escape}]" class="textArea richContent" id="description" rows="5" cols="60">{$description[$formLocale]|escape}</textarea></td>
</tr>
<tr>
	<td class="label">{fieldLabel name="publisher" key="common.publisher"}</td>
	<td class="value"><input type="text" name="publisher[{$formLocale|escape}]" class="textField" id="publisher" value="{$publisher[$formLocale]|escape}" size="60" maxlength="255" />
	</td>
</tr>
<tr>
	<td>&nbsp;</td>
...
<tr>
	...
	<td class="value"><input type="text" name="sponsor[{$formLocale|escape}]" class="textField" id="sponsor" value="{$sponsor[$formLocale]|escape}" size="60" maxlength="255" /></td>
</tr>
<tr>
	<td class="label">{fieldLabel name="dateCreated" key="common.date"}</td>
	<td class="value"><input type="text" name="dateCreated" class="textField" id="dateCreated" value="{$dateCreated|escape}" size="11" maxlength="10" /> {translate key="submission.date.yyyymmdd"}</td>
</tr>
<tr>
	<td>&nbsp;</td>
...
<tr>
	...
	<td class="value"><input type="text" name="source[{$formLocale|escape}]" class="textField" id="source" value="{$source[$formLocale]|escape}" size="60" maxlength="255" /></td>
</tr>
<tr>
	<td>&nbsp;</td>
...
<tr>
	...
	<td class="value"><a href="{url op="download" path=$articleId|to_array:$suppFile->getFileId()}">{$suppFile->getFileName()|escape}</a></td>
</tr>
<tr>
...
<table id="showReviewers" class="data">
<tr>
	<td>&nbsp;</td>
...
<table id="replaceFile" class="data">
<tr>
	<td class="label">
		{if $suppFile && $suppFile->getFileId()}
