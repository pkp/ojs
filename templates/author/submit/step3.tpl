...
<tr valign="top">
	...
	<td width="80%" class="value"><textarea name="authors[0][biography][{$formLocale|escape}]" class="textArea richContent" id="authors-0-biography" rows="5" cols="40"></textarea></td>
</tr>
</table>
{/foreach}
