...
<tr>
	<td class="label">{fieldLabel name="authors-0-url" required="true" key="user.url"}</td>
...
<tr>
	<td class="label">{if $section->getAbstractsNotRequired()==0}{fieldLabel name="abstract" key="article.abstract" required="true"}{else}{fieldLabel name="abstract" key="article.abstract"}{/if}</td>
...
{if $section->getMetaIndexed()==1}
	<div id="indexing">
		...
		<tr>
			<td width="20%" class="label">{fieldLabel name="discipline" key="article.discipline"}</td>
		...
		<tr>
			<td class="label"><a href="{$currentJournal->getLocalizedSetting('metaSubjectClassUrl')|escape}" target="_blank">{$currentJournal->getLocalizedSetting('metaSubjectClassTitle')|escape}</a></td>
		</tr>
		<tr>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
		...
		<tr>
			<td width="20%" class="label">{fieldLabel name="subject" key="article.subject"}</td>
		...
		<tr>
			<td width="20%" class="label">{fieldLabel name="coverageChron" key="article.coverageChron"}</td>
		...
		<tr>
			<td width="20%" class="label">{fieldLabel name="coverageSample" key="article.coverageSample"}</td>
