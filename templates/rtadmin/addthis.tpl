...
<table class="data">
	<tr>
		<td class="label"></td>
		<td><input type="checkbox" name="sharingEnabled" id="sharingEnabled" {if isset($sharingEnabled) && $sharingEnabled} checked="checked" {/if} /> <label for="sharingEnabled">{translate key="rt.admin.sharing.enabled"}</label></td>
	</tr>
	<tr>
...
<table class="data">
	<tr>
		<td class="label"><label for="sharingBrand">{translate key="rt.admin.sharing.brandLabel"}</label></td>
		<td><input type="text" name="sharingBrand" id="sharingBrand" value="{$sharingBrand|escape}"/></td>
	</tr>
	<tr>
