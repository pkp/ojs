...
<table class="data">
	<tr>
		<td class="label"><h4>{translate key="common.year"}</h4></td>
	...
	{if $statItemsPublished}<tr>
		<td class="label">{translate key="manager.statistics.statistics.itemsPublished"}</td>
		<td colspan="2" class="value">{$articleStatistics.numPublishedSubmissions}</td>
	</tr>{/if}
	{if $statNumSubmissions}<tr>
		<td class="label">{translate key="manager.statistics.statistics.numSubmissions"}</td>
		<td colspan="2" class="value">{$articleStatistics.numSubmissions}</td>
	</tr>{/if}
	{if $statPeerReviewed}<tr>
		<td class="label">{translate key="manager.statistics.statistics.peerReviewed"}</td>
		<td colspan="2" class="value">{$limitedArticleStatistics.numReviewedSubmissions}</td>
	</tr>{/if}
	{if $statCountAccept}<tr>
		<td class="label">&nbsp;&nbsp;{translate key="manager.statistics.statistics.count.accept"}</td>
	...
	{if $statCountDecline}<tr>
		<td class="label">&nbsp;&nbsp;{translate key="manager.statistics.statistics.count.decline"}</td>
	...
	{if $statCountRevise}<tr>
		<td class="label">&nbsp;&nbsp;{translate key="manager.statistics.statistics.count.revise"}</td>
	...
	{if $statDaysPerReview}<tr>
		<td class="label">&nbsp;&nbsp;{translate key="manager.statistics.statistics.daysPerReview"}</td>
		<td colspan="2" class="value">
	...
	{if $statDaysToPublication}<tr>
		<td class="label">&nbsp;&nbsp;{translate key="manager.statistics.statistics.daysToPublication"}</td>
		<td colspan="2" class="value">{$limitedArticleStatistics.daysToPublication}</td>
	</tr>{/if}
	{if $statRegisteredUsers}<tr>
		<td class="label">{translate key="manager.statistics.statistics.registeredUsers"}</td>
	...
	{if $statRegisteredReaders}<tr>
		<td class="label">{translate key="manager.statistics.statistics.registeredReaders"}</td>
