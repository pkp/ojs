...
<div id="settingsTabs">
	<ul>
		...
		<li><a name="siteUsers" href="{url router=$smarty.const.ROUTE_COMPONENT component="tab.settings.AdminSettingsTabHandler" op="showTab" tab="siteUsers"}">{translate key="manager.users"}</a></li>
