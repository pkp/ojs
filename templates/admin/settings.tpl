...
<ul class="menu">
	<li class="current"><a href="{$pageUrl}/admin/settings">{translate key="admin.siteSettings"}</a></li>
...
<tr valign="top">
	...
	<td class="value"><textarea name="intro" id="intro" cols="60" rows="10" class="textArea">{$intro|escape}</textarea></td>
</tr>
<tr valign="top">
...
<tr valign="top">
	...
	<td class="value"><textarea name="about" id="about" cols="60" rows="10" class="textArea">{$about|escape}</textarea></td>
</tr>
<tr valign="top">
