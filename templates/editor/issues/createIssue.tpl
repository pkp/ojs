...
{/if}
	...
	<tr valign="top">
		<td class="label">{fieldLabel name="number" key="issue.issue"}</td>
...
{* 02042014 LS commenting out per PT https://www.pivotaltracker.com/story/show/64504020
	<tr valign="top">
