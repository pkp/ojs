...
<form class="pkp_form" id="subscriptionPolicies" method="post" action="{url op="saveSubscriptionPolicies"}">
	...
	{fbvFormSection label="manager.subscriptionPolicies.subscriptionContact"}
		...
		{fbvElement type="text" label="user.name" required=true id="subscriptionName" value=$subscriptionName inline=true size=$fbvStyles.size.MEDIUM}
		...
		{fbvElement type="tel" label="user.phone" name="subscriptionPhone" id="subscriptionPhone" value=$subscriptionPhone maxlength="32" size=$fbvStyles.size.SMALL}
