...
{/if}
<tr>
	<td class="label">{fieldLabel name="title" required="true" key="section.title"}</td>
...
<table class="listing" id="assignedSectionEditors">
	...
	<tr class="heading">
		<td>{translate key="user.username"}</td>
		<td>{translate key="user.name"}</td>
		<td align="center">{translate key="submission.review"}</td>
		<td align="center">{translate key="submission.editing"}</td>
		<td align="right">{translate key="common.action"}</td>
	</tr>
	<tr>
		<td colspan="5" class="headseparator">&nbsp;</td>
