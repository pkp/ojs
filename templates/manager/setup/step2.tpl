...
<p>
	...
	<p>
        ...
        <input type="hidden" name=name="remindForInvite" id="remindForInviteHidden" value="0" />       
		<input type="checkbox" name="remindForInvite" id="remindForInvite" value="1" onclick="toggleAllowSetInviteReminder(this.form)"{if !$scheduledTasksEnabled} disabled="disabled" {elseif $remindForInvite or !isset($remindForInvite)} checked="checked"{/if} />&nbsp;
		...
		<input type="checkbox" name="remindForSubmit" id="remindForSubmit" value="1" onclick="toggleAllowSetSubmitReminder(this.form)"{if !$scheduledTasksEnabled} disabled="disabled"{elseif $remindForSubmit or !isset($remindForSubmit)} checked="checked"{/if} />&nbsp;
...
<p>
	...
	<input type="checkbox" name="rateReviewerOnQuality" id="rateReviewerOnQuality" value="1"{if $rateReviewerOnQuality or !isset($rateReviewerOnQuality)} checked="checked"{/if} />&nbsp;
...
<p>
	...
	<input type="checkbox" name="reviewerAccessKeysEnabled" id="reviewerAccessKeysEnabled" value="1"{if $reviewerAccessKeysEnabled or !isset($reviewerAccessKeysEnabled)} checked="checked"{/if} />&nbsp;
	...
	<input type="checkbox" name="restrictReviewerFileAccess" id="restrictReviewerFileAccess" value="1"{if $restrictReviewerFileAccess or !isset($restrictReviewerFileAccess)} checked="checked"{/if} />&nbsp;
...
<p>
	...
	<input type="checkbox" name="showEnsuringLink" id="showEnsuringLink" value="1"{if $showEnsuringLink or !isset($showEnsuringLink)} checked="checked"{/if} />&nbsp;
...
<p><input type="checkbox" name="notifyAllAuthorsOnDecision" id="notifyAllAuthorsOnDecision" value="1"{if $notifyAllAuthorsOnDecision or !isset($notifyAllAuthorsOnDecision)} checked="checked"{/if} /> <label for="notifyAllAuthorsOnDecision">{translate key="manager.setup.notifyAllAuthorsOnDecision"}</label></p>
</div>
<div class="separator"></div>
