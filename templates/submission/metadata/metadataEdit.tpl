...
<table width="100%" class="data">
	...
	<tr valign="top">
		...
		<td class="value"><input type="text" name="authors[{$authorIndex|escape}][url]" id="authors-{$authorIndex|escape}-url" value="{$author.url|escape}" size="30" maxlength="255255" class="textField" /></td>
	</tr>
	<tr valign="top">
