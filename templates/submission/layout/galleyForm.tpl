...
<tr class="{cycle values="row,rowAlt"}">
	...
	<td><input type="image" name="deleteImage[{$imageFile->getFileId()}]" src="{$baseUrl}/templates/images/delete.gif" width="16" height="16" border="0" onclick="return confirmAction('', '{translate|escape:"javascript" key="submission.layout.confirmDeleteGalleyImage"}')" /></td>
</tr>
{foreachelse}
<tr>
