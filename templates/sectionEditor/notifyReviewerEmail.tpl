{**
 * notifyReviewerEmail.tpl
 *
 * Copyright (c) 2000-2011 John Willinsky
 * Distributed under the GNU GPL v2. For full terms see the file docs/COPYING.
 *
 * Email template form for notifying reviewer of review request.
 *
 *}
{strip}
...
<tr>
	...
	<td width="80%" bgcolor="yellow"><p><strong>Note: Submission URL is unique to this reviewer.</strong><br/>If you are pasting text into this template, be careful not to paste over the Submission URL ending in ../#####?key=ACCESS_KEY</p></td>
</tr>
{/if}
<tr valign="top">
