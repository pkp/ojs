	...
	{if $reviewFile}
		<tr valign="top">
			...
			<td width="50%" class="value">
				...
				{if $copyeditFile && $copyeditFile->getFileId() == $reviewFile->getFileId()}
	...
	{foreach from=$authorFiles item=authorFile key=key}
		<tr valign="top">
			...
			<td width="80%" class="value">
				...
				{if $copyeditFile && $copyeditFile->getFileId() == $authorFile->getFileId()}
					&nbsp;&nbsp;&nbsp;&nbsp;{translate key="submission.sent"}&nbsp;&nbsp;{$copyeditFile->getDateUploaded()|date_format:$dateFormatShort}
				{/if}
			</td>
		</tr>
	...
	{foreach from=$editorFiles item=editorFile key=key}
		<tr valign="top">
			...
			<td width="80%" class="value">
				...
				{if $copyeditFile && $copyeditFile->getFileId() == $editorFile->getFileId()}
					{translate key="submission.sent"}&nbsp;&nbsp;{$copyeditFile->getDateUploaded()|date_format:$dateFormatShort}&nbsp;&nbsp;&nbsp;&nbsp;
				{/if}
