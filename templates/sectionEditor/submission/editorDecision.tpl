...
<tr>
	<td class="label">{translate key="editor.article.selectDecision"}</td>
	<td class="value">
...
<table id="table2" class="data">
	...
	{foreach from=$authorFiles item=authorFile key=key}
		<tr>
			{if $firstItem}
				...
				<td rowspan="{$authorFiles|@count}" class="label">{translate key="submission.authorVersion"}</td>
			{/if}
			<td class="value">
	...
	{foreach from=$editorFiles item=editorFile key=key}
		<tr>
			{if $firstItem}
				{assign var="firstItem" value=false}
				<td rowspan="{$editorFiles|@count}" class="label">{translate key="submission.editorVersion"}</td>
			{/if}
			<td class="value">
