{**
 * selectProofreader.tpl
 *
 * Copyright (c) 2003-2004 The Public Knowledge Project
 * Distributed under the GNU GPL v2. For full terms see the file docs/COPYING.
 *
 * List proofreaders and give the ability to select a proofreader.
 *
 * $Id$
 *}

{assign var="pageTitle" value="submission.proofreader"}
{include file="common/header.tpl"}

<div class="subTitle">{translate key="editor.article.selectProofreader"}</div>
