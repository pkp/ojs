...
<a class="obj_galley_link {$type}{if $restricted} restricted{/if}" href="{url page=$page op="view" path="galley"|to_array:$parentId:$galley->getBestGalleyId($currentJournal)}">
