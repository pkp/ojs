					...
					{foreach from=$publication->getData('authors') item=author}
						<li>
							...
							<span class="contributor_roles">
								{foreach $author->getLocalizedContributorRoleNames($currentLocale) as $contributorRole}
									{strip}
									<span class="value">
										{$contributorRole|escape}
									</span>
									{if !$contributorRole@last}{translate key="common.commaListSeparator"}{/if}
									{strip}
								{/foreach}
							</span>
