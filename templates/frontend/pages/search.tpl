		...
		<fieldset class="search_advanced">
			...
			<div class="date_range">
				<div class="from">
					...
					{html_select_date prefix="dateFrom" time=$dateFrom start_year=$yearStart end_year=$yearEnd|@end year_empty="" month_empty="" day_empty="" field_order="YMD"}
				</div>
				<div class="to">
					<label class="label">
						{translate key="search.dateTo"}
					</label>
					{html_select_date prefix="dateTo" time=$dateTo start_year=$yearStart end_year=$yearEnd|@end year_empty="" month_empty="" day_empty="" field_order="YMD"}
				</div>
			</div>
			<div class="author">
