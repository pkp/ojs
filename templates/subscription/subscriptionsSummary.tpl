...
<ul class="plain">
	...
	<li>&#187; <a href="{url op="subscriptions" path="individual" filterStatus=$status.status}">{translate key=$status.localeKey} ({$status.count})</a></li>
	{/foreach}
</ul>
...
<ul class="plain">
	...
	<li>&#187; <a href="{url op="subscriptions" path="institutional" filterStatus=$status.status}">{translate key=$status.localeKey} ({$status.count})</a></li>
	{/foreach}
</ul>
