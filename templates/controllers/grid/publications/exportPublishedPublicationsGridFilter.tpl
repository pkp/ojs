{**
 * templates/controllers/grid/publications/exportPublishedPublicationsGridFilter.tpl
 *
 * Copyright (c) 2025 Simon Fraser University
 * Copyright (c) 2025 John Willinsky
 * Distributed under the GNU GPL v3. For full terms see the file docs/COPYING.
 *
 * Filter template for publications lists.
 *}
{assign var="formId" value="publicationsListFilter-"|concat:$filterData.gridId}
...
<form class="pkp_form filter" id="{$formId}" action="{url op="fetchGrid"}" method="post">
	{csrf}
	{fbvFormArea id="publicationSearchFormArea"|concat:$filterData.gridId}
		{fbvFormSection}
