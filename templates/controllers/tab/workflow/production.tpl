...
<div id="production">
	...
	<div class="pkp_workflow_content">
		{capture assign=productionReadyFilesGridUrl}{url router=PKPApplication::ROUTE_COMPONENT component="grid.files.productionReady.ProductionReadyFilesGridHandler" op="fetchGrid" submissionId=$submission->getId() stageId=$stageId escape=false}{/capture}
