{**
 * templates/subscriptions/subscriptionForm.tpl
 *
...
<tr>
	<td class="label">{fieldLabel name="status" required="true" key="manager.subscriptions.form.status"}</td>
	<td class="value"><select name="status" id="status" class="selectMenu">
