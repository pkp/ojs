...
<div id="publicationTabs">
	<ul>
		...
		<li><a href="{url router=$smarty.const.ROUTE_COMPONENT component="tab.settings.PublicationSettingsTabHandler" op="showTab" tab="submissionDocuments"}">{translate key="manager.publication.submissionDocuments"}</a></li>
