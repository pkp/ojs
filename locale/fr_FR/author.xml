...
<locale name="fr_FR" full_name = "Français">
	...
	<message key="author.submit.step2">Étape 2. Télécharger la soumission</message>
	<message key="author.submit.step3">Étape 3. Saisir les métadonnées de la soumission</message>
	<message key="author.submit.step4">Étape 4. Télécharger les fichiers supplémentaires</message>
	...
	<message key="author.submit.start">1. Commencer</message>
	<message key="author.submit.upload">2. Télécharger la soumission</message>
	<message key="author.submit.metadata">3. Saisir les métadonnées</message>
	<message key="author.submit.supplementaryFiles">4. Télécharger les fichiers supplémentaires</message>
	<message key="author.submit.confirmation">5. Confirmer la soumission</message>
	<message key="author.submit.cancelSubmission">Vous pouvez terminer cette soumission plus tard en sélectionnant Soumissions actives à la Page d'accueil de l'auteur.</message>
	...
	<message key="author.submissions.uploadCopyeditedVersion">Télécharger le fichier révisé</message>
	...
	<message key="author.submit.selectSection">Veuillez sélectionner une rubrique...</message>
	<message key="author.submit.submissionChecklist">Liste de vérification de la soumission</message>
	<message key="author.submit.submissionChecklistDescription">Indiquer que cette soumission est prête à être évaluée par la revue en sélectionnant tous les éléments suivants (des commentaires au rédacteur peuvent être ajoutés ci-dessous).</message>
	...
	<message key="author.submit.commentsForEditor">Commentaires pour le Rédacteur</message>
	...
	<message key="author.submit.privacyStatement">Déclaration de confidentialité de la revue</message>
	...
	<message key="author.submit.subjectClassInstructions">Utiliser le système de classification par liens pour sélectionner les termes de la classification et, s'il y a lieu, les numéros.</message>
	...
	<message key="author.submit.uploadSubmissionFile">Télécharger le fichier de soumission</message>
	<message key="author.submit.replaceSubmissionFile">Remplacer le fichier de soumission</message>
	<message key="author.submit.noSubmissionFile">Aucun fichier de soumission téléchargé.</message>
	<message key="author.submit.noSubmissionConfirm">Êtes-vous certain de vouloir continuer sans télécharger le fichier de soumission?</message>
	...
	<message key="author.submit.supplementaryFiles.saveToUpload">Cliquer sur Enregistrer pour télécharger le fichier (après cela, des fichiers supplémentaires peuvent être téléchargés).</message>
	<message key="author.submit.forgottenSubmitSuppFile">Êtes-vous certain de vouloir continuer sans télécharger le fichier supplémentaire que vous avez choisi?</message>
	...
	<message key="author.submit.uploadSuppFile">Télécharger le fichier supplémentaire</message>
	...
	<message key="author.submit.supplementaryFileDataDescription">Pour indexer ces documents supplémentaires, fournir les métadonnées suivantes pour chaque fichier supplémentaire téléchargé.</message>
	...
	<message key="author.submit.suppFile.contributorOrSponsor">Contributeur ou organisme de soutien</message>
	<message key="author.submit.suppFile.availableToPeers">Présenter le fichier aux évaluateurs (sans métadonnées), de façon à ne pas compromettre l'évaluation anonyme.</message>
	...
	<message key="author.submit.suppFile.noFile">Aucun fichier téléchargé.</message>
	...
	<message key="author.submit.expedite"><![CDATA[Si cette soumission est déjà dans un format qui lui permet d'être publiée sans évaluation, révision ou mise en page supplémentaire, il est possible de la placer directement dans la dernière étape de la file d'attente en <a href="{$expediteUrl}" class="action">Cliquant ici</a>. (Note : seuls les rédacteurs de revue ont cette option pour leurs soumissions.)]]></message>
	<message key="author.article.uploadAuthorVersion">Télécharger la version de l'auteur</message>
	...
	<message key="author.submit.submissionLocaleDescription">La revue accepte les soumissions dans plusieurs langues. Choisir la langue principale de la soumission à partir de la liste déroulante ci-dessous.</message>
	<message key="author.submit.form.localeRequired">Veuillez sélectionner une langue de soumission.</message>
	<message key="author.submit.submissionSupportingAgencies">Contributeurs et institutions commanditaires</message>
	<message key="author.submit.submissionSupportingAgenciesDescription">Nommez les institutions (individu, organisation ou service) ayant participé à l'élaboration du contenu, au financement ou à la promotion des travaux présentés dans cette soumission. Séparez chaque entité d'un point-virgule (ex. : Pierre Gagnon, Université Métropolitaine; Université Master, Département d'informatique).</message>
</locale>
