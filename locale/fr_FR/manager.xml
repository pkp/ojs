...
<locale name="fr_FR" full_name = "Français">
	...
	<message key="manager.groups">Bloc générique</message>
	<message key="manager.groups.context.editorialTeam">Faire apparaître le titre sous Équipe éditoriale dans la section Personnes de À propos de la revue (p. ex., Rédacteur)</message>
	<message key="manager.groups.context.editorialTeam.short">Équipe éditoriale</message>
	<message key="manager.groups.context.people">Faire apparaître le titre en tant que sa propre catégorie dans la section Personnes (p. ex., Comité de rédaction)</message>
	<message key="manager.groups.create">Créer un titre de poste</message>
	<message key="manager.groups.disableBoard">OJS liste les personnes dans l'équipe éditoriale par rôle assigné (Directeur de la revue, Réviseur, etc.)</message>
	<message key="manager.groups.enableBoard">Le directeur de la revue crée les titres et ajoute les personnes sous chaque titre.</message>
	<message key="manager.groups.enableBoard.description"><![CDATA[Sous <a href="{$aboutEditorialTeamUrl}">Personnes</a> dans À propos de la revue :]]></message>
	<message key="manager.groups.noneCreated">Aucun poste éditorial n'a été créé.</message>
	...
	<message key="manager.language.reloadLocalizedDefaultSettings">Recharger les paramètres de langue par défaut</message>
	...
	<message key="manager.payment.options.donationFee">Dons à la revue</message>
	...
	<message key="manager.payment.options.fastTrackFee">Évaluation accélérée</message>
	...
	<message key="manager.payment.options.submissionFee">Soumission d'article</message>
	<message key="manager.payment.options.text">Description de la méthode de paiement</message>
	<message key="manager.payment.options.waiverPolicy">Politique d'exemption</message>
	...
	<message key="manager.reviewFormElements.form.elementTypeRequired">Le type d'élément est obligatoire pour l'élément du formulaire.</message>
	<message key="manager.reviewFormElements.form.questionRequired">La question est obligatoire pour l'élément du formulaire.</message>
	<message key="manager.reviewFormElements.noneCreated">Aucun élément de formulaire n'a été créé.</message>
	...
	<message key="manager.reviewFormElements.radiobuttons">Boutons radio (en choisir un seulement)</message>
	<message key="manager.reviewFormElements.required">Les évaluateurs doivent compléter l'élément</message>
	<message key="manager.reviewFormElements.smalltextfield">Zone de texte uniterme</message>
	<message key="manager.reviewFormElements.textarea">Zone de texte multiligne</message>
	<message key="manager.reviewFormElements.textfield">Zone de texte simple</message>
	<message key="manager.reviewForms">Formulaires d'évaluation</message>
	<message key="manager.reviewForms.completed">Terminé</message>
	<message key="manager.reviewForms.create">Créer un formulaire d'évaluation</message>
	<message key="manager.reviewForms.description">Description et directives</message>
	<message key="manager.reviewForms.edit">Formulaire d'évaluation</message>
	<message key="manager.reviewForms.form.titleRequired">Le titre est obligatoire pour le formulaire d'évaluation.</message>
	<message key="manager.reviewForms.inReview">En évaluation</message>
	<message key="manager.reviewForms.list.description">Les formulaires d'évaluation par les pairs créés ici seront présentés aux évaluateurs pour complétion, au lieu du formulaire par défaut qui consiste en deux boîtes de texte libre, la première "pour l'auteur et le rédacteur" et la deuxième "pour le rédacteur". Des formulaires d'évaluation peuvent être attribués à une rubrique spécifique de la revue, et les rédacteurs auront l'option de choisir quel formulaire utiliser en assignant l'évaluation. Dans tous les cas, les rédacteurs auront l'option d'inclure les évaluations lors de leurs communications avec l'auteur.</message>
	<message key="manager.reviewForms.noneChosen">Aucun / Formulaire d'évaluation libre</message>
	...
	<message key="manager.sections.disableComments">Désactiver les commentaires des lecteurs pour cette rubrique.</message>
	...
	<message key="manager.sections.hideAbout">Omettre cette rubrique de À propos de cette revue.</message>
	<message key="manager.sections.hideTocAuthor">Omettre les noms d'auteur pour les articles de rubriques des sommaires de numéros.</message>
	<message key="manager.sections.hideTocTitle">Omettre le titre de cette rubrique des sommaires de numéros.</message>
	...
	<message key="manager.setup.addContributor">Ajouter un contributeur</message>
	...
	<message key="manager.setup.additionalContentDescription">Ajouter le contenu suivant, en utilisant du texte/HTML, qui apparaîtra sous l'image de la page d'accueil, le cas échéant.</message>
	...
	<message key="manager.setup.contributor">Contributeur</message>
	<message key="manager.setup.contributors">Sources d'appui</message>
	<message key="manager.setup.contributorsDescription">Les agences ou organismes fournissant un soutien financier ou en nature à la revue seront mentionnés dans À propos de la revue et pourront être accompagnés d'une note de remerciements.</message>
	<message key="manager.setup.copyediting">Réviseurs</message>
	...
	<message key="manager.setup.coverageChronExamples">(Par ex., Renaissance européenne; Période jurassique; Troisième trimestre; etc.)</message>
	<message key="manager.setup.coverageChronProvideExamples">Proposer des exemples de termes chronologiques ou historiques pertinents pour ce domaine</message>
	...
	<message key="manager.setup.coverageGeoExamples">(Par ex., Péninsule ibérique; Stratosphère; Forêt boréale; etc.)</message>
	<message key="manager.setup.coverageGeoProvideExamples">Proposer des exemples de termes géo-spatiaux ou géographiques pertinents pour ce domaine de recherche.</message>
	<message key="manager.setup.coverageResearchSampleExamples">(Par ex., Âge; Sexe; Origine ethnique; etc.)</message>
	<message key="manager.setup.coverageResearchSampleProvideExamples">Proposer des exemples de caractéristiques d'échantillons de recherche dans ce domaine</message>
	...
	<message key="manager.setup.doiPrefix">Préfixe DOI</message>
	<message key="manager.setup.doiPrefixDescription"><![CDATA[Le préfixe DOI (Digital Object Identifier) est attribué par <a href="http://www.crossref.org" target="_new">CrossRef</a> et correspond au format 10.xxxx (par ex., 10.1234).]]></message>
	<message key="manager.setup.editorDecision">Décision du rédacteur</message>
	<message key="manager.setup.editorialMembers">Aller à Membres du comité et ajouter les noms des membres des comités éditorial et/ou d'évaluation. Cela peut être fait à n'importe quel moment de l'exploitation de la revue.</message>
	<message key="manager.setup.editorialProcess1">Un ou plusieurs rédacteurs s'occupent des étapes de base sans rôle désigné.</message>
	<message key="manager.setup.editorialProcess2">Le Rédacteur en chef gère la File d'attente des soumissions et le Sommaire, tandis que les Rédacteurs de rubrique se chargent de l'Évaluation des soumissions et de la Révision des soumissions.</message>
	<message key="manager.setup.editorialProcess3">Le Rédacteur en chef gère la File d'attente des soumissions, la Révision des soumissions et le Sommaire, tandis que les Rédacteurs de rubrique se chargent de l'Évaluation des soumissions.</message>
	<message key="manager.setup.editorialReviewBoard">Comité éditorial / d'évaluation</message>
	<message key="manager.setup.editorialReviewBoardDescription">Les revues disposent de comités éditoriaux pour superviser la direction éditoriale de la revue, participer à la nomination des rédacteurs, et, grâce à la réputation des membres du comité, impartir à la revue une certaine position sociale dans le domaine. Les comités d'évaluation jouent un rôle semblable mais, en outre, ils dirigent le processus d'évaluation par les pairs. Les membres du comité d'évaluation n'auront pas accès au système de gestion de la revue, mais ils feront partie de la liste des personnes disponibles pour effectuer une évaluation par les pairs.</message>
	...
	<message key="manager.setup.emailSignatureDescription">La signature suivante sera ajoutée à la fin de chaque courriel préparé et envoyé par le système, au nom de la revue. Le corps des courriels préparés sont disponibles pour modification sous Gestion de la revue.</message>
	...
	<message key="manager.setup.enablePageNumber">La pagination pour les articles sera calculée et saisie manuellement dans le sommaire de cette revue (par ex., p. 13-26).</message>
	<message key="manager.setup.enablePublicArticleId">Des identifiants personnalisés seront utilisés pour identifier les articles publiés.</message>
	<message key="manager.setup.enablePublicGalleyId">Des identifiants personnalisés seront utilisés pour identifier les épreuves (par ex., des fichiers HTML ou PDF) pour les éléments publiés.</message>
	...
	<message key="manager.setup.enablePublicSuppFileId">Des identifiants personnalisés seront utilisés pour identifier les fichiers supplémentaires de l'article.</message>
	<message key="manager.setup.enableUserRegistration">Les utilisateurs peuvent s'inscrire à la revue dans l'un ou plusieurs des rôles suivants :</message>
	<message key="manager.setup.enableUserRegistration.author">Auteurs (peut soumettre des documents à la revue)</message>
	<message key="manager.setup.enableUserRegistration.reader">Lecteurs (recevra des avis et sera considéré de la même façon qu'un abonné)</message>
	<message key="manager.setup.enableUserRegistration.reviewer">Évaluateurs (disponible pour l'évaluation de soumissions)</message>
	<message key="manager.setup.focusAndScope">Énoncé de mission</message>
	<message key="manager.setup.focusAndScopeDescription">Saisir un énoncé de mission ci-dessous, qui apparaîtra dans À propos de la revue, indiquant aux auteurs, aux lecteurs et aux bibliothécaires les types d'articles que la revue publie.</message>
	<message key="manager.setup.focusAndScopeOfJournal">Politique éditoriale de la revue</message>
	<message key="manager.setup.focusScope">Politique éditoriale</message>
	<message key="manager.setup.focusScopeDescription"><![CDATA[<strong>EXEMPLE DE DONNÉES HTML</strong>]]></message>
	...
	<message key="manager.setup.form.journalInitialsRequired">Les initiales de la revue sont obligatoires.</message>
	...
	<message key="manager.setup.frequencyOfPublication">Première publication et périodicité</message>
	<message key="manager.setup.frequencyOfPublicationDescription">Établir le numéro de publication (volume et/ou numéro) et l'année pour la première publication de la revue, ainsi que la périodicité prévue pour les publications de la revue.</message>
	<message key="manager.setup.frequencyOfPublicationNote">Note : Laisser les éléments vides s'ils ne sont pas utilisés par cette revue; les rédacteurs peuvent réinitialiser les chiffres lors du processus de publication.</message>
	...
	<message key="manager.setup.homepageImageDescription">Ajouter un fichier image ou graphique dans le milieu de la page.</message>
	...
	<message key="manager.setup.journalAbbreviation">Abréviation de la revue</message>
	<message key="manager.setup.journalArchiving">Archivage de la revue</message>
	<message key="manager.setup.journalDescription">Description de la revue</message>
	<message key="manager.setup.journalDescriptionDescription">Ajouter une brève description (20-25 mots) en texte/HTML qui apparaîtra juste en-dessous des liens de navigation.</message>
	...
	<message key="manager.setup.journalInitials">Initiales de la revue</message>
	...
	<message key="manager.setup.journalPageHeader">En-têtes des pages de la revue</message>
	<message key="manager.setup.journalPageHeaderDescription">Une version graphique du titre et du logo de la revue (fichier .gif, .jpg, ou .png), possiblement une version plus petite que celle qui est utilisée dans la page d'accueil, peut être téléchargée pour servir d'en-tête dans les pages de la revue, et remplacera la version textuelle qui y figure habituellement.</message>
	...
	<message key="manager.setup.layoutAndGalleys">Responsables de la mise en page</message>
	...
	<message key="manager.setup.lockssLicenses"><![CDATA[Voir <a href="http://www.lockss.org/community/publishers-titles-gln/" target="_blank">les autres versions d'une licence LOCKSS</a>.]]></message>
	...
	<message key="manager.setup.mailingAddressDescription">Emplacement physique et adresse postale de la revue.</message>
	...
	<message key="manager.setup.notifications">Avis de soumission d'auteur</message>
	<message key="manager.setup.notifications.copyPrimaryContact">Envoyer une copie au contact principal de la revue, identifié à l'Étape 1 de la Configuration.</message>
	<message key="manager.setup.notifications.copySpecifiedAddress">Envoyer une copie à cette adresse de courriel :</message>
	<message key="manager.setup.notifications.description">Après avoir complété le processus de soumission, les auteurs reçoivent un courriel accusant réception de celle-ci (lequel peut être vu et modifié dans "Courriels préparés"). De plus, une copie du courriel accusant réception peut être envoyée comme suit :</message>
	...
	<message key="manager.setup.notifyAllAuthorsOnDecision">Lorsque vous utilisez le courriel Aviser l'auteur, inclure les adresses de courriel de tous les auteurs pour les soumissions d'auteurs multiples, et non simplement celle de l'utilisateur soumissionnaire.</message>
	<message key="manager.setup.noUseCopyeditors">La révision sera assurée par un Rédacteur ou un Rédacteur de rubrique assigné à la soumission.</message>
	<message key="manager.setup.noUseLayoutEditors">Un Rédacteur ou un Rédacteur de rubrique assigné à la soumission préparera les fichiers en format HTML, PDF, etc.</message>
	<message key="manager.setup.noUseProofreaders">Un Rédacteur ou un Rédacteur de rubriques assigné à la soumission vérifiera les épreuves.</message>
	...
	<message key="manager.setup.openAccessPolicy">Politique d'accès libre</message>
	<message key="manager.setup.openAccessPolicyDescription">Si la revue fournira aux lecteurs l'accès libre immédiat à l'ensemble de son contenu publié, saisir une Politique d'accès libre qui apparaîtra dans À propos de la revue, sous Politiques.</message>
	<message key="manager.setup.pageNumberIdentifier">Option de numéro de page</message>
	<message key="manager.setup.peerReviewDescription">Décrire la politique d'évaluation par les pairs et les processus de la revue pour les lecteurs et les auteurs, y compris le nombre d'évaluateurs utilisés généralement pour évaluer une soumission, les critères sur lesquels les évaluateurs doivent s'appuyer pour juger les soumissions, le temps habituel accordé aux évaluations, et les principes de recrutement des évaluateurs. Ces données apparaîtront dans À propos de la revue.</message>
	<message key="manager.setup.peerReviewPolicy">Évaluation par les pairs</message>
	<message key="manager.setup.peerReviewPolicy2">Politique d'évaluation par les pairs</message>
	...
	<message key="manager.setup.principalContactDescription">Ce poste, qui peut être traité comme rédacteur en chef, directeur de revue, ou tout autre poste du personnel administratif, figurera dans la page d'accueil de la revue sous Contact, au côté du Contact du soutien technique.</message>
	...
	<message key="manager.setup.proofreading">Correcteurs d'épreuves</message>
	...
	<message key="manager.setup.publicationFormatDescription">La revue utilisera les éléments suivants pour identifier les numéros (qui peuvent être outrepassés pour des numéros particuliers).</message>
	<message key="manager.setup.publicationFormatNumber">Numéro</message>
	<message key="manager.setup.publicationFormatTitle">Titre</message>
	<message key="manager.setup.publicationFormatVolume">Volume</message>
	<message key="manager.setup.publicationFormatYear">Année</message>
	...
	<message key="manager.setup.registerJournalForIndexing">Inscrire la revue pour indexation (collecte de métadonnées)</message>
	...
	<message key="manager.setup.reviewOptions.noteOnModification">Peut être modifié pendant le processus éditorial.</message>
	...
	<message key="manager.setup.reviewOptions.remindForInvite1">Si l'évaluateur n'a pas répondu à une demande d'évaluation dans les</message>
	<message key="manager.setup.reviewOptions.remindForInvite2">jours.</message>
	<message key="manager.setup.reviewOptions.remindForSubmit1">Si l'évaluateur n'a pas soumis de recommandation dans les</message>
	<message key="manager.setup.reviewOptions.remindForSubmit2">jours suivants la date d'échéance de l'évaluation.</message>
	...
	<message key="manager.setup.reviewOptions.reviewerAccess">Accès de l'évaluateur</message>
	<message key="manager.setup.reviewOptions.reviewerAccessKeysEnabled">Activer l'accès en un seul clic de l'évaluateur.</message>
	<message key="manager.setup.reviewOptions.reviewerAccessKeysEnabled.description"><![CDATA[<strong>Note :</strong> Le courriel d'invitation destiné aux évaluateurs contiendra une URL particulière qui les mènera directement à la page d'évaluation de la soumission (avec accès à toute autre page leur demandant de se connecter). Pour des raisons de sécurité reliées à cette option, les rédacteurs ne peuvent pas modifier les adresses de courriel, ni ajouter des CC ou CCI avant d'envoyer une invitation aux évaluateurs.]]></message>
	...
	<message key="manager.setup.reviewOptions.reviewTime">Temps d'évaluation</message>
	...
	<message key="manager.setup.reviewProcess">Processus d'évaluation</message>
	<message key="manager.setup.reviewProcessDescription"><![CDATA[OJS prend en charge deux modèles pour la gestion du processus d'évaluation. Le processus d'évaluation standard est recommandé parce qu'il accompagne les évaluateurs durant tout le processus, fait en sorte d'obtenir un historique complet de l'évaluation de chaque soumission, et tire avantage des avis de rappel automatiques et des recommandations standards pour les soumissions (Accepter; Accepter avec révisions; Soumettre pour évaluation; Soumettre ailleurs; Refuser; Voir les commentaires).<br /><br />Sélectionner l'un des processus suivants :]]></message>
	<message key="manager.setup.reviewProcessEmail">Processus d'évaluation par courriels et pièces jointes</message>
	<message key="manager.setup.reviewProcessStandard">Processus d'évaluation standard</message>
	<message key="manager.setup.reviewProcessStandardDescription">Les rédacteurs enverront aux Évaluateurs sélectionnés un courriel avec le titre et le résumé de la soumission, ainsi qu'une invitation à visiter le site Web de la revue pour compléter l'évaluation. Les évaluateurs visitent le site Web de la revue pour consentir à effectuer l'évaluation, pour télécharger les soumissions, soumettre leurs commentaires, et sélectionner une recommandation.</message>
	...
	<message key="manager.setup.siteAccess">Restrictions supplémentaires concernant l'accès à l'article et au site</message>
	<message key="manager.setup.sponsorsDescription">Les noms des institutions (par ex., associations de chercheurs, départements universitaires, coopératives, etc.) soutenant la revue figureront dans À propos de la revue et pourraient être accompagnés des remerciements.</message>
	<message key="manager.setup.stepsToJournalSite">Cinq étapes pour configurer votre revue</message>
	<message key="manager.setup.subjectClassification">Classement par sujet</message>
	<message key="manager.setup.subjectClassificationExamples">(Par ex., Mathématiques - Classification par sujet; Classification de la Library of Congress)</message>
	...
	<message key="manager.setup.submissionEmailLogging">Tenez un registre, sur la page Historique, de tous les courriels envoyés concernant une soumission.</message>
	<message key="manager.setup.submissionEventLogging">Tenez un registre, sur la page Historique, de toutes les actions prises concernant une soumission.</message>
	...
	<message key="manager.setup.useCopyeditors">Un réviseur sera assigné à chaque soumission.</message>
	<message key="manager.setup.useEditorialReviewBoard">La revue aura recours à un comité éditorial/d'évaluation.</message>
	<message key="manager.setup.useImageLogo">Image du logo</message>
	...
	<message key="manager.setup.useLayoutEditors">Un responsable de la mise en page sera assigné à la constitution de fichiers en format HTML, PDF, etc., aux fins de publication numérique.</message>
	<message key="manager.setup.useProofreaders">Un correcteur d'épreuves sera assigné à la vérification (assistée par les auteurs) des épreuves avant la publication.</message>
	<message key="manager.setup.userRegistration">Inscription de l'utilisateur</message>
	<message key="manager.setup.useTextTitle">Texte du titre</message>
	<message key="manager.setup.volumePerYear">Volumes par année</message>
	<message key="manager.statistics.reports">Générateur de rapports</message>
	<message key="manager.statistics.reports.description">OJS génère des rapports qui font le suivi des détails associés avec le traitement des soumissions à la revue, de la perspective des rédacteurs, des évaluateurs, et rubriques, au cours d'une période donnée. Les rapports sont produits en format CSV qui nécessite un tableur pour être affiché correctement.</message>
	...
	<message key="manager.subscriptionPolicies.subscriptionPoliciesSaved">Votre politique d'abonnement a été mise à jour.</message>
	...
	<message key="manager.reviewFormElement.changeType">Avertissement : Modifier le type d'élément du formulaire d'évaluation du type « à choix multiples » à un type « ouvert » aura pour conséquence la suppression des options reliées au choix multiples.</message>
	<message key="manager.reviewFormElements.confirmDelete">Êtes-vous certain de vouloir supprimer un élément d'un formulaire d'évaluation publié?</message>
	<message key="manager.reviewForms.confirmDeleteUnpublished">Êtes-vous certain de vouloir supprimer un élément d'un formulaire d'évaluation non publié?</message>
	...
	<message key="manager.plugins.install">Installer un nouvel plugiciel</message>
	<message key="manager.plugins.installDescription">Ce formulaire vous permet de télécharger et d'installer un nouveau plugiciel. Veuillez vous assurer que le plugiciel est compressé dans un fichier .tar.gz.</message>
	<message key="manager.plugins.upgrade">Mettre à jour un plugiciel</message>
	<message key="manager.plugins.upgradeDescription">Ce formulaire vous permet de mettre à jour un plugiciel. Veuillez vous assurer que le plugiciel est compressé dans un fichier .tar.gz.</message>
	<message key="manager.plugins.delete">Supprimer un plugiciel</message>
	<message key="manager.plugins.deleteDescription">En cliquant supprimer, vous supprimerez le plugiciel du système de fichiers du serveur.</message>
	<message key="manager.plugins.deleteSuccess">Plugiciel supprimé avec succès</message>
	<message key="manager.plugins.uploadPluginDir">Sélectionner un fichier de plugiciel</message>
	<message key="manager.plugins.deleteConfirm">Êtes-vous certain que vous souhaitez supprimer ce plugiciel du système?</message>
	<message key="manager.plugins.uploadError">Un erreur s'est produite lors du téléchargement du fichier</message>
	<message key="manager.plugins.fileSelectError">Veuillez d'abord sélectionner un fichier</message>
	<message key="manager.plugins.versionFileNotFound">Version.xml n'a pas été trouvé dans le répertoire du plugiciel</message>
	<message key="manager.plugins.copyError">Le plugiciel n'a pas été copié avec succès</message>
	<message key="manager.plugins.pleaseUpgrade">Le plugiciel existe déjà, mais dans une version plus récente que la version installée. Veuillez plutôt faire la mise à jour</message>
	<message key="manager.plugins.installedVersionOlder">Le plugiciel existe déjà, et est dans une version plus ancienne ou équivalente à la version installée.</message>
	<message key="manager.plugins.installedVersionNewer">Le plugiciel existe déjà, et dans une version plus récente ou équivalente à la version installée.</message>
	<message key="manager.plugins.pleaseInstall">Le plugiciel n'existe pas. Veuillez plutôt l'installer</message>
	<message key="manager.plugins.deleteError">Le plugiciel n'a pu être supprimé du système de fichiers</message>
	<message key="manager.plugins.doesNotExist">Le plugiciel n'existe pas</message>
	<message key="manager.plugins.installSuccessful">Version installée avec succès</message>
	<message key="manager.plugins.upgradeSuccessful">Version mise à jour avec succès</message>
	<message key="manager.plugins.installFailed">L'installation a échouée</message>
	<message key="manager.plugins.upgradeFailed">La mise à jour à échouée</message>
	...
	<message key="manager.setup.contributorNoteDescription">Ce texte apparaîtra sous l'en-tête « Sources d'appui » et au-dessus de la liste des noms et urls des organismes de soutien sous « Commanditaires de la revue » sur la page « À propos ».</message>
	...
	<message key="manager.setup.doiSuffix">Suffixe DOI</message>
	<message key="manager.setup.doiSuffixDefault">Utiliser la forme par défaut (%j.v%vi%i.%a).</message>
	<message key="manager.setup.doiSuffixPattern">Utiliser la forme inscrite ci-dessous pour générer les suffixes DOI. Utiliser %j pour les initiales de la revue, %v pour le numéro du volume, %i pour le numéro de la publication, %a pour l'ID de l'article dans OJS, et %p pour le numéro de page.</message>
	<message key="manager.setup.doiSuffixPattern.example">Par exemple, vol%viss%ipp%p pourrait générer un DOI tel que 10.1234/vol3iss2pp230</message>
	<message key="manager.setup.doiSuffixDescription">Un suffixe DOI peut prendre n'importe quelle forme, mais doit être unique pour chaque article publié.</message>
	<message key="manager.setup.doiSuffixPublisherId">Utiliser l'« Identifiant personnalisé » comme suffixe DOI pour les articles publiés (doit être activé à l'Étape 4).</message>
	<message key="manager.setup.form.doiPrefixPattern">Le DOI doit avoir le format 10.xxxx.</message>
	<message key="manager.setup.journalFavicon">Icône (favicon) de la revue</message>
	<message key="manager.setup.journalFaviconDescription">Ajouter un icône (favicon) pour cette revue pour fins d'affichage à côté de la barre de navigation quand les utilisateurs visitent votre site.</message>
	<message key="manager.setup.journalFaviconInvalid">Format d'icône (favicon) invalide. Les formats acceptés sont .ico, .png et .gif.</message>
	<message key="manager.setup.publisherNoteDescription">Ce texte apparaîtra sous l'entête « Éditeur » et au-dessus du nom/url de l'éditeur sous « Commanditaires de la revue » sur la page « À propos ».</message>
	<message key="manager.setup.sponsors">Commanditaires de la revue</message>
	<message key="manager.setup.sponsorNoteDescription">Ce texte apparaîtra sous l'entête « Commanditaires » et au-dessus de la liste des noms et urls des commanditaires sous « Commanditaires » sur la page « À propos ».</message>
	...
	<message key="manager.groups.publishEmails">Publier les courriels des membres</message>
	<message key="manager.language.submissions">Soumissions</message>
	<message key="manager.plugins.invalidPluginArchive">Les archives du plugiciel téléchargées ne contiennent pas un dossier qui corresponde au nom du plugiciel.</message>
	...
	<message key="manager.setup.doiReassign">Réaffecter les DOIs</message>
	<message key="manager.setup.doiReassign.description">Si vous modifier votre configuration DOI, les DOIs qui ont déjà été affectés ne seront pas visés. Du moment que la configuration DOI est enregistrée, utiliser ce bouton pour effacer tous les DOIs existants afin que les nouveaux paramètres s'appliquent aux articles existants.</message>
	<message key="manager.payment.giftFees">Tarif des formules cadeau</message>
	<message key="manager.payment.giftFeesDescription">Un lien vers les abonnements en cadeau apparaîtra sur la page des abonnements dans À propos de la revue et dans la barre latérale des abonnements.</message>
	<message key="manager.payment.options.acceptGiftSubscriptionPayments">Cela activera le règlement des abonnements en cadeau, permettant aux lecteurs de la revue d'acheter des abonnements en cadeau pour d'autres lecteurs.</message>
	<message key="manager.payment.options.purchaseIssueFee">Acheter un numéro</message>
	<message key="manager.plugins.wrongCategory">Le plugiciel téléchargé est incompatible avec la catégorie du plugiciel mis à jour.</message>
	<message key="manager.plugins.wrongName">La version .xml dans le plugiciel téléchargé contient un nom de plugiciel incompatible avec le nom du plugiciel mis à jour.</message>
	...
	<message key="manager.setup.subjectClassificationURLValid">Veuillez entrer une URL distante valide (incluant http://).</message>
	...
	<message key="manager.statistics.reports.defaultReportTemplates">Modèle de rapport par défaut</message>
	<message key="manager.statistics.reports.defaultReport.articleDownloads">Téléchargement d'article</message>
	<message key="manager.statistics.reports.defaultReport.articleAbstract">Nombre de vues de résumé d'article</message>
	<message key="manager.statistics.reports.defaultReport.articleAbstractAndDownloads">Résumé d'article et téléchargements</message>
	<message key="manager.statistics.reports.defaultReport.issueDownloads">Problème de téléchargement de fichier</message>
	...
	<message key="manager.statistics.reports.reportUrl">URL du rapport</message>
	...
	<message key="manager.statistics.reports.filters.byTime">Choisir la portée du rapport</message>
	<message key="manager.statistics.reports.filters.byTime.dimensionSelector">Ou choisir la portée par:</message>
	<message key="manager.statistics.reports.filters.byLocation.description">Affiner les résultats selon le pays, la région ou la ville.</message>
	<message key="manager.setup.permissions.priorAgreement">Accord préalable</message>
	<message key="manager.setup.permissions.display">Afficher</message>
	<message key="manager.setup.licenseURLDescription">Fournissez l'adresse URL du site Web des licences, le cas échéant.</message>
	<message key="manager.setup.includeLicense">Afficher la licence avec la publication.</message>
	...
	<message key="manager.statistics.reports.objectId.label">Définir un ou plusieurs identifiant(s) d'objet, séparés par une virgule (ex.: 1,2,3,4,5).</message>
	...
	<message key="manager.statistics.reports.orderBy">Mettre en ordre</message>
	<message key="manager.statistics.reports.orderDir.asc">Ascendant</message>
	<message key="manager.statistics.reports.orderDir.desc">Descendant</message>
	<message key="manager.statistics.reports.month.label">Veuillez employer le format AAAAMM.</message>
	<message key="manager.statistics.reports.day.label">Veuillez employer le format AAAAMMJJ.</message>
	<message key="manager.statistics.reports.cities.label">Un ou plusieurs nom(s) de villes, séparés par une virgule (ex.: Ville 1, Ville 2)</message>
	<message key="manager.statistics.reports.filters.byContext.description">Affiner les résultats par contexte</message>
	<message key="manager.statistics.reports.filters.byObject">Par type d'objet ou identifiant d'objet</message>
	<message key="manager.setup.includeCopyrightStatement">Afficher la déclaration de droit d'auteur avec le contenu (recommandé lorsque l'auteur détient le droit d'auteur).</message>
	<message key="manager.setup.resetPermissions">Réinitialiser les autorisations pour les articles</message>
	<message key="manager.setup.resetPermissions.description">La déclaration de droit d'auteur et l'information concernant la licence seront liés de façon définitive au contenu publié afin de prévenir toute modification à ces données en cas de changement des politiques d'un journal pour les nouvelles soumissions. Afin de réinitialiser les autorisations enregistrées, utilisez le bouton ci-dessous.</message>
	<message key="manager.setup.confirmResetLicense">Êtes-vous certain de vouloir réinitialiser les informations concernant la licence et le droit d'auteur liées au contenu publié à la licence pré-configurée dans la configuration de revue?</message>
	<message key="manager.statistics.defaultMetricDescription">Votre revue a été configurée pour enregistrer plus d'une mesure d'utilisation. Les statistiques d'utilisation seront affichées pour plusieurs contextes. Il arrive parfois qu'une seule statistique d'utilisation doit être utilisée, par exemple pour afficher une liste ordonnée des soumissions les plus utilisées ou pour ordonner les résultats de la recherche. Veuillez choisir l'une des mesures configurées à titre de mesure par défaut.</message>
	<message key="manager.statistics.reports.filters.byObject.description">Affiner les résultat par type d'objet (revue, numéro, article, épreuve PDF, autres épreuves) et/ou par un ou plusieurs identifiant(s) d'objet.</message>
	<message key="manager.statistics.reports.filters.byLocation">Par emplacement géographique</message>
	<message key="manager.statistics.reports.defaultReport.issueTableOfContents">Nombre de consultations du sommaire du numéro</message>
	<message key="manager.statistics.reports.defaultReport.issueTableOfContentsAndDownloads">Sommaire et téléchargements du numéro</message>
	<message key="manager.statistics.reports.defaultReport.journalIndexPageViews">Nombre de consultations de la page d'accueil de la revue</message>
	<message key="manager.statistics.reports.orderDir">Ordre</message>
	<message key="manager.subscriptions.form.dateRemindedBefore">Rappel de pré-expiration envoyé</message>
	<message key="manager.subscriptions.form.dateRemindedAfter">Rappel de post-expiration envoyé</message>
</locale>
